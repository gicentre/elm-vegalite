...
var $author$project$VegaLite$Ascending = {$: 'Ascending'};
...
var $author$project$SortTests$stack1 = function () {
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$SortTests$path + 'cars.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				data,
...
var $author$project$SortTests$specs = _List_fromArray(
	[
...
var $author$project$SortTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$SortTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$SortTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$SortTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$SortTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$SortTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$SortTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$SortTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$SortTests$update,
		view: $author$project$SortTests$view
	});
