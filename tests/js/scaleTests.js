...
var $author$project$ScaleTests$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$ScaleTests$sourceExample = $author$project$ScaleTests$scale11;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$ScaleTests$sourceExample))
					]))
			]));
};
var $author$project$ScaleTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$ScaleTests$mySpecs,
				$author$project$ScaleTests$elmToJS($author$project$ScaleTests$mySpecs))),
