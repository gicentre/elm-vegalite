...
var $author$project$VegaLite$Identity = {$: 'Identity'};
...
var $author$project$ProjectionTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$ProjectionTests$update,
		view: $author$project$ProjectionTests$view
	});
