...
var $author$project$FillStrokeTests$capAndJoin1 = function () {
	var prm = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$paValue(
						$author$project$VegaLite$str('square')),
						$author$project$VegaLite$paBind(
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$FillStrokeTests$path + 'cars.json', _List_Nil);
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$joExpr('join'))
					]))
			]));
}();
...
var $author$project$FillStrokeTests$encChart = function (extraEnc) {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			$author$project$VegaLite$size(
				_List_fromArray(
					[
						$author$project$VegaLite$mNum(2000)
					]))),
		extraEnc);
	var data = A2(
		$elm$core$Basics$composeL,
...
var $author$project$FillStrokeTests$combined1 = $author$project$FillStrokeTests$encChart(
	A2(
		$elm$core$Basics$composeL,
...
var $author$project$FillStrokeTests$combined2 = $author$project$FillStrokeTests$encChart(
	A2(
		$elm$core$Basics$composeL,
...
var $author$project$FillStrokeTests$combined3 = $author$project$FillStrokeTests$encChart(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$stroke(
			_List_fromArray(
...
var $author$project$FillStrokeTests$defChart = $author$project$FillStrokeTests$encChart(
	$elm$core$Basics$always(_List_Nil));
var $author$project$FillStrokeTests$fill1 = $author$project$FillStrokeTests$encChart(
	$author$project$VegaLite$fill(_List_Nil));
var $author$project$FillStrokeTests$fill2 = $author$project$FillStrokeTests$encChart(
	$author$project$VegaLite$fill(
		_List_fromArray(
			[
				$author$project$VegaLite$mName('y'),
...
var $author$project$VegaLite$GeoLine = function (a) {
	return {$: 'GeoLine', a: a};
};
var $author$project$VegaLite$geoLine = $author$project$VegaLite$GeoLine;
var $author$project$VegaLite$GeoPoint = F2(
	function (a, b) {
		return {$: 'GeoPoint', a: a, b: b};
	});
var $author$project$VegaLite$geoPoint = $author$project$VegaLite$GeoPoint;
...
var $author$project$VegaLite$jsonProperty = $author$project$VegaLite$JSON;
var $elm$core$Basics$negate = function (n) {
	return -n;
};
var $author$project$FillStrokeTests$geo1 = function () {
	var geojson = $author$project$VegaLite$geoFeatureCollection(
		_List_fromArray(
			[
				...
				A2(
				$author$project$VegaLite$geometry,
				$author$project$VegaLite$geoLine(
					_List_fromArray(
						[
							_Utils_Tuple2(4, 52),
							_Utils_Tuple2(4, 59),
				...
				A2(
				$author$project$VegaLite$geometry,
				A2($author$project$VegaLite$geoPoint, 4, 55),
				_List_Nil)
			]));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$FillStrokeTests$geo2 = function () {
	var geojson = $author$project$VegaLite$geoFeatureCollection(
		_List_fromArray(
			[
				A2(
		...
		$author$project$VegaLite$fill(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$mStr('rgb(0,0,0,0)')
						]))
				])));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$VegaLite$maCornerRadiusEnd = function (n) {
	return $author$project$VegaLite$MCornerRadiusEnd(
		$author$project$VegaLite$Num(n));
};
var $author$project$FillStrokeTests$rounded1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maCornerRadiusEnd(4)
					]))
			]));
}();
var $author$project$FillStrokeTests$rounded2 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$ChStrokeDash = {$: 'ChStrokeDash'};
var $author$project$VegaLite$chStrokeDash = $author$project$VegaLite$ChStrokeDash;
...
var $author$project$FillStrokeTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('default', $author$project$FillStrokeTests$defChart),
		_Utils_Tuple2('fill1', $author$project$FillStrokeTests$fill1),
		_Utils_Tuple2('fill2', $author$project$FillStrokeTests$fill2),
		_Utils_Tuple2('fill3', $author$project$FillStrokeTests$fill3),
		_Utils_Tuple2('stroke1', $author$project$FillStrokeTests$stroke1),
		_Utils_Tuple2('stroke2', $author$project$FillStrokeTests$stroke2),
		_Utils_Tuple2('stroke3', $author$project$FillStrokeTests$stroke3),
		_Utils_Tuple2('combined1', $author$project$FillStrokeTests$combined1),
		...
		_Utils_Tuple2('capAndJoin1', $author$project$FillStrokeTests$capAndJoin1)
	]);
...
var $author$project$FillStrokeTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$FillStrokeTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$FillStrokeTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$FillStrokeTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$FillStrokeTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$FillStrokeTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$FillStrokeTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$FillStrokeTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$FillStrokeTests$update,
		view: $author$project$FillStrokeTests$view
	});
_Platform_export({'FillStrokeTests':{'init':$author$project$FillStrokeTests$main(
