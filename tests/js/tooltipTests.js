...
var $author$project$TooltipTests$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$TooltipTests$sourceExample = $author$project$TooltipTests$tooltip1;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$TooltipTests$sourceExample))
					]))
			]));
};
var $author$project$TooltipTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$TooltipTests$mySpecs,
				$author$project$TooltipTests$elmToJS($author$project$TooltipTests$mySpecs))),
