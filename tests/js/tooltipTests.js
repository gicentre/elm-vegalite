...
var $author$project$TooltipTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TooltipTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$TooltipTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$TooltipTests$update,
		view: $author$project$TooltipTests$view
	});
