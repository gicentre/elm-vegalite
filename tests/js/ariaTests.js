...
var $author$project$AriaTests$defaultVis = F2(
	function (mProps, cfg) {
		var enc = A2(
...
var $author$project$AriaTests$aria1 = A2(
...
var $author$project$AriaTests$aria2 = A2(
	$author$project$AriaTests$defaultVis,
	_List_fromArray(
		[
...
var $author$project$AriaTests$aria3 = A2(
	$author$project$AriaTests$defaultVis,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$VegaLite$arDescription('Point marks')
				]))
		]),
	$author$project$VegaLite$configure);
...
var $author$project$AriaTests$aria4 = A2(
	$author$project$AriaTests$defaultVis,
	_List_fromArray(
		[
			$author$project$VegaLite$maAria(
