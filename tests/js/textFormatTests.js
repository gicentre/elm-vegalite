...
var $author$project$VegaLite$fTemporal = $author$project$VegaLite$FmType($author$project$VegaLite$Temporal);
...
var $author$project$VegaLite$Sum = {$: 'Sum'};
...
var $author$project$TextFormatTests$customFormatter1 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
			$author$project$VegaLite$fiExpr('datum.month >= \'2016\'')));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$VegaLite$axFormatAsCustom('axTest')
									]))
							]))),
				A2(
					$author$project$VegaLite$position,
			...
			$author$project$VegaLite$color(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$leFormatAsCustom('leTest')
							]))
					]))),
		$author$project$VegaLite$column(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$hdFormatAsCustom('hdTest')
						]))
				])));
	var data = $author$project$VegaLite$dataFromUrl('https://gicentre.github.io/data/westMidlands/westMidsCrimesAggregated.tsv');
...
var $author$project$VegaLite$TitleLineHeight = function (a) {
	return {$: 'TitleLineHeight', a: a};
};
var $author$project$VegaLite$axcoTitleLineHeight = $author$project$VegaLite$TitleLineHeight;
...
var $author$project$VegaLite$LeTitleLineHeight = function (a) {
	return {$: 'LeTitleLineHeight', a: a};
};
var $author$project$VegaLite$lecoTitleLineHeight = $author$project$VegaLite$LeTitleLineHeight;
...
var $author$project$VegaLite$MLineHeight = function (a) {
	return {$: 'MLineHeight', a: a};
};
var $author$project$VegaLite$maLineHeight = function (n) {
...
var $author$project$VegaLite$TSubtitleLineHeight = function (a) {
	return {$: 'TSubtitleLineHeight', a: a};
};
...
var $author$project$TextFormatTests$multiline1 = function () {
	var encBase = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var enc2 = A2(
		...
		$author$project$VegaLite$text(
			_List_fromArray(
				[
					$author$project$VegaLite$tStr('literal\non\nthree lines')
				])));
	var enc1 = A2(
		$elm$core$Basics$composeL,
		encBase,
			...
			A2(
				...
				$author$project$VegaLite$configuration(
					$author$project$VegaLite$coAxis(
						_List_fromArray(
							[
								$author$project$VegaLite$axcoTitleLineHeight(24)
							])))),
			$author$project$VegaLite$configuration(
				$author$project$VegaLite$coLegend(
					_List_fromArray(
						[
							$author$project$VegaLite$lecoTitleLineHeight(24)
						])))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coMark(
				_List_fromArray(
					[
						$author$project$VegaLite$maLineHeight(16)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$axLabelLineHeight = function (n) {
...
var $author$project$VegaLite$VLColumns = {$: 'VLColumns'};
var $author$project$VegaLite$columns = function (cols) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLColumns,
		$elm$json$Json$Encode$int(
			A2($elm$core$Basics$max, 0, cols)));
};
var $author$project$VegaLite$VLConcat = {$: 'VLConcat'};
var $author$project$VegaLite$concat = function (specs) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLConcat,
		$author$project$VegaLite$toList(specs));
};
...
var $author$project$VegaLite$VAlignAlphabetic = {$: 'VAlignAlphabetic'};
...
var $author$project$VegaLite$VAlignLineBottom = {$: 'VAlignLineBottom'};
var $author$project$VegaLite$vaLineBottom = $author$project$VegaLite$VAlignLineBottom;
var $author$project$VegaLite$VAlignLineTop = {$: 'VAlignLineTop'};
...
var $author$project$TextFormatTests$textAlign1 = function () {
	var enc = A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$axLabelLineHeight(40),
									$author$project$VegaLite$axLabelBaseline($author$project$VegaLite$vaLineTop)
								]))
						]))),
			A2(
				$author$project$VegaLite$position,
		...
		$author$project$VegaLite$text(
			_List_fromArray(
				[
					$author$project$VegaLite$tStr('Xxgqh')
				])));
	var data = A2(
		$elm$core$Basics$composeL,
		A2(
				...
				return $author$project$VegaLite$asSpec(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$maBaseline($author$project$VegaLite$vaAlphabetic)
								]))
						]));
			case 'bottom':
				return $author$project$VegaLite$asSpec(
...
var $author$project$VegaLite$MFontStyle = function (a) {
	return {$: 'MFontStyle', a: a};
};
var $author$project$VegaLite$maFontStyle = function (s) {
	return $author$project$VegaLite$MFontStyle(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$MEllipsis = function (a) {
	return {$: 'MEllipsis', a: a};
};
		...
		switch (_v0.$) {
			...
			case 'MStroke':
				return $author$project$VegaLite$MStroke(
					$author$project$VegaLite$StrExpr(ex));
			case 'MHRef':
				return $author$project$VegaLite$MHRef(
					$author$project$VegaLite$StrExpr(ex));
			case 'MEllipsis':
				return $author$project$VegaLite$MEllipsis(
					$author$project$VegaLite$StrExpr(ex));
			case 'MText':
...
var $author$project$TextFormatTests$textAlign2 = function () {
		...
		A2(
				...
				A2(
					...
					A2(
																...
																$author$project$VegaLite$ipRange(
																	_List_fromArray(
																		[
																			...
																			$author$project$VegaLite$inMax(36),
																			$author$project$VegaLite$inStep(1)
																		])))
															]))),
												A2(
															...
															$author$project$VegaLite$ipRange(
																_List_fromArray(
																	[
																		...
																		$author$project$VegaLite$inMax(150),
																		$author$project$VegaLite$inStep(1)
																	])))
														]))),
											A2(
												...
												_List_fromArray(
													[
														$author$project$VegaLite$paValue(
														$author$project$VegaLite$str('left')),
														$author$project$VegaLite$paBind(
						...
						A2(
							...
							_List_fromArray(
								[
									$author$project$VegaLite$paExpr('0')
								]))),
					A2(
						$author$project$VegaLite$param,
						'cSize',
								...
								$author$project$VegaLite$ipRange(
									_List_fromArray(
										[
											...
											$author$project$VegaLite$inStep(5)
										])))
							]))),
				A2(
					$author$project$VegaLite$param,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$paValue(
						$author$project$VegaLite$str('grey')),
						$author$project$VegaLite$paBind(
...
var $author$project$VegaLite$AxFormatAsNum = {$: 'AxFormatAsNum'};
var $author$project$VegaLite$axFormatAsNum = $author$project$VegaLite$AxFormatAsNum;
var $author$project$VegaLite$AxFormatAsTemporal = {$: 'AxFormatAsTemporal'};
var $author$project$VegaLite$axFormatAsTemporal = $author$project$VegaLite$AxFormatAsTemporal;
...
var $author$project$VegaLite$LFormatAsTemporal = {$: 'LFormatAsTemporal'};
var $author$project$VegaLite$leFormatAsTemporal = $author$project$VegaLite$LFormatAsTemporal;
var $author$project$VegaLite$MmType = function (a) {
	return {$: 'MmType', a: a};
};
var $author$project$VegaLite$mTemporal = $author$project$VegaLite$MmType($author$project$VegaLite$Temporal);
var $author$project$VegaLite$MDir = function (a) {
	return {$: 'MDir', a: a};
};
var $author$project$VegaLite$maDir = $author$project$VegaLite$MDir;
var $author$project$VegaLite$maEllipsis = function (s) {
	return $author$project$VegaLite$MEllipsis(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$TFormatAsTemporal = {$: 'TFormatAsTemporal'};
...
var $author$project$VegaLite$tTemporal = $author$project$VegaLite$TmType($author$project$VegaLite$Temporal);
var $author$project$VegaLite$RightToLeft = {$: 'RightToLeft'};
var $author$project$VegaLite$tdRightToLeft = $author$project$VegaLite$RightToLeft;
var $author$project$TextFormatTests$textFormat1 = function () {
	var encSym = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$VegaLite$axFormatAsTemporal,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$axFormatAsNum,
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$leFormatAsTemporal,
							$author$project$VegaLite$leFormat('%b %Y')
						]))
				])));
	var specLabel = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				encLabel(_List_Nil),
				$author$project$VegaLite$textMark(
				_List_fromArray(
					[
						...
						$author$project$VegaLite$maDx(22),
						$author$project$VegaLite$maBaseline($author$project$VegaLite$vaMiddle),
						$author$project$VegaLite$maLimit(30),
						$author$project$VegaLite$maEllipsis('~ '),
						$author$project$VegaLite$maDir($author$project$VegaLite$tdRightToLeft)
					]))
			]));
	var data = A2(
		$elm$core$Basics$composeL,
			...
			A2(
				...
				$author$project$VegaLite$strs(
					A2(
						...
						A2($elm$core$List$range, 1981, 2001))))),
		A2(
			$author$project$VegaLite$dataColumn,
			'b',
			$author$project$VegaLite$nums(
				A2(
					...
					A2($elm$core$List$range, 1991, 2011)))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				$author$project$VegaLite$width(600),
				$author$project$VegaLite$height(400),
				A2($author$project$VegaLite$title, 'A title over\ntwo lines with an \\n escaped new line on the second line.', _List_Nil),
				data(_List_Nil),
				$author$project$VegaLite$layer(
				_List_fromArray(
					[specSym, specLabel]))
...
var $author$project$VegaLite$HFormatAsTemporal = {$: 'HFormatAsTemporal'};
		...
		$author$project$VegaLite$column(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$hdFormatAsTemporal,
							$author$project$VegaLite$hdFormat('%b %y')
						]))
				])));
	var data = $author$project$VegaLite$dataFromUrl('https://gicentre.github.io/data/westMidlands/westMidsCrimesAggregated.tsv');
	return $author$project$VegaLite$toVegaLite(
...
var $author$project$VegaLite$TSubtitleFontSize = function (a) {
	return {$: 'TSubtitleFontSize', a: a};
};
var $author$project$VegaLite$TSubtitlePadding = function (a) {
	return {$: 'TSubtitlePadding', a: a};
};
...
var $author$project$TextFormatTests$title1 = function () {
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$VegaLite$paValue(
							$author$project$VegaLite$str('A subtitle')),
							$author$project$VegaLite$paBind(
							$author$project$VegaLite$ipSelect(
								_List_fromArray(
									[
										$author$project$VegaLite$inOptions(
										_List_fromArray(
											['A subtitle', 'A different subtitle', 'And a third subtitle']))
									])))
						]))),
			A2(
				$author$project$VegaLite$param,
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$TextFormatTests$path + 'cars.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				prm(_List_Nil),
				$author$project$VegaLite$padding(
				A4($author$project$VegaLite$paEdges, 5, 250, 5, 5)),
				A2(
				$author$project$VegaLite$title,
...
var $author$project$TextFormatTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('textFormat1', $author$project$TextFormatTests$textFormat1),
		_Utils_Tuple2('textFormat2', $author$project$TextFormatTests$textFormat2),
		_Utils_Tuple2('textAlign1', $author$project$TextFormatTests$textAlign1),
		_Utils_Tuple2('textAlign2', $author$project$TextFormatTests$textAlign2),
		_Utils_Tuple2('multiline1', $author$project$TextFormatTests$multiline1),
		_Utils_Tuple2('customFormatter1', $author$project$TextFormatTests$customFormatter1),
		_Utils_Tuple2('title1', $author$project$TextFormatTests$title1)
	]);
...
var $author$project$TextFormatTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$TextFormatTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$TextFormatTests$NewSource = function (a) {
...
var $author$project$TextFormatTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TextFormatTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$TextFormatTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TextFormatTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TextFormatTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$TextFormatTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$TextFormatTests$update,
		view: $author$project$TextFormatTests$view
	});
_Platform_export({'TextFormatTests':{'init':$author$project$TextFormatTests$main(
