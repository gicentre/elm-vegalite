...
var $author$project$ParamTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$ParamTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$ParamTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$ParamTests$update,
		view: $author$project$ParamTests$view
	});
