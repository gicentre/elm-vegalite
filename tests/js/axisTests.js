...
var $author$project$AxisTests$qAxisBase = function (maybeCfg) {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var cfg = function () {
		if (maybeCfg.$ === 'Just') {
			var axCfg = maybeCfg.a;
			return A2(
				$elm$core$Basics$composeL,
				$author$project$VegaLite$configure,
				$author$project$VegaLite$configuration(axCfg));
		} else {
			return $author$project$VegaLite$configure;
		}
	}();
...
var $author$project$VegaLite$AxisBand = F2(
	function (a, b) {
		return {$: 'AxisBand', a: a, b: b};
	});
var $author$project$VegaLite$AxisDiscrete = F2(
	function (a, b) {
		return {$: 'AxisDiscrete', a: a, b: b};
	});
var $author$project$VegaLite$AxisPoint = F2(
	function (a, b) {
		return {$: 'AxisPoint', a: a, b: b};
	});
var $author$project$VegaLite$AxisQuant = F2(
	function (a, b) {
		return {$: 'AxisQuant', a: a, b: b};
	});
var $author$project$VegaLite$AxisTemporal = F2(
	function (a, b) {
		return {$: 'AxisTemporal', a: a, b: b};
	});
var $author$project$VegaLite$AxX = {$: 'AxX'};
var $author$project$VegaLite$axX = $author$project$VegaLite$AxX;
...
var $author$project$VegaLite$AxY = {$: 'AxY'};
var $author$project$VegaLite$axY = $author$project$VegaLite$AxY;
...
var $author$project$AxisTests$axis11 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$AxDomainDash = function (a) {
	return {$: 'AxDomainDash', a: a};
};
var $author$project$VegaLite$axDomainDash = $author$project$VegaLite$AxDomainDash;
...
var $author$project$VegaLite$AxisStyles = function (a) {
	return {$: 'AxisStyles', a: a};
};
var $author$project$VegaLite$coAxisStyles = $author$project$VegaLite$AxisStyles;
var $author$project$VegaLite$PAxis = function (a) {
	return {$: 'PAxis', a: a};
};
var $author$project$VegaLite$pAxis = $author$project$VegaLite$PAxis;
var $author$project$AxisTests$axis12 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$axStyle(
								_List_fromArray(
									['redStyle']))
							]))
					]))),
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisStyles(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'redStyle',
						_List_fromArray(
							[
								$author$project$VegaLite$axDomainColor('red'),
								$author$project$VegaLite$axLabelColor('red'),
								$author$project$VegaLite$axTitleColor('red'),
								$author$project$VegaLite$axTickCount(
								$author$project$VegaLite$niTickCount(10)),
								$author$project$VegaLite$axDomainDash(
								_List_fromArray(
									[4, 2, 8, 4]))
							])),
						_Utils_Tuple2(
						...
						_List_fromArray(
							[
								$author$project$VegaLite$axDomainColor('blue'),
								$author$project$VegaLite$axLabelColor('blue'),
								$author$project$VegaLite$axTitleColor('blue'),
								$author$project$VegaLite$axTickCount(
								$author$project$VegaLite$niTickCount(10))
							]))
					]))));
...
var $author$project$VegaLite$AxDomainCap = function (a) {
	return {$: 'AxDomainCap', a: a};
};
var $author$project$VegaLite$axDomainCap = $author$project$VegaLite$AxDomainCap;
...
var $author$project$VegaLite$AxGridCap = function (a) {
	return {$: 'AxGridCap', a: a};
};
var $author$project$VegaLite$axGridCap = $author$project$VegaLite$AxGridCap;
var $author$project$VegaLite$CAxGridDash = F2(
	function (a, b) {
		return {$: 'CAxGridDash', a: a, b: b};
	});
var $author$project$VegaLite$cAxGridDash = $author$project$VegaLite$CAxGridDash;
var $author$project$VegaLite$CAxGridDashOffset = F2(
	function (a, b) {
		return {$: 'CAxGridDashOffset', a: a, b: b};
	});
var $author$project$VegaLite$cAxGridDashOffset = $author$project$VegaLite$CAxGridDashOffset;
var $author$project$VegaLite$CAxTickDash = F2(
	function (a, b) {
		return {$: 'CAxTickDash', a: a, b: b};
	});
var $author$project$VegaLite$cAxTickDash = $author$project$VegaLite$CAxTickDash;
var $author$project$VegaLite$CAxTickDashOffset = F2(
	function (a, b) {
		return {$: 'CAxTickDashOffset', a: a, b: b};
	});
var $author$project$VegaLite$cAxTickDashOffset = $author$project$VegaLite$CAxTickDashOffset;
var $author$project$VegaLite$CRound = {$: 'CRound'};
var $author$project$VegaLite$caRound = $author$project$VegaLite$CRound;
var $author$project$VegaLite$CSquare = {$: 'CSquare'};
var $author$project$VegaLite$caSquare = $author$project$VegaLite$CSquare;
var $author$project$AxisTests$axis15 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$axDomainCap($author$project$VegaLite$caSquare),
								$author$project$VegaLite$axDomainWidth(6),
								$author$project$VegaLite$axDomainDash(
								_List_fromArray(
									[12, 12])),
								A2(
								$author$project$VegaLite$axDataCondition,
								$author$project$VegaLite$expr('datum.label < \'5\''),
								A2(
								...
								A2(
								$author$project$VegaLite$axDataCondition,
								$author$project$VegaLite$expr('datum.label < \'3\''),
								A2($author$project$VegaLite$cAxTickDashOffset, 0, 8))
							]))
					]))),
		A2(
			$author$project$VegaLite$position,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$axGridCap($author$project$VegaLite$caRound),
							$author$project$VegaLite$axGridWidth(3),
							A2(
							$author$project$VegaLite$axDataCondition,
							...
							A2($author$project$VegaLite$cAxGridDashOffset, 0, 8))
						]))
				])));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$VegaLite$AxBandPosition = function (a) {
	return {$: 'AxBandPosition', a: a};
};
var $author$project$VegaLite$axBandPosition = function (n) {
	return $author$project$VegaLite$AxBandPosition(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxDomainOpacity = function (a) {
	return {$: 'AxDomainOpacity', a: a};
};
var $author$project$VegaLite$axDomainOpacity = function (n) {
	return $author$project$VegaLite$AxDomainOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxLabelFlushOffset = function (a) {
	return {$: 'AxLabelFlushOffset', a: a};
};
var $author$project$VegaLite$axLabelFlushOffset = function (n) {
	return $author$project$VegaLite$AxLabelFlushOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxLabelLimit = function (a) {
	return {$: 'AxLabelLimit', a: a};
};
var $author$project$VegaLite$axLabelLimit = function (n) {
	return $author$project$VegaLite$AxLabelLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxLabelSeparation = function (a) {
	return {$: 'AxLabelSeparation', a: a};
};
var $author$project$VegaLite$axLabelSeparation = function (n) {
	return $author$project$VegaLite$AxLabelSeparation(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$AxDomainDashOffset = function (a) {
	return {$: 'AxDomainDashOffset', a: a};
};
var $author$project$VegaLite$AxLabelLineHeight = function (a) {
	return {$: 'AxLabelLineHeight', a: a};
};
var $author$project$VegaLite$AxMaxExtent = function (a) {
	return {$: 'AxMaxExtent', a: a};
};
var $author$project$VegaLite$AxOffset = function (a) {
	return {$: 'AxOffset', a: a};
};
var $author$project$VegaLite$AxPosition = function (a) {
	return {$: 'AxPosition', a: a};
};
var $author$project$VegaLite$AxTickMinStep = function (a) {
	return {$: 'AxTickMinStep', a: a};
};
var $author$project$VegaLite$AxTickOffset = function (a) {
	return {$: 'AxTickOffset', a: a};
};
var $author$project$VegaLite$AxTitleAngle = function (a) {
	return {$: 'AxTitleAngle', a: a};
};
var $author$project$VegaLite$AxTitleFontSize = function (a) {
	return {$: 'AxTitleFontSize', a: a};
};
var $author$project$VegaLite$AxTitleLimit = function (a) {
	return {$: 'AxTitleLimit', a: a};
};
var $author$project$VegaLite$AxTitleLineHeight = function (a) {
	return {$: 'AxTitleLineHeight', a: a};
};
var $author$project$VegaLite$AxTitleOpacity = function (a) {
	return {$: 'AxTitleOpacity', a: a};
};
var $author$project$VegaLite$AxTitlePadding = function (a) {
	return {$: 'AxTitlePadding', a: a};
};
var $author$project$VegaLite$AxTitleX = function (a) {
	return {$: 'AxTitleX', a: a};
};
var $author$project$VegaLite$AxTitleY = function (a) {
	return {$: 'AxTitleY', a: a};
};
var $author$project$VegaLite$AxTranslate = function (a) {
	return {$: 'AxTranslate', a: a};
};
...
var $author$project$VegaLite$axNumExpr = F2(
	function (ex, fn) {
		...
		switch (_v0.$) {
			...
			case 'AxMaxExtent':
				return $author$project$VegaLite$AxMaxExtent(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxMinExtent':
				return $author$project$VegaLite$AxMinExtent(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxOffset':
				return $author$project$VegaLite$AxOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxPosition':
				return $author$project$VegaLite$AxPosition(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTranslate':
				return $author$project$VegaLite$AxTranslate(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxZIndex':
				return $author$project$VegaLite$AxZIndex(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxDomainDashOffset':
				return $author$project$VegaLite$AxDomainDashOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxDomainOpacity':
				return $author$project$VegaLite$AxDomainOpacity(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 'AxLabelFontSize':
				return $author$project$VegaLite$AxLabelFontSize(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxLabelLineHeight':
				return $author$project$VegaLite$AxLabelLineHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxLabelLimit':
				return $author$project$VegaLite$AxLabelLimit(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 'AxTickDashOffset':
				return $author$project$VegaLite$AxTickDashOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTickOffset':
				return $author$project$VegaLite$AxTickOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTickOpacity':
				return $author$project$VegaLite$AxTickOpacity(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 'AxTickWidth':
				return $author$project$VegaLite$AxTickWidth(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleAngle':
				return $author$project$VegaLite$AxTitleAngle(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleFontSize':
				return $author$project$VegaLite$AxTitleFontSize(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleLimit':
				return $author$project$VegaLite$AxTitleLimit(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleLineHeight':
				return $author$project$VegaLite$AxTitleLineHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleOpacity':
				return $author$project$VegaLite$AxTitleOpacity(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitlePadding':
				return $author$project$VegaLite$AxTitlePadding(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleX':
				return $author$project$VegaLite$AxTitleX(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxTitleY':
				return $author$project$VegaLite$AxTitleY(
					$author$project$VegaLite$NumExpr(ex));
			case 'AxGridDashOffset':
				return $author$project$VegaLite$AxGridDashOffset(
					$author$project$VegaLite$NumExpr(ex));
...
var $author$project$VegaLite$axPosition = function (n) {
	return $author$project$VegaLite$AxPosition(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$AxTitleFont = function (a) {
	return {$: 'AxTitleFont', a: a};
};
var $author$project$VegaLite$AxTitleFontStyle = function (a) {
	return {$: 'AxTitleFontStyle', a: a};
};
		...
		switch (_v0.$) {
			...
			case 'AxTitleColor':
				return $author$project$VegaLite$AxTitleColor(
					$author$project$VegaLite$StrExpr(ex));
			case 'AxTitleFont':
				return $author$project$VegaLite$AxTitleFont(
					$author$project$VegaLite$StrExpr(ex));
			case 'AxTitleFontStyle':
				return $author$project$VegaLite$AxTitleFontStyle(
					$author$project$VegaLite$StrExpr(ex));
			case 'AxGridColor':
				return $author$project$VegaLite$AxGridColor(
					$author$project$VegaLite$StrExpr(ex));
...
var $author$project$VegaLite$AxTickCap = function (a) {
	return {$: 'AxTickCap', a: a};
};
var $author$project$VegaLite$axTickCap = $author$project$VegaLite$AxTickCap;
var $author$project$VegaLite$axTickOffset = function (n) {
	return $author$project$VegaLite$AxTickOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxTitleAlign = function (a) {
	return {$: 'AxTitleAlign', a: a};
};
var $author$project$VegaLite$axTitleAlign = $author$project$VegaLite$AxTitleAlign;
var $author$project$VegaLite$AxTitleAnchor = function (a) {
	return {$: 'AxTitleAnchor', a: a};
};
var $author$project$VegaLite$axTitleAnchor = $author$project$VegaLite$AxTitleAnchor;
var $author$project$VegaLite$axTitleAngle = function (n) {
	return $author$project$VegaLite$AxTitleAngle(
		$author$project$VegaLite$Num(
			$author$project$VegaLite$positiveAngle(n)));
};
var $author$project$VegaLite$AxTitleBaseline = function (a) {
	return {$: 'AxTitleBaseline', a: a};
};
var $author$project$VegaLite$axTitleBaseline = $author$project$VegaLite$AxTitleBaseline;
var $author$project$VegaLite$axTitleFont = function (s) {
	return $author$project$VegaLite$AxTitleFont(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$axTitleFontStyle = function (s) {
	return $author$project$VegaLite$AxTitleFontStyle(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$AxTitleFontWeight = function (a) {
	return {$: 'AxTitleFontWeight', a: a};
};
var $author$project$VegaLite$axTitleFontWeight = $author$project$VegaLite$AxTitleFontWeight;
var $author$project$VegaLite$axTitleLimit = function (n) {
	return $author$project$VegaLite$AxTitleLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$axTitleLineHeight = function (n) {
	return $author$project$VegaLite$AxTitleLineHeight(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$axTitleOpacity = function (n) {
	return $author$project$VegaLite$AxTitleOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$axTranslate = function (n) {
	return $author$project$VegaLite$AxTranslate(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$VLPadding = {$: 'VLPadding'};
var $author$project$VegaLite$padding = function (pad) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLPadding,
		$author$project$VegaLite$paddingSpec(pad));
};
...
var $author$project$AxisTests$axis16 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
																										...
																										_List_fromArray(
																											[
																												...
																												$author$project$VegaLite$ipRange(
																													_List_fromArray(
																														[
																															$author$project$VegaLite$inName('Label padding '),
																															$author$project$VegaLite$inMin(-30),
																															$author$project$VegaLite$inMax(30)
																														])))
																											]))),
																									...
																									_List_fromArray(
																										[
																											...
																											$author$project$VegaLite$ipRange(
																												_List_fromArray(
																													[
																														$author$project$VegaLite$inName('Label separation '),
																														$author$project$VegaLite$inMin(0),
																														$author$project$VegaLite$inMax(20)
																													])))
																										]))),
																								...
																								_List_fromArray(
																									[
																										...
																										$author$project$VegaLite$ipSelect(
																											_List_fromArray(
																												[
																													$author$project$VegaLite$inName('Tick cap '),
																													$author$project$VegaLite$inOptions(
																													_List_fromArray(
																														['butt', 'round', 'square']))
																												])))
																							...
																							_List_fromArray(
																								[
																									...
																									$author$project$VegaLite$ipColor(
																										_List_fromArray(
																											[
																												$author$project$VegaLite$inName('Tick colour ')
																											])))
																								]))),
																					A2(
																						$author$project$VegaLite$param,
																						...
																						_List_fromArray(
																							[
																								...
																								$author$project$VegaLite$ipRange(
																									_List_fromArray(
																										[
																											$author$project$VegaLite$inName('Tick offset '),
																											$author$project$VegaLite$inMin(-30),
																											$author$project$VegaLite$inMax(30)
																										])))
																							]))),
																					...
																					_List_fromArray(
																						[
																							...
																							$author$project$VegaLite$ipRange(
																								_List_fromArray(
																									[
																										$author$project$VegaLite$inName('Tick opacity '),
																										$author$project$VegaLite$inMin(0),
																										$author$project$VegaLite$inMax(1)
																									])))
																						]))),
																				...
																				_List_fromArray(
																					[
																						...
																						$author$project$VegaLite$ipRange(
																							_List_fromArray(
																								[
																									$author$project$VegaLite$inName('Tick size '),
																									$author$project$VegaLite$inMin(-20),
																									$author$project$VegaLite$inMax(20)
																								])))
																					]))),
																			...
																			_List_fromArray(
																				[
																					...
																					$author$project$VegaLite$ipRange(
																						_List_fromArray(
																							[
																								$author$project$VegaLite$inName('Tick width '),
																								$author$project$VegaLite$inMin(0),
																								$author$project$VegaLite$inMax(12)
																							])))
																				]))),
																		...
																		_List_fromArray(
																			[
																				...
																				$author$project$VegaLite$ipSelect(
																					_List_fromArray(
																						[
																							$author$project$VegaLite$inName('Title align '),
																							$author$project$VegaLite$inOptions(
																							_List_fromArray(
																								['center', 'left', 'right']))
																						])))
																	...
																	_List_fromArray(
																		[
																			...
																			$author$project$VegaLite$ipSelect(
																				_List_fromArray(
																					[
																						$author$project$VegaLite$inName('Title anchor '),
																						$author$project$VegaLite$inOptions(
																						_List_fromArray(
																							['start', 'middle', 'end']))
																					])))
																...
																_List_fromArray(
																	[
																		...
																		$author$project$VegaLite$ipRange(
																			_List_fromArray(
																				[
																					$author$project$VegaLite$inName('Title angle '),
																					$author$project$VegaLite$inMin(-90),
																					$author$project$VegaLite$inMax(90),
																					$author$project$VegaLite$inStep(1)
																				])))
															...
															_List_fromArray(
																[
																	...
																	$author$project$VegaLite$ipSelect(
																		_List_fromArray(
																			[
																				$author$project$VegaLite$inName('Title baseline '),
																				$author$project$VegaLite$inOptions(
																				_List_fromArray(
																					['alphabetic', 'top', 'middle', 'bottom', 'line-top', 'line-bottom']))
																			])))
														...
														_List_fromArray(
															[
																...
																$author$project$VegaLite$ipColor(
																	_List_fromArray(
																		[
																			$author$project$VegaLite$inName('Title colour ')
																		])))
															]))),
												A2(
													$author$project$VegaLite$param,
													...
													_List_fromArray(
														[
															...
															$author$project$VegaLite$ipSelect(
																_List_fromArray(
																	[
																		$author$project$VegaLite$inName('Title font '),
																		$author$project$VegaLite$inOptions(
																		_List_fromArray(
																			['sans-serif', 'serif', 'monospace']))
																	])))
												...
												_List_fromArray(
													[
														...
														$author$project$VegaLite$ipSelect(
															_List_fromArray(
																[
																	$author$project$VegaLite$inName('Title style '),
																	$author$project$VegaLite$inOptions(
																	_List_fromArray(
																		['normal', 'italic']))
																])))
											...
											_List_fromArray(
												[
													...
													$author$project$VegaLite$ipSelect(
														_List_fromArray(
															[
																$author$project$VegaLite$inName('Title weight '),
																$author$project$VegaLite$inOptions(
																_List_fromArray(
																	['normal', 'bold', 'lighter']))
															])))
										...
										_List_fromArray(
											[
												...
												$author$project$VegaLite$ipRange(
													_List_fromArray(
														[
															$author$project$VegaLite$inName('Title limit '),
															$author$project$VegaLite$inMin(0),
															$author$project$VegaLite$inMax(200)
														])))
											]))),
									...
									_List_fromArray(
										[
											...
											$author$project$VegaLite$ipRange(
												_List_fromArray(
													[
														$author$project$VegaLite$inName('Title line height '),
								...
								_List_fromArray(
									[
										...
										$author$project$VegaLite$ipRange(
											_List_fromArray(
												[
													$author$project$VegaLite$inName('Title opacity '),
													$author$project$VegaLite$inMin(0),
													$author$project$VegaLite$inMax(1)
												])))
									]))),
							...
							_List_fromArray(
								[
									...
									$author$project$VegaLite$ipRange(
										_List_fromArray(
											[
												$author$project$VegaLite$inName('Title padding '),
												$author$project$VegaLite$inMin(-20),
												$author$project$VegaLite$inMax(20)
											])))
								]))),
						...
						_List_fromArray(
							[
								...
								$author$project$VegaLite$ipSelect(
									_List_fromArray(
										[
											$author$project$VegaLite$inName('Grid cap '),
											$author$project$VegaLite$inOptions(
											_List_fromArray(
												['butt', 'round', 'square']))
										])))
					...
					_List_fromArray(
						[
							...
							$author$project$VegaLite$ipColor(
								_List_fromArray(
									[
										$author$project$VegaLite$inName('Grid colour ')
									])))
						]))),
			A2(
				$author$project$VegaLite$param,
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$ipRange(
							_List_fromArray(
								[
									$author$project$VegaLite$inName('Grid opacity '),
									$author$project$VegaLite$inMin(0),
									$author$project$VegaLite$inMax(1)
								])))
					]))),
			...
			_List_fromArray(
				[
					...
					$author$project$VegaLite$ipRange(
						_List_fromArray(
							[
								$author$project$VegaLite$inName('Grid width '),
								$author$project$VegaLite$inMin(0),
								$author$project$VegaLite$inMax(12)
							])))
				])));
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$VegaLite$axNumExpr, 'bandPosition', $author$project$VegaLite$axBandPosition),
								A2($author$project$VegaLite$axNumExpr, 'offset', $author$project$VegaLite$axOffset),
								A2($author$project$VegaLite$axNumExpr, 'minExtent', $author$project$VegaLite$axMinExtent),
								$author$project$VegaLite$axOrient(
								$author$project$VegaLite$siExpr('orient')),
								$author$project$VegaLite$axDomainCap(
								$author$project$VegaLite$caExpr('domainCap')),
								A2($author$project$VegaLite$axStrExpr, 'domainColor', $author$project$VegaLite$axDomainColor),
								A2($author$project$VegaLite$axNumExpr, 'domainOpacity', $author$project$VegaLite$axDomainOpacity),
								A2($author$project$VegaLite$axNumExpr, 'domainWidth', $author$project$VegaLite$axDomainWidth),
								A2($author$project$VegaLite$axNumExpr, 'position', $author$project$VegaLite$axPosition),
								A2($author$project$VegaLite$axNumExpr, 'translate', $author$project$VegaLite$axTranslate),
								$author$project$VegaLite$axLabelAlign(
								$author$project$VegaLite$haExpr('labelAlign')),
								$author$project$VegaLite$axLabelBaseline(
								...
								A2($author$project$VegaLite$axStrExpr, 'labelColor', $author$project$VegaLite$axLabelColor),
								A2($author$project$VegaLite$axNumExpr, 'labelFlushOffset', $author$project$VegaLite$axLabelFlushOffset),
								A2($author$project$VegaLite$axStrExpr, 'labelFont', $author$project$VegaLite$axLabelFont),
								A2($author$project$VegaLite$axNumExpr, 'labelFontSize', $author$project$VegaLite$axLabelFontSize),
								A2($author$project$VegaLite$axStrExpr, 'labelFontStyle', $author$project$VegaLite$axLabelFontStyle),
								$author$project$VegaLite$axLabelFontWeight(
								...
								A2($author$project$VegaLite$axStrExpr, 'tickColor', $author$project$VegaLite$axTickColor),
								A2($author$project$VegaLite$axNumExpr, 'tickOffset', $author$project$VegaLite$axTickOffset),
								A2($author$project$VegaLite$axNumExpr, 'tickOpacity', $author$project$VegaLite$axTickOpacity),
								A2($author$project$VegaLite$axNumExpr, 'tickSize', $author$project$VegaLite$axTickSize),
								A2($author$project$VegaLite$axNumExpr, 'tickWidth', $author$project$VegaLite$axTickWidth),
								$author$project$VegaLite$axTitleAnchor(
								$author$project$VegaLite$anExpr('titleAnchor')),
								$author$project$VegaLite$axTitleAlign(
								$author$project$VegaLite$haExpr('titleAlign')),
								A2($author$project$VegaLite$axNumExpr, 'titleAngle', $author$project$VegaLite$axTitleAngle),
								$author$project$VegaLite$axTitleBaseline(
								...
								A2($author$project$VegaLite$axStrExpr, 'titleFont', $author$project$VegaLite$axTitleFont),
								A2($author$project$VegaLite$axStrExpr, 'titleFontStyle', $author$project$VegaLite$axTitleFontStyle),
								$author$project$VegaLite$axTitleFontWeight(
	...
	var dataMovies = A2($author$project$VegaLite$dataFromUrl, $author$project$AxisTests$path + 'movies.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				ps(_List_Nil),
...
var $author$project$VegaLite$GridColor = function (a) {
	return {$: 'GridColor', a: a};
};
var $author$project$VegaLite$axcoGridColor = $author$project$VegaLite$GridColor;
var $author$project$VegaLite$coAxisQuant = $author$project$VegaLite$AxisQuant($author$project$VegaLite$AxBoth);
var $author$project$AxisTests$axis1a = $author$project$AxisTests$qAxisBase(
	$elm$core$Maybe$Just(
		$author$project$VegaLite$coAxisQuant(
			_List_fromArray(
				[
					$author$project$VegaLite$axcoGridColor('red')
				]))));
				...
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							'date',
							$author$project$VegaLite$foDate('%Y-%m-%d %H:%M:%S'))
						]))
				])),
		A2(
			$author$project$VegaLite$dataColumn,
...
var $author$project$AxisTests$tAxisBase = function (maybeCfg) {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$DomainDash = function (a) {
	return {$: 'DomainDash', a: a};
};
var $author$project$VegaLite$axcoDomainDash = $author$project$VegaLite$DomainDash;
var $author$project$VegaLite$DomainDashOffset = function (a) {
	return {$: 'DomainDashOffset', a: a};
};
var $author$project$VegaLite$axcoDomainDashOffset = $author$project$VegaLite$DomainDashOffset;
var $author$project$VegaLite$GridDash = function (a) {
	return {$: 'GridDash', a: a};
};
var $author$project$VegaLite$axcoGridDash = $author$project$VegaLite$GridDash;
var $author$project$VegaLite$GridDashOffset = function (a) {
	return {$: 'GridDashOffset', a: a};
};
var $author$project$VegaLite$axcoGridDashOffset = $author$project$VegaLite$GridDashOffset;
var $author$project$VegaLite$TickDash = function (a) {
	return {$: 'TickDash', a: a};
};
var $author$project$VegaLite$axcoTickDash = $author$project$VegaLite$TickDash;
var $author$project$VegaLite$TickDashOffset = function (a) {
	return {$: 'TickDashOffset', a: a};
};
var $author$project$VegaLite$axcoTickDashOffset = $author$project$VegaLite$TickDashOffset;
var $author$project$VegaLite$TickSize = function (a) {
	return {$: 'TickSize', a: a};
};
var $author$project$VegaLite$axcoTickSize = $author$project$VegaLite$TickSize;
var $author$project$VegaLite$coAxisTemporal = $author$project$VegaLite$AxisTemporal($author$project$VegaLite$AxBoth);
var $author$project$AxisTests$axis4a = $author$project$AxisTests$tAxisBase(
	$elm$core$Maybe$Just(
		$author$project$VegaLite$coAxisTemporal(
			_List_fromArray(
				[
					$author$project$VegaLite$axcoGridColor('red'),
					$author$project$VegaLite$axcoDomainDash(
					_List_fromArray(
						[6, 6])),
					$author$project$VegaLite$axcoDomainDashOffset(6),
					$author$project$VegaLite$axcoGridDash(
					_List_fromArray(
						[3, 3])),
					$author$project$VegaLite$axcoGridDashOffset(3),
					$author$project$VegaLite$axcoTickSize(10),
					$author$project$VegaLite$axcoTickDash(
					_List_fromArray(
						[2, 2])),
					$author$project$VegaLite$axcoTickDashOffset(2)
				]))));
...
var $author$project$VegaLite$Jan = {$: 'Jan'};
									...
									_List_fromArray(
										[
											...
											[
												...
												$author$project$VegaLite$dtMonth($author$project$VegaLite$Jan),
...
var $author$project$AxisTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('axis01', $author$project$AxisTests$axis1),
		_Utils_Tuple2('axis01a', $author$project$AxisTests$axis1a),
		_Utils_Tuple2('axis02', $author$project$AxisTests$axis2),
		_Utils_Tuple2('axis03', $author$project$AxisTests$axis3),
		_Utils_Tuple2('axis04', $author$project$AxisTests$axis4),
		_Utils_Tuple2('axis04a', $author$project$AxisTests$axis4a),
		_Utils_Tuple2('axis05', $author$project$AxisTests$axis5),
		_Utils_Tuple2('axis06', $author$project$AxisTests$axis6),
		_Utils_Tuple2('axis07', $author$project$AxisTests$axis7),
		_Utils_Tuple2('axis08', $author$project$AxisTests$axis8),
		_Utils_Tuple2('axis09', $author$project$AxisTests$axis9),
		...
		_Utils_Tuple2('axis15', $author$project$AxisTests$axis15),
		_Utils_Tuple2('axis16', $author$project$AxisTests$axis16)
	]);
...
var $author$project$AxisTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$AxisTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$AxisTests$NewSource = function (a) {
	return {$: 'NewSource', a: a};
};
...
var $author$project$AxisTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$AxisTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$AxisTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$AxisTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$AxisTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$AxisTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$AxisTests$update,
		view: $author$project$AxisTests$view
	});
