...
var $author$project$VegaLite$axDomainDash = function (ns) {
	return $author$project$VegaLite$AxDomainDash(
		$author$project$VegaLite$Nums(ns));
};
...
var $author$project$VegaLite$CSquare = {$: 2};
...
var $author$project$VegaLite$axDomainDashOffset = function (n) {
...
var $author$project$VegaLite$AxLabelBound = function (a) {
	return {$: 23, a: a};
};
var $author$project$VegaLite$MaybeNumExpr = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$axLabelBoundExpr = function (ex) {
	return $author$project$VegaLite$AxLabelBound(
...
var $author$project$VegaLite$axNumsExpr = F2(
	function (ex, fn) {
...
var $author$project$VegaLite$AxTickBand = function (a) {
	return {$: 42, a: a};
};
var $author$project$VegaLite$axTickBand = $author$project$VegaLite$AxTickBand;
...
var $author$project$AxisTests$axis16 = function () {
	var solid = $author$project$VegaLite$daConcat(
		$author$project$VegaLite$nums(_List_Nil));
	var shortDash = $author$project$VegaLite$daConcat(
		$author$project$VegaLite$nums(
			_List_fromArray(
				[2, 2])));
	var longDash = $author$project$VegaLite$daConcat(
		$author$project$VegaLite$nums(
			_List_fromArray(
				[8, 8])));
	var ps = A2(
																																												...
																																												_List_fromArray(
																																													[
																																														...
																																														$author$project$VegaLite$ipSelect(
																																															_List_fromArray(
																																																[
																																																	$author$project$VegaLite$inName('Label bound '),
																																																	$author$project$VegaLite$inDataOptions(
																																																	_List_fromArray(
																																																		[
																																																			$author$project$VegaLite$boo(false),
																														...
																														_List_fromArray(
																															[
																																...
																																$author$project$VegaLite$ipSelect(
																																	_List_fromArray(
																																		[
																																			$author$project$VegaLite$inName('Tick band '),
																																			$author$project$VegaLite$inOptions(
																																			_List_fromArray(
																																				['center', 'extent']))
																																		])))
																											...
																											_List_fromArray(
																												[
																													...
																													$author$project$VegaLite$ipRange(
																														_List_fromArray(
																															[
																																$author$project$VegaLite$inName('Tick count '),
																										...
																										_List_fromArray(
																											[
																												...
																												$author$project$VegaLite$ipSelect(
																													_List_fromArray(
																														[
																															$author$project$VegaLite$inName('Tick dash '),
																															$author$project$VegaLite$inDataOptions(
																															_List_fromArray(
																																[solid, shortDash, longDash]))
																														])))
																									...
																									_List_fromArray(
																										[
																											...
																											$author$project$VegaLite$ipRange(
																												_List_fromArray(
																													[
																														$author$project$VegaLite$inName('Tick dash offset '),
																														$author$project$VegaLite$inMin(0),
																														$author$project$VegaLite$inMax(12)
																													])))
																										]))),
						...
						_List_fromArray(
							[
								...
								$author$project$VegaLite$ipSelect(
									_List_fromArray(
										[
											$author$project$VegaLite$inName('Grid dash '),
											$author$project$VegaLite$inDataOptions(
											_List_fromArray(
												[solid, shortDash, longDash]))
										])))
					...
					_List_fromArray(
						[
							...
							$author$project$VegaLite$ipRange(
								_List_fromArray(
									[
										$author$project$VegaLite$inName('Grid dash offset '),
										$author$project$VegaLite$inMin(0),
										$author$project$VegaLite$inMax(12)
									])))
						]))),
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$VegaLite$axNumsExpr, 'domainDash', $author$project$VegaLite$axDomainDash),
								A2($author$project$VegaLite$axNumExpr, 'domainDashOffset', $author$project$VegaLite$axDomainDashOffset),
								...
								$author$project$VegaLite$axTickBand(
								...
								A2($author$project$VegaLite$axNumsExpr, 'tickDash', $author$project$VegaLite$axTickDash),
								A2($author$project$VegaLite$axNumExpr, 'tickDashOffset', $author$project$VegaLite$axTickDashOffset),
...
var $author$project$AxisTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$AxisTests$main = $elm$browser$Browser$element(
	{
		...
		az: $author$project$AxisTests$update,
		aA: $author$project$AxisTests$view
	});
