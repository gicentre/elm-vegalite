...
var $author$project$VegaLite$Boxplot = {$: 'Boxplot'};
...
var $author$project$VegaLite$boxplot = $author$project$VegaLite$mark($author$project$VegaLite$Boxplot);
...
var $author$project$VegaLite$ExRange = {$: 'ExRange'};
...
var $author$project$VegaLite$Errorband = {$: 'Errorband'};
var $author$project$VegaLite$errorband = $author$project$VegaLite$mark($author$project$VegaLite$Errorband);
var $author$project$VegaLite$ExCI = {$: 'ExCI'};
var $author$project$VegaLite$exCi = $author$project$VegaLite$ExCI;
var $author$project$VegaLite$ExIqr = {$: 'ExIqr'};
var $author$project$VegaLite$exIqr = $author$project$VegaLite$ExIqr;
var $author$project$VegaLite$ExStderr = {$: 'ExStderr'};
var $author$project$VegaLite$exStderr = $author$project$VegaLite$ExStderr;
var $author$project$VegaLite$ExStdev = {$: 'ExStdev'};
...
var $author$project$VegaLite$Errorbar = {$: 'Errorbar'};
var $author$project$VegaLite$errorbar = $author$project$VegaLite$mark($author$project$VegaLite$Errorbar);
...
var $author$project$VegaLite$XError = {$: 'XError'};
...
var $author$project$CompositeTests$errorbar4 = function () {
	...
	var encErrorBars = A2(
		...
		A2(
			$author$project$VegaLite$position,
			$author$project$VegaLite$XError,
			_List_fromArray(
				[
...
var $author$project$VegaLite$XError2 = {$: 'XError2'};
...
var $author$project$CompositeTests$errorbar5 = function () {
	...
	var encErrorBars = A2(
		...
		A2(
			$author$project$VegaLite$position,
			$author$project$VegaLite$XError2,
			_List_fromArray(
				[
...
var $author$project$VegaLite$YError = {$: 'YError'};
var $author$project$CompositeTests$errorbar6 = function () {
	...
	var encErrorBars = A2(
		...
		A2(
			$author$project$VegaLite$position,
			$author$project$VegaLite$YError,
			_List_fromArray(
				[
					$author$project$VegaLite$pName('yieldError')
				])));
...
var $author$project$VegaLite$YError2 = {$: 'YError2'};
var $author$project$CompositeTests$errorbar7 = function () {
	...
	var encErrorBars = A2(
		...
		A2(
			$author$project$VegaLite$position,
			$author$project$VegaLite$YError2,
			_List_fromArray(
				[
					$author$project$VegaLite$pName('yieldError2')
				])));
...
var $author$project$CompositeTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$CompositeTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$CompositeTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$CompositeTests$update,
		view: $author$project$CompositeTests$view
	});
