...
var $author$project$VegaLite$CAxLabelPadding = F2(
	function (a, b) {
		return {$: 'CAxLabelPadding', a: a, b: b};
	});
...
var $author$project$VegaLite$CAxLabelBaseline = F2(
	function (a, b) {
		return {$: 'CAxLabelBaseline', a: a, b: b};
	});
...
var $author$project$VegaLite$CAxLabelFontSize = F2(
	function (a, b) {
		return {$: 'CAxLabelFontSize', a: a, b: b};
	});
...
var $author$project$VegaLite$CAxLabelFontStyle = F2(
	function (a, b) {
		return {$: 'CAxLabelFontStyle', a: a, b: b};
	});
...
var $author$project$VegaLite$CAxLabelFontWeight = F2(
	function (a, b) {
		return {$: 'CAxLabelFontWeight', a: a, b: b};
	});
...
var $author$project$VegaLite$CAxLabelOpacity = F2(
	function (a, b) {
		return {$: 'CAxLabelOpacity', a: a, b: b};
	});
...
var $author$project$ConditionalTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$ConditionalTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$ConditionalTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$ConditionalTests$update,
		view: $author$project$ConditionalTests$view
	});
