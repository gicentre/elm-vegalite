...
var $author$project$RadialTests$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $elm$json$Json$Encode$null = _Json_encodeNull;
var $author$project$VegaLite$Theta = {$: 'Theta'};
var $author$project$VegaLite$Arc = {$: 'Arc'};
...
var $author$project$VegaLite$arc = $author$project$VegaLite$mark($author$project$VegaLite$Arc);
...
var $author$project$VegaLite$maInnerRadius = function (n) {
...
var $author$project$VegaLite$maTheta2Offset = function (n) {
...
var $author$project$VegaLite$maThetaOffset = function (n) {
...
var $author$project$VegaLite$R = {$: 'R'};
var $author$project$VegaLite$R2 = {$: 'R2'};
var $author$project$VegaLite$Theta2 = {$: 'Theta2'};
...
var $author$project$RadialTests$radial10 = function () {
	var thetas = A2(
		$elm$core$List$map,
		function (n) {
			return $elm$core$Basics$degrees(n * 45);
		},
	...
	var enc = A2(
		...
		A2(
			...
			A2(
				...
				A2(
					$author$project$VegaLite$position,
					$author$project$VegaLite$Theta2,
					_List_fromArray(
						[
	...
	var data = A2(
		...
		A2(
			...
			A2(
				...
				't',
				$author$project$VegaLite$nums(
					A2($elm$core$List$take, 8, thetas)))),
		A2(
			$author$project$VegaLite$dataColumn,
			't2',
			$author$project$VegaLite$nums(
				A2($elm$core$List$drop, 1, thetas))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				data(_List_Nil),
...
var $author$project$VegaLite$OfNone = {$: 'OfNone'};
var $author$project$VegaLite$stNone = $author$project$VegaLite$OfNone;
...
var $author$project$RadialTests$radial12 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
...
var $author$project$RadialTests$radial13 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$RadialTests$radial4 = A3($author$project$RadialTests$radial, 0, $author$project$RadialTests$firstCentreOffset, 0);
var $author$project$RadialTests$radial5 = A3($author$project$RadialTests$radial, 0, $author$project$RadialTests$firstCentreOffset, $author$project$RadialTests$firstCentreOffset);
...
var $author$project$VegaLite$maRadius = function (n) {
	return $author$project$VegaLite$MRadius(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$OfZero = {$: 'OfZero'};
var $author$project$VegaLite$stZero = $author$project$VegaLite$OfZero;
	...
	var pieSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maOuterRadius(80)
					]))
			]));
	var labelEnc = A2(
		$elm$core$Basics$composeL,
	...
	var labelSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maRadius(90)
					]))
			]));
	var enc = A2(
		$elm$core$Basics$composeL,
...
var $author$project$VegaLite$maTheta = function (n) {
	return $author$project$VegaLite$MTheta(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$maTheta2 = function (n) {
	return $author$project$VegaLite$MTheta2(
		$author$project$VegaLite$Num(n));
};
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maTheta(0.3),
						$author$project$VegaLite$maTheta2(1.3),
						$author$project$VegaLite$maInnerRadius(30),
						$author$project$VegaLite$maOuterRadius(100),
						$author$project$VegaLite$maX(0),
						$author$project$VegaLite$maY(200)
					]))
			]));
}();
...
var $author$project$RadialTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('radial1', $author$project$RadialTests$radial1),
		_Utils_Tuple2('radial2', $author$project$RadialTests$radial2),
		_Utils_Tuple2('radial3', $author$project$RadialTests$radial3),
		_Utils_Tuple2('radial4', $author$project$RadialTests$radial4),
		_Utils_Tuple2('radial5', $author$project$RadialTests$radial5),
		...
		_Utils_Tuple2('radial11', $author$project$RadialTests$radial11),
		_Utils_Tuple2('radial12', $author$project$RadialTests$radial12),
		_Utils_Tuple2('radial13', $author$project$RadialTests$radial13)
	]);
...
var $author$project$RadialTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$RadialTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$RadialTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$RadialTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$RadialTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$RadialTests$update,
		view: $author$project$RadialTests$view
	});
_Platform_export({'RadialTests':{'init':$author$project$RadialTests$main(
