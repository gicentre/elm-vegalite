...
var author$project$HyperlinkTests$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var author$project$HyperlinkTests$sourceExample = author$project$HyperlinkTests$hyperlink3;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						A2(elm$json$Json$Encode$encode, 2, author$project$HyperlinkTests$sourceExample))
					]))
			]));
};
...
var author$project$HyperlinkTests$main = elm$browser$Browser$element(
	{
		as: elm$core$Basics$always(
			_Utils_Tuple2(
				author$project$HyperlinkTests$mySpecs,
				author$project$HyperlinkTests$elmToJS(author$project$HyperlinkTests$mySpecs))),
		ay: elm$core$Basics$always(elm$core$Platform$Sub$none),
		aA: F2(
			function (_n0, model) {
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			}),
		aC: author$project$HyperlinkTests$view
	});
