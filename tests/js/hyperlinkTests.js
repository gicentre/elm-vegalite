...
var $author$project$HyperlinkTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$HyperlinkTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$HyperlinkTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$HyperlinkTests$update,
		view: $author$project$HyperlinkTests$view
	});
