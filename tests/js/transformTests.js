...
var $author$project$VegaLite$RgPoly = {$: 'RgPoly'};
var $author$project$VegaLite$rgPoly = $author$project$VegaLite$RgPoly;
...
var $author$project$VegaLite$RgLinear = {$: 'RgLinear'};
var $author$project$VegaLite$rgLinear = $author$project$VegaLite$RgLinear;
var $author$project$VegaLite$RgParams = function (a) {
	return {$: 'RgParams', a: a};
};
var $author$project$VegaLite$rgParams = $author$project$VegaLite$RgParams;
...
var $author$project$VegaLite$Max = {$: 'Max'};
var $author$project$VegaLite$opMax = $author$project$VegaLite$Max;
var $author$project$VegaLite$Min = {$: 'Min'};
...
var $author$project$VegaLite$OfNormalize = {$: 'OfNormalize'};
var $author$project$VegaLite$stNormalize = $author$project$VegaLite$OfNormalize;
...
var $author$project$VegaLite$Minutes = {$: 'Minutes'};
...
var $author$project$VegaLite$VLHeightStep = {$: 'VLHeightStep'};
var $author$project$VegaLite$heightStep = function (hs) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLHeightStep,
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
...
var $author$project$TransformTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TransformTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$TransformTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$TransformTests$update,
		view: $author$project$TransformTests$view
	});
