...
var $author$project$VegaLite$noData = _Utils_Tuple2($author$project$VegaLite$VLData, $elm$json$Json$Encode$null);
...
var $author$project$VegaLite$PBinned = {$: 'PBinned'};
...
var $author$project$VegaLite$Arrow = {$: 'Arrow'};
...
var $author$project$DataTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.2/data/';
...
var $author$project$VegaLite$ImKeyValSequence = F3(
	function (a, b, c) {
		return {$: 'ImKeyValSequence', a: a, b: b, c: c};
	});
...
var $author$project$DataTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$DataTests$update,
		view: $author$project$DataTests$view
	});
