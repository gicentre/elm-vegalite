...
var $author$project$InteractionTests$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$InteractionTests$sourceExample = $author$project$InteractionTests$interaction18;
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$InteractionTests$sourceExample))
					]))
			]));
};
var $author$project$InteractionTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$InteractionTests$mySpecs,
				$author$project$InteractionTests$elmToJS($author$project$InteractionTests$mySpecs))),
