...
var $author$project$InteractionTests$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$InteractionTests$cScale = $author$project$VegaLite$categoricalDomainMap(
	_List_fromArray(
		[
			_Utils_Tuple2('Anti-social behaviour', 'rgb(59,118,175)'),
			_Utils_Tuple2('Burglary', 'rgb(81,157,62)'),
			_Utils_Tuple2('Criminal damage and arson', 'rgb(141,106,184)'),
			_Utils_Tuple2('Drugs', 'rgb(239,133,55)'),
			_Utils_Tuple2('Robbery', 'rgb(132,88,78)'),
			_Utils_Tuple2('Vehicle crime', 'rgb(213,126,190)')
		]));
...
var $author$project$InteractionTests$encHighlight = A2(
	...
	$author$project$VegaLite$opacity(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$mNum(0.1)
					]))
			])));
...
var $author$project$InteractionTests$interaction1 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
...
var $author$project$VegaLite$PBindScales = {$: 'PBindScales'};
var $author$project$VegaLite$paBindScales = $author$project$VegaLite$PBindScales;
var $author$project$VegaLite$SeInterval = {$: 'SeInterval'};
var $author$project$VegaLite$seInterval = $author$project$VegaLite$SeInterval;
...
var $author$project$VegaLite$LeUnselectedOpacity = function (a) {
	return {$: 'LeUnselectedOpacity', a: a};
};
...
var $author$project$VegaLite$IPRadio = function (a) {
	return {$: 'IPRadio', a: a};
};
var $author$project$VegaLite$ipRadio = $author$project$VegaLite$IPRadio;
					...
					$author$project$VegaLite$ipRadio(
						_List_fromArray(
							[
								...
								_List_fromArray(
									['Anti-social behaviour', 'Criminal damage and arson', 'Drugs', 'Robbery', 'Vehicle crime']))
							])))
				])));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$InteractionTests$enc = A2(
	$elm$core$Basics$composeL,
	A2(
		$elm$core$Basics$composeL,
		A2(
...
var $author$project$InteractionTests$interaction15 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
			$author$project$VegaLite$fiExpr('datum.reportedCrimes >= minSlider_minReported && maxSlider_maxReported >= datum.reportedCrimes')));
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$ipRange(
							_List_fromArray(
								[
									$author$project$VegaLite$inName('Min'),
									$author$project$VegaLite$inMax(12800)
								])))
					]))),
		A2(
			$author$project$VegaLite$param,
					...
					$author$project$VegaLite$dataObject(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'maxReported',
								$author$project$VegaLite$num(14000))
							]))),
					$author$project$VegaLite$paBind(
					$author$project$VegaLite$ipRange(
						_List_fromArray(
							[
								$author$project$VegaLite$inName('Max'),
								$author$project$VegaLite$inMin(400),
								$author$project$VegaLite$inMax(14000)
							])))
				])));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$VegaLite$CSV = {$: 'CSV'};
...
var $author$project$VegaLite$DTMonthNum = function (a) {
	return {$: 'DTMonthNum', a: a};
};
var $author$project$VegaLite$dtMonthNum = function (mon) {
	switch (mon.$) {
		case 'Jan':
			return $author$project$VegaLite$DTMonthNum(1);
		case 'Feb':
			return $author$project$VegaLite$DTMonthNum(2);
		case 'Mar':
			return $author$project$VegaLite$DTMonthNum(3);
		case 'Apr':
			return $author$project$VegaLite$DTMonthNum(4);
		case 'May':
			return $author$project$VegaLite$DTMonthNum(5);
		case 'Jun':
			return $author$project$VegaLite$DTMonthNum(6);
		case 'Jul':
			return $author$project$VegaLite$DTMonthNum(7);
		case 'Aug':
			return $author$project$VegaLite$DTMonthNum(8);
		case 'Sep':
			return $author$project$VegaLite$DTMonthNum(9);
		case 'Oct':
			return $author$project$VegaLite$DTMonthNum(10);
		case 'Nov':
			return $author$project$VegaLite$DTMonthNum(11);
		default:
			return $author$project$VegaLite$DTMonthNum(12);
	}
};
...
var $author$project$VegaLite$lookupSelection = F3(
	function (key1, selName, key2) {
		return $elm$core$List$cons(
			_Utils_Tuple2(
				'multiSpecs',
				$elm$json$Json$Encode$object(
...
var $author$project$InteractionTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.2/data/';
...
var $author$project$InteractionTests$interaction16 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			$author$project$VegaLite$transform,
			A3($author$project$VegaLite$lookupSelection, 'symbol', 'index', 'symbol')),
		A2($author$project$VegaLite$calculateAs, 'datum.index && datum.index.price > 0 ? (datum.price - datum.index.price)/datum.index.price : 0', 'indexed_price'));
	var textEnc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pNum(310)
					]))),
	...
	var ruleTrans = A2(
		...
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
			$author$project$VegaLite$fiSelection('index')));
	var ruleEnc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
								...
								$author$project$VegaLite$dt(
									_List_fromArray(
										[
											...
											$author$project$VegaLite$dtMonthNum($author$project$VegaLite$Jan),
	...
	var pointSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maOpacity(0)
					]))
			]));
	var lineEnc = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName('indexed_price'),
						$author$project$VegaLite$pQuant,
						$author$project$VegaLite$pAxis(
						_List_fromArray(
							[
								$author$project$VegaLite$axFormat('%')
							]))
					]))),
		$author$project$VegaLite$color(
			_List_fromArray(
	...
	var labelledRuleSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				ruleTrans(_List_Nil),
				ruleEnc(_List_Nil),
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$VegaLite$fwValue(100))
									]))
							]))
					]))
			]));
...
var $author$project$VegaLite$CPointer = {$: 'CPointer'};
var $author$project$VegaLite$cuPointer = $author$project$VegaLite$CPointer;
var $author$project$VegaLite$CText = {$: 'CText'};
var $author$project$VegaLite$cuText = $author$project$VegaLite$CText;
var $author$project$VegaLite$SelectionMark = function (a) {
	return {$: 'SelectionMark', a: a};
};
var $author$project$VegaLite$seSelectionMark = $author$project$VegaLite$SelectionMark;
var $author$project$VegaLite$SMCursor = function (a) {
	return {$: 'SMCursor', a: a};
};
var $author$project$VegaLite$smCursor = $author$project$VegaLite$SMCursor;
var $author$project$VegaLite$VCursor = function (a) {
	return {$: 'VCursor', a: a};
};
var $author$project$VegaLite$vicoCursor = $author$project$VegaLite$VCursor;
var $author$project$InteractionTests$interaction17 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$smCursor($author$project$VegaLite$cuPointer)
								]))
						]))
				])));
	var encLine = A2(
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coView(
				_List_fromArray(
					[
						$author$project$VegaLite$vicoCursor($author$project$VegaLite$cuText)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$DSelectionChannel = F2(
	function (a, b) {
		return {$: 'DSelectionChannel', a: a, b: b};
	});
var $author$project$VegaLite$doSelectionChannel = $author$project$VegaLite$DSelectionChannel;
var $author$project$VegaLite$DSelectionField = F2(
	function (a, b) {
		return {$: 'DSelectionField', a: a, b: b};
	});
var $author$project$VegaLite$doSelectionField = $author$project$VegaLite$DSelectionField;
...
var $author$project$InteractionTests$interaction18 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		A2($author$project$VegaLite$calculateAs, 'cos(datum.theta)', 'y'));
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
				...
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$seEncodings(
							_List_fromArray(
								[$author$project$VegaLite$chX, $author$project$VegaLite$chY]))
						])),
					$author$project$VegaLite$paValue(
					$author$project$VegaLite$dataObject(
						_List_fromArray(
	...
	var overviewEnc = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName('theta'),
						$author$project$VegaLite$pQuant,
						$author$project$VegaLite$pAxis(_List_Nil)
					]))),
		A2(
	...
	var overviewSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				ps(_List_Nil),
				overviewEnc(_List_Nil),
				$author$project$VegaLite$line(_List_Nil)
			]));
	var detailEnc = A2(
		$elm$core$Basics$composeL,
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$VegaLite$doSelectionChannel, 'myBrush', $author$project$VegaLite$chX))
							]))
					]))),
		A2(
			$author$project$VegaLite$position,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$scDomain(
							A2($author$project$VegaLite$doSelectionField, 'myBrush', 'y'))
						]))
				])));
	var detailSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				detailEnc(_List_Nil),
	...
	var angleData = A4($author$project$VegaLite$dataSequenceAs, 0, 2 * $elm$core$Basics$pi, 0.1, 'theta');
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				angleData,
...
var $author$project$VegaLite$TTEncoding = {$: 'TTEncoding'};
...
var $author$project$InteractionTests$interaction4 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
...
var $author$project$InteractionTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('interaction1', $author$project$InteractionTests$interaction1),
		_Utils_Tuple2('interaction2', $author$project$InteractionTests$interaction2),
		_Utils_Tuple2('interaction3', $author$project$InteractionTests$interaction3),
		_Utils_Tuple2('interaction4', $author$project$InteractionTests$interaction4),
		_Utils_Tuple2('interaction5', $author$project$InteractionTests$interaction5),
		_Utils_Tuple2('interaction6', $author$project$InteractionTests$interaction6),
		_Utils_Tuple2('interaction7', $author$project$InteractionTests$interaction7),
		_Utils_Tuple2('interaction8', $author$project$InteractionTests$interaction8),
		_Utils_Tuple2('interaction9', $author$project$InteractionTests$interaction9),
		_Utils_Tuple2('interaction10', $author$project$InteractionTests$interaction10),
		_Utils_Tuple2('interaction11', $author$project$InteractionTests$interaction11),
		_Utils_Tuple2('interaction12', $author$project$InteractionTests$interaction12),
		_Utils_Tuple2('interaction13', $author$project$InteractionTests$interaction13),
		_Utils_Tuple2('interaction14', $author$project$InteractionTests$interaction14),
...
var $author$project$InteractionTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$InteractionTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$InteractionTests$NewSource = function (a) {
...
var $author$project$InteractionTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$InteractionTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$InteractionTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$InteractionTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$InteractionTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$InteractionTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$InteractionTests$update,
		view: $author$project$InteractionTests$view
	});
_Platform_export({'InteractionTests':{'init':$author$project$InteractionTests$main(
