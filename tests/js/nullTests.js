...
var $author$project$NullTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.1/data/';
...
var $author$project$NullTests$NewSource = function (a) {
	return {$: 0, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$NullTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
