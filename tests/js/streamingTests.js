...
var $author$project$StreamingTests$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
...
var $author$project$StreamingTests$main = $elm$core$Platform$worker(
	{
		as: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$StreamingTests$mySpecs,
				$author$project$StreamingTests$elmToJS($author$project$StreamingTests$mySpecs))),
