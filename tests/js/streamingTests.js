...
var $author$project$StreamingTests$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$StreamingTests$streaming1 = function () {
	var enc = A2(
...
var $author$project$StreamingTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('streaming1', $author$project$StreamingTests$streaming1)
	]);
...
var $author$project$StreamingTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$StreamingTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$StreamingTests$NewSource = function (a) {
...
var $author$project$StreamingTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$StreamingTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$StreamingTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$StreamingTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$StreamingTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$StreamingTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$StreamingTests$update,
		view: $author$project$StreamingTests$view
	});
_Platform_export({'StreamingTests':{'init':$author$project$StreamingTests$main(
