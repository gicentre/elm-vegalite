...
var $author$project$VegaLite$VLBackgroundExpr = {$: 'VLBackgroundExpr'};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$VegaLite$backgroundExpr = function (s) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLBackgroundExpr,
...
var $author$project$VegaLite$MBlend = function (a) {
	return {$: 'MBlend', a: a};
};
var $author$project$VegaLite$maBlend = $author$project$VegaLite$MBlend;
var $author$project$VegaLite$MFillGradient = F2(
	function (a, b) {
		return {$: 'MFillGradient', a: a, b: b};
	});
...
var $author$project$ColorTests$blend1 = function () {
	var props = function (p) {
		switch (p) {
			case 0:
				return _List_fromArray(
					[
						$author$project$VegaLite$grX1(0.5),
						$author$project$VegaLite$grX2(0.5),
			...
			case 1:
				return _List_fromArray(
					[
						$author$project$VegaLite$grX1(0.7),
						$author$project$VegaLite$grX2(0.3),
						$author$project$VegaLite$grY1(0.1),
			...
			default:
				return _List_fromArray(
					[
						...
						$author$project$VegaLite$grX2(0),
						$author$project$VegaLite$grY1(1),
						$author$project$VegaLite$grY2(0)
					]);
		}
	...
	var ellipse = function (ang) {
		var thetas = A2(
			$elm$core$List$map,
			function (n) {
				return ((2 * $elm$core$Basics$pi) / 25) * n;
			},
			A2($elm$core$List$range, 0, 25));
		var rminor = 0.3;
		var rmajor = 1.0;
		var rad = (ang * $elm$core$Basics$pi) / 180;
		var sinRot = $elm$core$Basics$sin(rad);
		var cosRot = $elm$core$Basics$cos(rad);
		var pair = function (t) {
			var y = ((rmajor * $elm$core$Basics$cos(t)) * sinRot) + ((rminor * $elm$core$Basics$sin(t)) * cosRot);
			var x = ((rmajor * $elm$core$Basics$cos(t)) * cosRot) - ((rminor * $elm$core$Basics$sin(t)) * sinRot);
			return 'L ' + ($elm$core$String$fromFloat(x) + (' ' + $elm$core$String$fromFloat(y)));
		};
		return $author$project$VegaLite$symPath(
			$elm$core$String$concat(
				A2(
					$elm$core$List$intersperse,
					' ',
					A2($elm$core$List$map, pair, thetas))));
	};
	var lyr = F2(
		function (bm, f) {
			var a = function () {
					...
					[
						...
						_List_fromArray(
							[
								...
								ellipse(a)),
								$author$project$VegaLite$maBlend(bm),
								gradient(f)
							]))
					]));
		});
				...
				$author$project$VegaLite$coPoint(
					_List_fromArray(
						[
							...
							$author$project$VegaLite$maSize(40000),
							$author$project$VegaLite$maStroke('')
						])))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coBackground('rgba(255,255,255,0)')));
	var blendData = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var ax = F2(
		function (t, f) {
			return A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName(f),
						$author$project$VegaLite$pQuant,
	...
	var createLayer = function (_v0) {
		...
		var enc = A2(
			...
			A2(
				$elm$core$Basics$composeL,
				$author$project$VegaLite$encoding,
				A2(ax, $author$project$VegaLite$X, 'x')),
			A2(ax, $author$project$VegaLite$Y, 'y'));
		return $author$project$VegaLite$asSpec(
			_List_fromArray(
				[
					enc(_List_Nil),
					...
					A2(
						...
						_List_fromArray(
							[1, 0, 2]))),
					A2($author$project$VegaLite$title, ttl, _List_Nil)
				]));
	};
	var layers = A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[
				_Utils_Tuple2($author$project$VegaLite$bmNormal, 'Normal'),
				_Utils_Tuple2($author$project$VegaLite$bmMultiply, 'Multiply'),
				_Utils_Tuple2($author$project$VegaLite$bmScreen, 'Screen'),
				_Utils_Tuple2($author$project$VegaLite$bmOverlay, 'Overlay'),
				_Utils_Tuple2($author$project$VegaLite$bmDarken, 'Darken'),
				_Utils_Tuple2($author$project$VegaLite$bmLighten, 'Lighten'),
				_Utils_Tuple2($author$project$VegaLite$bmColorDodge, 'Color-Dodge'),
				_Utils_Tuple2($author$project$VegaLite$bmColorBurn, 'Color-Burn'),
				_Utils_Tuple2($author$project$VegaLite$bmHardLight, 'Hard-Light'),
				_Utils_Tuple2($author$project$VegaLite$bmSoftLight, 'Soft-Light'),
				_Utils_Tuple2($author$project$VegaLite$bmDifference, 'Difference'),
				_Utils_Tuple2($author$project$VegaLite$bmExclusion, 'Exclusion'),
				_Utils_Tuple2($author$project$VegaLite$bmHue, 'Hue'),
				_Utils_Tuple2($author$project$VegaLite$bmSaturation, 'Saturation'),
				_Utils_Tuple2($author$project$VegaLite$bmColor, 'Color'),
				_Utils_Tuple2($author$project$VegaLite$bmLuminosity, 'Luminosity')
			]));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$VLBackground = {$: 'VLBackground'};
var $author$project$VegaLite$background = function (colour) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLBackground,
		$elm$json$Json$Encode$string(colour));
};
...
var $author$project$VegaLite$Square = {$: 'Square'};
var $author$project$VegaLite$square = $author$project$VegaLite$mark($author$project$VegaLite$Square);
...
var $author$project$ColorTests$chart = F2(
	function (desText, enc) {
		var trans = A2(
			$elm$core$Basics$composeL,
			$author$project$VegaLite$transform,
			A2($author$project$VegaLite$calculateAs, '(datum.Acceleration - 15.52)/2.80', 'accelerationZScore'));
		var fullEnc = A2(
			$elm$core$Basics$composeL,
			A2(
				$elm$core$Basics$composeL,
...
var $author$project$VegaLite$SInterpolate = function (a) {
	return {$: 'SInterpolate', a: a};
};
var $author$project$VegaLite$scInterpolate = $author$project$VegaLite$SInterpolate;
var $author$project$VegaLite$ScLinear = {$: 'ScLinear'};
var $author$project$VegaLite$scLinear = $author$project$VegaLite$ScLinear;
...
var $author$project$VegaLite$Hsl = {$: 'Hsl'};
...
var $author$project$VegaLite$HslLong = {$: 'HslLong'};
...
var $author$project$VegaLite$Lab = {$: 'Lab'};
...
var $author$project$VegaLite$Hcl = {$: 'Hcl'};
...
var $author$project$VegaLite$HclLong = {$: 'HclLong'};
...
var $author$project$VegaLite$ScPow = {$: 'ScPow'};
var $author$project$VegaLite$scPow = $author$project$VegaLite$ScPow;
var $author$project$ColorTests$scale3 = A2(
	$author$project$ColorTests$chart,
	'Power colour scale with default (1) exponent.',
	$author$project$VegaLite$color(
		_List_fromArray(
			[
				$author$project$VegaLite$mName('Acceleration'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$scType($author$project$VegaLite$scPow),
						$author$project$VegaLite$scExponent(3),
						$author$project$VegaLite$scRange(
						$author$project$VegaLite$raStrs(
							_List_fromArray(
								['yellow', 'red'])))
...
var $author$project$VegaLite$ScSqrt = {$: 'ScSqrt'};
var $author$project$VegaLite$scSqrt = $author$project$VegaLite$ScSqrt;
...
var $author$project$VegaLite$ScLog = {$: 'ScLog'};
var $author$project$VegaLite$scLog = $author$project$VegaLite$ScLog;
var $author$project$ColorTests$scale6 = A2(
	$author$project$ColorTests$chart,
	'Log colour scale.',
	$author$project$VegaLite$color(
		_List_fromArray(
...
var $author$project$VegaLite$ScSymLog = {$: 'ScSymLog'};
var $author$project$VegaLite$scSymLog = $author$project$VegaLite$ScSymLog;
var $author$project$ColorTests$scale7 = A2(
	$author$project$ColorTests$chart,
	'SymLog colour scale with default slope constant (1).',
	$author$project$VegaLite$color(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$scType($author$project$VegaLite$scSymLog),
						$author$project$VegaLite$scRange(
						$author$project$VegaLite$raStrs(
							_List_fromArray(
								['yellow', 'red'])))
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$scType($author$project$VegaLite$scSymLog),
						$author$project$VegaLite$scConstant(0.01),
						$author$project$VegaLite$scRange(
						$author$project$VegaLite$raStrs(
							_List_fromArray(
								['yellow', 'red'])))
...
var $author$project$ColorTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('scale6', $author$project$ColorTests$scale6),
		_Utils_Tuple2('scale7', $author$project$ColorTests$scale7),
		_Utils_Tuple2('scale8', $author$project$ColorTests$scale8),
		...
		_Utils_Tuple2('background1', $author$project$ColorTests$background1)
	]);
...
var $author$project$ColorTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$ColorTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$ColorTests$NewSource = function (a) {
...
var $author$project$ColorTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$ColorTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$ColorTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$ColorTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$ColorTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$ColorTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$ColorTests$update,
		view: $author$project$ColorTests$view
	});
