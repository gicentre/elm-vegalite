...
var $author$project$VegaLite$DayHours = {$: 'DayHours'};
var $author$project$VegaLite$dayHours = $author$project$VegaLite$DayHours;
var $author$project$VegaLite$DayHoursMinutes = {$: 'DayHoursMinutes'};
var $author$project$VegaLite$dayHoursMinutes = $author$project$VegaLite$DayHoursMinutes;
var $author$project$VegaLite$DayHoursMinutesSeconds = {$: 'DayHoursMinutesSeconds'};
...
var $author$project$VegaLite$ScTime = {$: 'ScTime'};
var $author$project$VegaLite$scTime = $author$project$VegaLite$ScTime;
var $author$project$VegaLite$SType = function (a) {
	return {$: 'SType', a: a};
};
var $author$project$VegaLite$scType = $author$project$VegaLite$SType;
var $author$project$VegaLite$ScUtc = {$: 'ScUtc'};
var $author$project$VegaLite$scUtc = $author$project$VegaLite$ScUtc;
...
var $author$project$VegaLite$YearMonthDateHours = {$: 'YearMonthDateHours'};
...
var $author$project$TimeTests$localTime = $author$project$TimeTests$parseTime($author$project$TimeTests$Local);
var $author$project$VegaLite$Milliseconds = {$: 'Milliseconds'};
...
var $author$project$VegaLite$MinutesSeconds = {$: 'MinutesSeconds'};
...
var $author$project$TimeTests$UTC = {$: 'UTC'};
var $author$project$TimeTests$utcTime = $author$project$TimeTests$parseTime($author$project$TimeTests$UTC);
...
var $author$project$TimeTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TimeTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$TimeTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$TimeTests$update,
		view: $author$project$TimeTests$view
	});
