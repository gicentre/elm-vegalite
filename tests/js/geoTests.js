...
var $author$project$GeoTests$choropleth1 = function () {
	var enc = A2(
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maStrokeOpacity(0)
					]))
			]));
}();
...
var $author$project$GeoTests$boroughColors = $author$project$VegaLite$categoricalDomainMap(
	_List_fromArray(
		[
			_Utils_Tuple2('Kingston upon Thames', '#9db7b1'),
			_Utils_Tuple2('Croydon', '#d4b4e5'),
			_Utils_Tuple2('Bromley', '#afb9cb'),
			_Utils_Tuple2('Hounslow', '#b2add6'),
			_Utils_Tuple2('Ealing', '#e2f8ca'),
			_Utils_Tuple2('Havering', '#a1bde6'),
			_Utils_Tuple2('Hillingdon', '#e8aa95'),
			_Utils_Tuple2('Harrow', '#8bd0eb'),
			_Utils_Tuple2('Brent', '#dfb89b'),
			_Utils_Tuple2('Barnet', '#a2e7ed'),
			_Utils_Tuple2('Lambeth', '#e3aba7'),
			_Utils_Tuple2('Southwark', '#86cbd1'),
			_Utils_Tuple2('Lewisham', '#ecb1c2'),
			_Utils_Tuple2('Greenwich', '#acd8ba'),
			_Utils_Tuple2('Bexley', '#e4bad9'),
			_Utils_Tuple2('Enfield', '#9bd6ca'),
			_Utils_Tuple2('Waltham Forest', '#cec9f3'),
			_Utils_Tuple2('Redbridge', '#c9d2a8'),
			_Utils_Tuple2('Sutton', '#d1c1d9'),
			_Utils_Tuple2('Richmond upon Thames', '#ddcba2'),
			_Utils_Tuple2('Merton', '#a2acbd'),
			_Utils_Tuple2('Wandsworth', '#deefd6'),
			_Utils_Tuple2('Hammersmith and Fulham', '#b5d7a7'),
			_Utils_Tuple2('Kensington and Chelsea', '#f6d4c9'),
			_Utils_Tuple2('Westminster', '#add4e0'),
			_Utils_Tuple2('Camden', '#d9b9ad'),
			_Utils_Tuple2('Tower Hamlets', '#c6e1db'),
			_Utils_Tuple2('Islington', '#e0c7ce'),
			_Utils_Tuple2('Hackney', '#a6b79f'),
			_Utils_Tuple2('Haringey', '#cbd5e7'),
			_Utils_Tuple2('Newham', '#c2d2ba'),
			_Utils_Tuple2('Barking and Dagenham', '#ebe2cf'),
			_Utils_Tuple2('City of London', '#c7bfad')
		]));
...
var $author$project$GeoTests$choropleth2 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				$author$project$VegaLite$width(1200),
				$author$project$VegaLite$height(700),
				cfg(_List_Nil),
...
var $author$project$GeoTests$defaultSize1 = function () {
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				$author$project$VegaLite$description('Default map size'),
				data,
				proj,
				$author$project$VegaLite$geoshape(
				_List_fromArray(
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coView(
				_List_fromArray(
					[
						$author$project$VegaLite$vicoContinuousWidth(500),
						$author$project$VegaLite$vicoContinuousHeight(300)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				$author$project$VegaLite$description('Default map size with view width and height specified in config.'),
				cfg(_List_Nil),
				proj,
				data,
				$author$project$VegaLite$geoshape(
...
var $author$project$GeoTests$dotMap1 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$num(-0.52))
					]))),
		A2(
			$author$project$VegaLite$position,
			$author$project$VegaLite$Latitude,
	...
	var hEnc = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$pDatum(
					$author$project$VegaLite$num(51.28))
				])));
	var geoData = A2(
		$author$project$VegaLite$dataFromUrl,
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$VegaLite$maFillOpacity(0.7)
						]))
				]));
		...
		var seaSpec = $author$project$VegaLite$asSpec(
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$maFill('#c1e7f5'),
							$author$project$VegaLite$maStrokeOpacity(0)
						]))
				]));
		var graticuleSpec = $author$project$VegaLite$asSpec(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$maStroke('white'),
							$author$project$VegaLite$maFill('#242'),
							$author$project$VegaLite$maStrokeWidth(0.1)
						]))
				]));
		return $author$project$VegaLite$asSpec(
...
var $author$project$GeoTests$scribbleMap1 = function () {
	var stateCondition = $elm$core$String$concat(
		A2(
			$elm$core$List$map,
			function (s) {
				return '&& datum.state !=\'' + (s + '\'');
			},
			_List_fromArray(
				['AS', 'FM', 'PW', 'MH', 'GU', 'MP', 'VI', 'PR'])));
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			$author$project$VegaLite$filter(
				$author$project$VegaLite$fiExpr('datum.latitude != \'\' && datum.county != \'Honolulu\' ' + stateCondition))),
		A2($author$project$VegaLite$calculateAs, 'datum.state == \'HI\' ? \'hi\' : (datum.state == \'AK\' ? \'ak\' : \'continent\')', 'conterminous'));
	var proj = $author$project$VegaLite$projection(
		_List_fromArray(
			[
				$author$project$VegaLite$prType($author$project$VegaLite$albersUsa)
				...
				$author$project$VegaLite$coTitle(
					_List_fromArray(
						[
							...
							$author$project$VegaLite$ticoFontSize(28)
						])))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coView(
				_List_fromArray(
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'US connected zip codes', _List_Nil),
				cfg(_List_Nil),
				$author$project$VegaLite$width(1000),
				$author$project$VegaLite$height(600),
				data,
				proj,
				trans(_List_Nil),
				enc(_List_Nil),
...
var $author$project$GeoTests$scribbleMap2 = function () {
	var stateCondition = $elm$core$String$concat(
		A2(
			$elm$core$List$map,
			function (s) {
	...
	var trans = A2(
		...
		A2(
			...
			A2(
				...
				$author$project$VegaLite$filter(
					$author$project$VegaLite$fiExpr('datum.latitude != \'\' && datum.county != \'Honolulu\' ' + stateCondition))),
			A2($author$project$VegaLite$calculateAs, 'substring(datum.zip_code, 0, 3)', 'digit3')),
		A2($author$project$VegaLite$calculateAs, 'length(datum.zip_code+\' \')', 'ziplen'));
	var proj = $author$project$VegaLite$projection(
		_List_fromArray(
			[
				$author$project$VegaLite$prType($author$project$VegaLite$albersUsa)
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'US connected zip codes, coloured by first three digits', _List_Nil),
				cfg(_List_Nil),
				$author$project$VegaLite$width(1000),
				$author$project$VegaLite$height(600),
				data,
...
var $author$project$GeoTests$tubeLines1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$encoding,
		$author$project$VegaLite$color(
...
var $author$project$GeoTests$tubeLineColors = $author$project$VegaLite$categoricalDomainMap(
	_List_fromArray(
		[
...
var $author$project$GeoTests$tubeLines3 = function () {
	var tubeEnc = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$encoding,
		$author$project$VegaLite$color(
...
var $author$project$GeoTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('defaultSize1', $author$project$GeoTests$defaultSize1),
		_Utils_Tuple2('defaultSize2', $author$project$GeoTests$defaultSize2),
		_Utils_Tuple2('choropleth1', $author$project$GeoTests$choropleth1),
		_Utils_Tuple2('choropleth2', $author$project$GeoTests$choropleth2),
...
var $author$project$GeoTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$GeoTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
		...
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				...
				$author$project$GeoTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$GeoTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$GeoTests$update,
		view: $author$project$GeoTests$view
	});
