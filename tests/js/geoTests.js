...
var $author$project$GeoTests$choropleth1 = $author$project$VegaLite$toVegaLite(
	_List_fromArray(
		[
...
var $author$project$GeoTests$defaultSize1 = $author$project$VegaLite$toVegaLite(
	_List_fromArray(
		[
...
var $author$project$GeoTests$defaultSize2 = $author$project$VegaLite$toVegaLite(
	_List_fromArray(
		[
				...
				$author$project$VegaLite$coTitle(
					_List_fromArray(
						[
							...
							$author$project$VegaLite$ticoFontWeight(6),
...
var $author$project$VegaLite$leOffset = $author$project$VegaLite$LOffset;
...
var $author$project$GeoTests$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($elm$json$Json$Encode$encode, 2, $author$project$GeoTests$sourceExample))
					]))
			]));
};
var $author$project$GeoTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$GeoTests$mySpecs,
				$author$project$GeoTests$elmToJS($author$project$GeoTests$mySpecs))),
