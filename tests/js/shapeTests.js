...
var $author$project$ShapeTests$isotypes = function () {
...
var $author$project$ShapeTests$personGrid = function () {
	var trans = A2(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$Maybe$withDefault,
							'circle',
							A2($elm$core$Dict$get, 'person', $author$project$ShapeTests$isotypes)))
					]))),
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$maSize(90)
					]))
			]));
}();
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$cons,
					$author$project$VegaLite$maSize(30),
					A2(
						$elm$core$List$cons,
...
var $author$project$ShapeTests$rounded1 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadius(8)
		]));
...
var $author$project$ShapeTests$rounded2 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadiusTopLeft(8)
		]));
...
var $author$project$ShapeTests$rounded3 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadiusTopRight(8)
		]));
var $author$project$VegaLite$MCornerRadiusBL = function (a) {
	return {$: 'MCornerRadiusBL', a: a};
};
var $author$project$VegaLite$maCornerRadiusBottomLeft = function (n) {
	return $author$project$VegaLite$MCornerRadiusBL(
		$author$project$VegaLite$Num(n));
};
var $author$project$ShapeTests$rounded4 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadiusBottomLeft(8)
		]));
var $author$project$VegaLite$MCornerRadiusBR = function (a) {
	return {$: 'MCornerRadiusBR', a: a};
};
var $author$project$VegaLite$maCornerRadiusBottomRight = function (n) {
	return $author$project$VegaLite$MCornerRadiusBR(
		$author$project$VegaLite$Num(n));
};
var $author$project$ShapeTests$rounded5 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadiusBottomRight(8)
		]));
var $author$project$ShapeTests$rounded6 = $author$project$ShapeTests$rectTest(
	_List_fromArray(
		[
			$author$project$VegaLite$maCornerRadius(16),
			$author$project$VegaLite$maCornerRadiusBottomLeft(0),
			$author$project$VegaLite$maCornerRadiusTopRight(0)
		]));
...
var $author$project$VegaLite$SymTriangleUp = {$: 'SymTriangleUp'};
...
var $author$project$VegaLite$SymExpr = function (a) {
	return {$: 'SymExpr', a: a};
};
var $author$project$VegaLite$symExpr = $author$project$VegaLite$SymExpr;
var $author$project$ShapeTests$symbols3 = function () {
	var prm = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$paValue(
					$author$project$VegaLite$str('circle')),
					$author$project$VegaLite$paBind(
					$author$project$VegaLite$ipSelect(
						_List_fromArray(
							[
								...
								_List_fromArray(
									['circle', 'square', 'cross', 'diamond', 'triangle-up', 'triangle-down', 'triangle-left', 'triangle-right', 'triangle', 'stroke', 'arrow', 'wedge', 'm0 -1l0.866 0.5v1l-0.866 0.5l-0.866 -0.5v-1']))
							])))
				])));
	var enc = A2(
		$elm$core$Basics$composeL,
...
var $author$project$ShapeTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('symbols3', $author$project$ShapeTests$symbols3)
	]);
...
var $author$project$ShapeTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$ShapeTests$update,
		view: $author$project$ShapeTests$view
	});
