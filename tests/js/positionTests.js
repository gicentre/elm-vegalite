...
var $author$project$PositionTests$NewSource = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$PositionTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
...
var $author$project$PositionTests$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$PositionTests$update,
		view: $author$project$PositionTests$view
	});
