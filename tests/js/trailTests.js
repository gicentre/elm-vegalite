...
var $author$project$VegaLite$InterpolateExpr = function (a) {
	return {$: 'InterpolateExpr', a: a};
};
var $author$project$VegaLite$miExpr = $author$project$VegaLite$InterpolateExpr;
...
var $author$project$TrailTests$line1 = function () {
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$str('linear')),
						$author$project$VegaLite$paBind(
						$author$project$VegaLite$ipSelect(
							_List_fromArray(
								[
									$author$project$VegaLite$inName('interpolation style '),
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$TrailTests$path + 'cars.json', _List_Nil);
...
var $author$project$VegaLite$Trail = {$: 'Trail'};
var $author$project$VegaLite$trail = $author$project$VegaLite$mark($author$project$VegaLite$Trail);
var $author$project$TrailTests$trail1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$maOrder = function (b) {
...
var $author$project$TrailTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('line1', $author$project$TrailTests$line1)
	]);
...
var $author$project$TrailTests$update = F2(
	function (msg, _v0) {
		var srcName = msg.a;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$TrailTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$TrailTests$NewSource = function (a) {
...
var $author$project$TrailTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onInput($author$project$TrailTests$NewSource)
					]),
				A2(
					$elm$core$List$map,
					function (_v0) {
					...
					A2(
						...
						$author$project$TrailTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TrailTests$main = $elm$browser$Browser$element(
	{
		init: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TrailTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$TrailTests$specs)))),
		subscriptions: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		update: $author$project$TrailTests$update,
		view: $author$project$TrailTests$view
	});
_Platform_export({'TrailTests':{'init':$author$project$TrailTests$main(
