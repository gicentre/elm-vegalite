...
var $author$project$VegaLite$CI0 = {$: 2};
var $author$project$VegaLite$opCI0 = $author$project$VegaLite$CI0;
var $author$project$VegaLite$CI1 = {$: 3};
var $author$project$VegaLite$opCI1 = $author$project$VegaLite$CI1;
...
var $author$project$GalleryError$error1 = function () {
	var encVariety = A2(
...
var $author$project$GalleryError$error2 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							A3($author$project$VegaLite$opAs, $author$project$VegaLite$opMean, 'yield', 'mean'),
							A3($author$project$VegaLite$opAs, $author$project$VegaLite$opStdev, 'yield', 'stdev')
						]),
					_List_fromArray(
						['variety']))),
			A2($author$project$VegaLite$calculateAs, 'datum.mean-datum.stdev', 'lower')),
		A2($author$project$VegaLite$calculateAs, 'datum.mean+datum.stdev', 'upper'));
	var encVariety = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$encoding,
		A2(
...
var $author$project$GalleryError$error3 = function () {
	var encTime = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$encoding,
		A2(
...
var $author$project$GalleryError$error4 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							A3($author$project$VegaLite$opAs, $author$project$VegaLite$opMean, 'Miles_per_Gallon', 'mean_MPG'),
							A3($author$project$VegaLite$opAs, $author$project$VegaLite$opStdev, 'Miles_per_Gallon', 'dev_MPG')
						]),
					_List_Nil)),
			A2($author$project$VegaLite$calculateAs, 'datum.mean_MPG+datum.dev_MPG', 'upper')),
		A2($author$project$VegaLite$calculateAs, 'datum.mean_MPG-datum.dev_MPG', 'lower'));
	var encRect = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$GalleryError$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('error1', $author$project$GalleryError$error1),
			_Utils_Tuple2('error2', $author$project$GalleryError$error2),
			_Utils_Tuple2('error3', $author$project$GalleryError$error3),
			_Utils_Tuple2('error4', $author$project$GalleryError$error4)
		]));
...
var $author$project$GalleryError$main = $elm$core$Platform$worker(
	{
		as: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$GalleryError$mySpecs,
				$author$project$GalleryError$elmToJS($author$project$GalleryError$mySpecs))),
...
_Platform_export({'GalleryError':{'init':$author$project$GalleryError$main(
