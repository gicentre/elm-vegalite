...
var $author$project$VegaLite$biMaxBins = function (n) {
	return $author$project$VegaLite$MaxBins(
...
var $author$project$VegaLite$seZoom = function (s) {
	return $author$project$VegaLite$Zoom(
		$author$project$VegaLite$Str(s));
};
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					...
					$author$project$VegaLite$prParam('myBrush'),
					_List_fromArray(
						[
...
var $author$project$VegaLite$leGradientLength = function (n) {
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('myPts'),
					_List_fromArray(
						[
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('myClick'),
					_List_fromArray(
						[
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('brush'),
					_List_fromArray(
						[
...
var $author$project$VegaLite$oName = function (s) {
	return $author$project$VegaLite$OName(
		$author$project$VegaLite$Str(s));
};
	...
	var lineTrans = A2(
		...
		A2(
			...
			A2(
				...
				$author$project$VegaLite$transform,
				$author$project$VegaLite$filter(
					$author$project$VegaLite$fiSelectionEmpty('mySelection'))),
			A4(
...
var $author$project$VegaLite$biSelectionExtent = function (s) {
	return $author$project$VegaLite$SelectionExtent(
		$author$project$VegaLite$Str(s));
};
