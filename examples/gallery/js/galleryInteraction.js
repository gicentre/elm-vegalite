			...
			$author$project$VegaLite$fillOpacity(
				_List_fromArray(
					[
						...
						$author$project$VegaLite$prParam('select'),
						_List_fromArray(
							[
...
var $author$project$GalleryInteraction$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.2/data/';
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$description('Transparent layer to make it easier to trigger selection'),
								ps(_List_Nil),
								$author$project$VegaLite$line(
								_List_fromArray(
									[
										$author$project$VegaLite$maStrokeWidth(8),
										$author$project$VegaLite$maStroke('transparent')
									]))
							])),
						$author$project$VegaLite$asSpec(
						_List_fromArray(
			...
			$author$project$VegaLite$color(
				_List_fromArray(
					[
						A3(
						$author$project$VegaLite$mCondition,
						$author$project$VegaLite$prParamEmpty('myHover'),
						_List_fromArray(
							[
...
var $author$project$GalleryInteraction$interaction14 = function () {
	var transSelFilter = A2(
		...
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
			$author$project$VegaLite$fiSelectionEmpty('hover')));
	var transPivot = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		A3(
		...
		$author$project$VegaLite$tooltips(
			_List_fromArray(
				[
					_List_fromArray(
					[
						$author$project$VegaLite$tName('AAPL'),
						$author$project$VegaLite$tQuant
					]),
					_List_fromArray(
					[
						$author$project$VegaLite$tName('AMZN'),
						$author$project$VegaLite$tQuant
					]),
					_List_fromArray(
					[
						$author$project$VegaLite$tName('GOOG'),
						$author$project$VegaLite$tQuant
					]),
					_List_fromArray(
					[
						$author$project$VegaLite$tName('IBM'),
						$author$project$VegaLite$tQuant
					]),
					_List_fromArray(
					[
						$author$project$VegaLite$tName('MSFT'),
						$author$project$VegaLite$tQuant
					])
				])));
	var spec2 = $author$project$VegaLite$asSpec(
...
var $author$project$GalleryInteraction$interaction19 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
...
var $author$project$GalleryInteraction$interaction2 = function () {
	...
	var highlightSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				ps(_List_Nil),
				highlightEnc(_List_Nil),
				$author$project$VegaLite$bar(
				_List_fromArray(
					[
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$GalleryInteraction$path + 'movies.json', _List_Nil);
...
var $author$project$GalleryInteraction$interaction3 = function () {
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$VegaLite$axTickSize(0)
									]))
							]))),
				A2(
					$author$project$VegaLite$position,
		...
		$author$project$VegaLite$opacity(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('industry'),
					_List_fromArray(
						[
							$author$project$VegaLite$mNum(1)
						]),
	...
	var desc = $author$project$VegaLite$description('Interactive legend');
		...
		$author$project$VegaLite$size(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('myPaintbrush'),
					_List_fromArray(
						[
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParam('CylYr'),
					_List_fromArray(
						[
							$author$project$VegaLite$mName('Origin')
						]),
...
var $author$project$GalleryInteraction$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			...
			_Utils_Tuple2('interaction19', $author$project$GalleryInteraction$interaction19)
		]));
