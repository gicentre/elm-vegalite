	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maSize(4)
					]))
			]));
}();
...
var $author$project$ApacheArrow$arrow2 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$transform,
		$author$project$VegaLite$sample(10000));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maSize(9),
						$author$project$VegaLite$maOpacity(0.4)
					]))
			]));
}();
...
var $author$project$ApacheArrow$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('arrow1', $author$project$ApacheArrow$arrow1),
			_Utils_Tuple2('arrow2', $author$project$ApacheArrow$arrow2)
		]));
