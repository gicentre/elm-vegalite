...
var $author$project$HelloWorlds$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('vis1', $author$project$HelloWorlds$myFirstVis),
			_Utils_Tuple2('vis2', $author$project$HelloWorlds$mySecondVis),
			_Utils_Tuple2('vis3', $author$project$HelloWorlds$myOtherVis)
		]));
...
var $author$project$HelloWorlds$main = $elm$core$Platform$worker(
	{
		as: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$HelloWorlds$mySpecs,
				$author$project$HelloWorlds$elmToJS($author$project$HelloWorlds$mySpecs))),
...
_Platform_export({'HelloWorlds':{'init':$author$project$HelloWorlds$main(
