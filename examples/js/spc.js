...
var $author$project$VegaLite$VLAutosize = 7;
	...
	function (msg, model) {
		if (!msg.$) {
			...
			var newModel = _Utils_update(
				...
				{
					B: baseline,
					C: $author$project$Spc$dynamicSpecs(baseline)
				});
			return _Utils_Tuple2(
				newModel,
				$author$project$Spc$elmToJS(newModel.C));
		} else {
				...
				_List_fromArray(
					[
						...
						' Baseline: ' + A2(
							...
							5,
							$elm$core$String$fromFloat(model.B + 0.0001)))
					])),
				A2(
...
var $author$project$Spc$main = $elm$browser$Browser$element(
	{
		...
		aB: $author$project$Spc$update,
		aC: $author$project$Spc$view
	});
