				...
				$author$project$VegaLite$coView(
					_List_fromArray(
						[
							...
							$author$project$VegaLite$vicoContinuousHeight(220)
						])))),
		$author$project$VegaLite$configuration(
...
var $author$project$VegaLite$NYear = {$: 'NYear'};
...
var $author$project$VegaLite$AContent = {$: 'AContent'};
var $author$project$VegaLite$asContent = $author$project$VegaLite$AContent;
...
var $author$project$Spc$takeWhile = function (predicate) {
	var takeWhileHelper = F2(
		function (accum, list) {
			takeWhileHelper:
			while (true) {
				if (!list.b) {
	...
	return takeWhileHelper(_List_Nil);
};
...
var $author$project$Spc$transpose = function (xss) {
	var numCols = A2(
		$elm$core$Basics$composeR,
		$elm$core$List$head,
		A2(
...
var $author$project$VegaLite$Stdev = {$: 'Stdev'};
...
var $author$project$VegaLite$dOrdinal = $author$project$VegaLite$DmType($author$project$VegaLite$Ordinal);
	...
	function (msg, model) {
		if (msg.$ === 'Update') {
			...
			var newModel = _Utils_update(
				...
				{
					num: baseline,
					spec: $author$project$Spc$dynamicSpecs(baseline)
				});
			return _Utils_Tuple2(
				newModel,
				$author$project$Spc$elmToJS(newModel.spec));
		} else {
...
var $author$project$Spc$Reset = {$: 'Reset'};
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromFloat(model.num)),
						...
						' Baseline: ' + A2(
							...
							5,
							$elm$core$String$fromFloat(model.num + 0.0001)))
					])),
				A2(
...
var $author$project$Spc$main = $elm$browser$Browser$element(
	{
		...
		update: $author$project$Spc$update,
		view: $author$project$Spc$view
	});
