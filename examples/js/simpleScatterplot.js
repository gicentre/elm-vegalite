...
var $author$project$SimpleScatterplot$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$SimpleScatterplot$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.2/data/';
...
var $author$project$SimpleScatterplot$scatter = function () {
	var enc = A2(
...
var $author$project$SimpleScatterplot$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('scatter', $author$project$SimpleScatterplot$scatter)
		]));
...
var $author$project$SimpleScatterplot$main = $elm$core$Platform$worker(
	{
		as: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$SimpleScatterplot$mySpecs,
				$author$project$SimpleScatterplot$elmToJS($author$project$SimpleScatterplot$mySpecs))),
...
_Platform_export({'SimpleScatterplot':{'init':$author$project$SimpleScatterplot$main(
