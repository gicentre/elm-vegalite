...
var $author$project$Streaming$elmToJS = _Platform_outgoingPort('elmToJS', $elm$core$Basics$identity);
...
var $author$project$Streaming$streaming1 = function () {
	var enc = A2(
...
var $author$project$Streaming$mySpecs = $author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			_Utils_Tuple2('streaming1', $author$project$Streaming$streaming1)
		]));
...
var $author$project$Streaming$main = $elm$core$Platform$worker(
	{
		as: $elm$core$Basics$always(
			_Utils_Tuple2(
				$author$project$Streaming$mySpecs,
				$author$project$Streaming$elmToJS($author$project$Streaming$mySpecs))),
...
_Platform_export({'Streaming':{'init':$author$project$Streaming$main(
