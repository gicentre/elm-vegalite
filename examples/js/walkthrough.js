...
var author$project$Walkthrough$dashboard1 = function () {
	...
	var scatterSpec = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$title('Scatterplot'),
	...
	var histoSpec = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$title('Frequency histogram'),
				author$project$VegaLite$bar(_List_Nil),
				histoEnc(_List_Nil)
			]));
	var barEnc = A2(
	...
	var barSpec = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$title('Bar chart'),
				author$project$VegaLite$bar(_List_Nil),
				barEnc(_List_Nil)
			]));
	...
	var annotationSpec = author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				author$project$VegaLite$title('Annotation'),
