    ...
    let
        ...
        ps =
            params
                ...
                << param "domainDash" [ paValues solid, paBind (ipSelect [ inName "Domain dash ", inDataOptions [ solid, shortDash, longDash ] ]) ]
                ...
                << param "labelBound" [ paValue (boo False), paBind (ipSelect [ inName "Label bound ", inDatumOptions [ boo False, boo True, num 15 ] ]) ]
                ...
                << param "tickDash" [ paValues solid, paBind (ipSelect [ inName "Tick dash ", inDataOptions [ solid, shortDash, longDash ] ]) ]
                ...
                << param "gridDash" [ paValues solid, paBind (ipSelect [ inName "Grid dash ", inDataOptions [ solid, shortDash, longDash ] ]) ]
