...
var $author$project$VegaLite$AnEnd = {$: 2};
var $author$project$VegaLite$anEnd = $author$project$VegaLite$AnEnd;
...
var $author$project$VegaLite$AxcoLabelFontStyle = function (a) {
	return {$: 28, a: a};
};
var $author$project$VegaLite$axcoLabelFontStyle = function (s) {
...
var $author$project$ConfigTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$ConfigTests$singleVis = function (config) {
	var scatterEnc = A2(
...
var $author$project$ConfigTests$axisCfg1 = $author$project$ConfigTests$singleVis(
	A2(
		$elm$core$Basics$composeL,
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxis(
				_List_fromArray(
					[
						$author$project$VegaLite$axcoTitleFontStyle('italic'),
						$author$project$VegaLite$axcoTitleFont('serif'),
						$author$project$VegaLite$axcoLabelFontStyle('italic'),
...
var $author$project$VegaLite$SRight = {$: 3};
var $author$project$VegaLite$siRight = $author$project$VegaLite$SRight;
...
var $author$project$ConfigTests$histoVis = function (config) {
	var lineEnc3 = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName('preference'),
	...
	var lineSpec3 = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				lineEnc3(_List_Nil),
	...
	var lineSpec2 = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				lineEnc2(_List_Nil),
				$author$project$VegaLite$line(_List_Nil)
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$axOrient($author$project$VegaLite$siRight)
						]))
				])));
	var lineSpec1 = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				lineEnc1(_List_Nil),
				$author$project$VegaLite$line(_List_Nil)
	...
	var dotEnc = A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$pName('rating'),
					$author$project$VegaLite$pQuant,
					$author$project$VegaLite$pAxis(
					_List_fromArray(
						[
	...
	var dotSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				dotEnc(_List_Nil),
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[barSpec, dotSpec, lineSpec1, lineSpec2, lineSpec3]))
			]));
};
...
var $author$project$ConfigTests$redAxis = _List_fromArray(
	[
		$author$project$VegaLite$axcoDomainColor('red'),
		$author$project$VegaLite$axcoTitleColor('red'),
		$author$project$VegaLite$axcoLabelColor('red'),
		$author$project$VegaLite$axcoTickColor('red')
	]);
var $author$project$ConfigTests$axisCfg10 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisQuant($author$project$ConfigTests$redAxis))));
...
var $author$project$ConfigTests$axisCfg11 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisTemporal($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxisDiscrete = F2(
	function (a, b) {
		return {$: 10, a: a, b: b};
	});
var $author$project$VegaLite$coAxisDiscrete = $author$project$VegaLite$AxisDiscrete(0);
var $author$project$ConfigTests$axisCfg12 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisDiscrete($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxisPoint = F2(
	function (a, b) {
		return {$: 11, a: a, b: b};
	});
var $author$project$VegaLite$coAxisPoint = $author$project$VegaLite$AxisPoint(0);
var $author$project$ConfigTests$axisCfg13 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisPoint($author$project$ConfigTests$redAxis))));
var $author$project$ConfigTests$axisCfg2 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxis($author$project$ConfigTests$redAxis))));
...
var $author$project$ConfigTests$axisCfg3 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
...
var $author$project$ConfigTests$axisCfg4 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisYFilter(
				$author$project$VegaLite$coAxis($author$project$ConfigTests$redAxis)))));
var $author$project$VegaLite$AxisBottom = function (a) {
	return {$: 8, a: a};
};
var $author$project$VegaLite$coAxisBottom = $author$project$VegaLite$AxisBottom;
var $author$project$ConfigTests$axisCfg5 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisBottom($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxisLeft = function (a) {
	return {$: 5, a: a};
};
var $author$project$VegaLite$coAxisLeft = $author$project$VegaLite$AxisLeft;
var $author$project$ConfigTests$axisCfg6 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisLeft($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxisTop = function (a) {
	return {$: 7, a: a};
};
var $author$project$VegaLite$coAxisTop = $author$project$VegaLite$AxisTop;
var $author$project$ConfigTests$axisCfg7 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisTop($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxisRight = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$coAxisRight = $author$project$VegaLite$AxisRight;
var $author$project$ConfigTests$axisCfg8 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisRight($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$coAxisBand = $author$project$VegaLite$AxisBand(0);
var $author$project$ConfigTests$axisCfg9 = $author$project$ConfigTests$histoVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxisBand($author$project$ConfigTests$redAxis))));
var $author$project$VegaLite$AxcoDisable = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$axcoDisable = function (b) {
	return $author$project$VegaLite$AxcoDisable(
		$author$project$VegaLite$Boo(b));
};
...
var $author$project$VegaLite$LecoDisable = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$lecoDisable = function (b) {
	return $author$project$VegaLite$LecoDisable(
		$author$project$VegaLite$Boo(b));
};
var $author$project$ConfigTests$axisLegendCfg1 = $author$project$ConfigTests$singleVis(
	A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			$author$project$VegaLite$configuration(
				$author$project$VegaLite$coLegend(
					_List_fromArray(
						[
							$author$project$VegaLite$lecoDisable(true)
						])))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coAxis(
				_List_fromArray(
					[
						$author$project$VegaLite$axcoDisable(true)
					])))));
...
var $author$project$VegaLite$chY = 1;
var $author$project$VegaLite$BarStyle = function (a) {
	return {$: 15, a: a};
};
var $author$project$VegaLite$coBar = $author$project$VegaLite$BarStyle;
var $author$project$VegaLite$MMinBandSize = function (a) {
	return {$: 21, a: a};
};
var $author$project$VegaLite$maMinBandSize = function (n) {
	return $author$project$VegaLite$MMinBandSize(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$ttEncoding = 0;
var $author$project$ConfigTests$barCfg1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName('Director'),
						$author$project$VegaLite$pSort(
						_List_fromArray(
							[
								$author$project$VegaLite$soByChannel($author$project$VegaLite$chY)
							])),
						$author$project$VegaLite$pAxis(
						_List_fromArray(
							[
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConfigTests$path + 'movies.json', _List_Nil);
	var cfg = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coBar(
				_List_fromArray(
					[
						$author$project$VegaLite$maMinBandSize(6)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$chColor = 6;
var $author$project$VegaLite$ChShape = 8;
var $author$project$VegaLite$chShape = 8;
...
var $author$project$VegaLite$VLResolve = 27;
...
var $author$project$ConfigTests$compositeVis = function (cfg) {
	...
	var streamSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'Car Streamgraph', _List_Nil),
				$author$project$VegaLite$width(200),
				$author$project$VegaLite$height(200),
	...
	var barSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'Car Histogram', _List_Nil),
				$author$project$VegaLite$width(200),
				$author$project$VegaLite$height(200),
...
var $author$project$VegaLite$LecoFillColor = function (a) {
	return {$: 7, a: a};
};
var $author$project$VegaLite$lecoFillColor = function (s) {
	return $author$project$VegaLite$LecoFillColor(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoGradientStrokeColor = function (a) {
	return {$: 13, a: a};
};
var $author$project$VegaLite$lecoGradientStrokeColor = function (s) {
	return $author$project$VegaLite$LecoGradientStrokeColor(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoLabelColor = function (a) {
	return {$: 23, a: a};
};
var $author$project$VegaLite$lecoLabelColor = function (s) {
	return $author$project$VegaLite$LecoLabelColor(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$LecoSymbolFillColor = function (a) {
	return {$: 43, a: a};
};
var $author$project$VegaLite$lecoSymbolFillColor = function (s) {
	return $author$project$VegaLite$LecoSymbolFillColor(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoTitleColor = function (a) {
	return {$: 55, a: a};
};
var $author$project$VegaLite$lecoTitleColor = function (s) {
	return $author$project$VegaLite$LecoTitleColor(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$ConfigTests$darkCfg = $author$project$ConfigTests$compositeVis(
	A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					$author$project$VegaLite$coTitle(
						_List_fromArray(
							[
								...
								$author$project$VegaLite$ticoColor('#fff')
							])))),
			$author$project$VegaLite$configuration(
				$author$project$VegaLite$coAxis(
					_List_fromArray(
						[
							$author$project$VegaLite$axcoDomainColor('yellow'),
							$author$project$VegaLite$axcoGridColor('rgb(255,255,200)'),
							$author$project$VegaLite$axcoGridOpacity(0.2),
							$author$project$VegaLite$axcoLabelColor('#fcf'),
							$author$project$VegaLite$axcoTickColor('white'),
							$author$project$VegaLite$axcoTitleColor('rgb(200,255,200)')
						])))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coLegend(
				_List_fromArray(
					[
						$author$project$VegaLite$lecoFillColor('#333'),
						$author$project$VegaLite$lecoStrokeColor('#444'),
						$author$project$VegaLite$lecoTitleColor('rgb(200,200,200)'),
						$author$project$VegaLite$lecoLabelColor('white'),
...
var $author$project$VegaLite$coMark = $author$project$VegaLite$MarkStyle;
var $author$project$ConfigTests$markCfg1 = $author$project$ConfigTests$compositeVis(
	A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
...
var $author$project$VegaLite$maStrokeOpacity = function (n) {
	return $author$project$VegaLite$MStrokeOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$ConfigTests$markCfg2 = $author$project$ConfigTests$compositeVis(
	A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coPoint(
				_List_fromArray(
					[
						$author$project$VegaLite$maFilled(true),
						$author$project$VegaLite$maStroke('white'),
						$author$project$VegaLite$maStrokeOpacity(0.2)
					])))));
...
var $author$project$VegaLite$DArray = function (a) {
	return {$: 8, a: a};
};
var $author$project$VegaLite$datumArray = $author$project$VegaLite$DArray;
...
var $author$project$VegaLite$VLUserMeta = 12;
var $author$project$VegaLite$userMeta = function (object) {
	return _Utils_Tuple2(
		12,
		$elm$json$Json$Encode$object(
			A2(
...
var $author$project$ConfigTests$metaCfg = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				$author$project$VegaLite$width(400),
				$author$project$VegaLite$userMeta(
				_List_fromArray(
					[
						_Utils_Tuple2(
						'Custom1',
						$author$project$VegaLite$num(13)),
						_Utils_Tuple2(
						'Custom2',
						$author$project$VegaLite$str('hello')),
						_Utils_Tuple2(
						'Custom3',
						$author$project$VegaLite$datumArray(
							A2(
								$elm$core$List$map,
						...
						$author$project$VegaLite$dataObject(
							_List_fromArray(
								[
									_Utils_Tuple2(
									'nested1',
									$author$project$VegaLite$num(14)),
									_Utils_Tuple2(
									'nested2',
									$author$project$VegaLite$boo(true))
								]))),
						_Utils_Tuple2('Custom5', $author$project$VegaLite$nullValue)
					])),
				data(_List_Nil),
				enc(_List_Nil),
...
var $author$project$VegaLite$coNumberFormat = function (s) {
...
var $author$project$ConfigTests$numberCfg = function (cfg) {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					A2($author$project$VegaLite$calculateAs, 'datum[\'Flipper Length (mm)\']/1000', 'flipperLen')),
				A2($author$project$VegaLite$calculateAs, 'datum[\'Beak Length (mm)\']/1000', 'beakLen')),
			A2($author$project$VegaLite$calculateAs, 'datum[\'Beak Depth (mm)\']/1000', 'beak depth (m)')),
		A2($author$project$VegaLite$calculateAs, 'datum[\'Body Mass (g)\']/1000', 'mass'));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							_List_fromArray(
								[
									$author$project$VegaLite$pName('flipperLen'),
									$author$project$VegaLite$pQuant,
									$author$project$VegaLite$pTitle('Flipper length (m)'),
					...
					A2(
						...
						_List_fromArray(
							[
								$author$project$VegaLite$pName('beakLen'),
								$author$project$VegaLite$pQuant,
								$author$project$VegaLite$pTitle('Beak length (m)'),
								$author$project$VegaLite$pScale(
								_List_fromArray(
									[
										$author$project$VegaLite$scDomain(
				...
				$author$project$VegaLite$size(
					_List_fromArray(
						[
							$author$project$VegaLite$mName('mass'),
							$author$project$VegaLite$mQuant,
							$author$project$VegaLite$mTitle('Body mass (kg)'),
		...
		$author$project$VegaLite$tooltips(
			_List_fromArray(
				[
					_List_fromArray(
					[
						$author$project$VegaLite$tName('beak depth (m)'),
						$author$project$VegaLite$tQuant
					])
				])));
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConfigTests$path + 'penguins.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				cfg(_List_Nil),
...
var $author$project$ConfigTests$numberCfg1 = function () {
	var cfg = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coNumberFormat('.4f')));
	return $author$project$ConfigTests$numberCfg(cfg);
}();
...
var $author$project$VegaLite$AxFormatAsCustom = function (a) {
	return {$: 19, a: a};
};
var $author$project$VegaLite$axFormatAsCustom = function (s) {
	return $author$project$VegaLite$AxFormatAsCustom(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$coNumberFormatType = function (s) {
	return $author$project$VegaLite$NumberFormatType(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LFormat = function (a) {
	return {$: 7, a: a};
};
var $author$project$VegaLite$leFormat = function (s) {
	return $author$project$VegaLite$LFormat(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LFormatAsCustom = function (a) {
	return {$: 10, a: a};
};
var $author$project$VegaLite$leFormatAsCustom = function (s) {
	return $author$project$VegaLite$LFormatAsCustom(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$TFormatAsCustom = function (a) {
	return {$: 13, a: a};
};
var $author$project$VegaLite$tFormatAsCustom = function (s) {
	return $author$project$VegaLite$TFormatAsCustom(
		$author$project$VegaLite$Str(s));
};
var $author$project$ConfigTests$numberCfg2 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				A2(
					...
					A2($author$project$VegaLite$calculateAs, 'datum[\'Flipper Length (mm)\']/1000', 'flipperLen')),
				A2($author$project$VegaLite$calculateAs, 'datum[\'Beak Length (mm)\']/1000', 'beakLen')),
			A2($author$project$VegaLite$calculateAs, 'datum[\'Beak Depth (mm)\']/1000', 'beak depth')),
		A2($author$project$VegaLite$calculateAs, 'datum[\'Body Mass (g)\']/1000', 'mass'));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
						...
						A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$VegaLite$axTitle('Flipper length'),
											$author$project$VegaLite$axFormatAsCustom('unitFormat'),
											$author$project$VegaLite$axFormat('2m')
										])),
									$author$project$VegaLite$pScale(
									_List_fromArray(
										[
					...
					A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$VegaLite$axTitle('Beak length'),
										$author$project$VegaLite$axFormatAsCustom('unitFormat'),
										$author$project$VegaLite$axFormat('3m')
									])),
								$author$project$VegaLite$pScale(
								_List_fromArray(
									[
				...
				$author$project$VegaLite$size(
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$leTitle('Body mass'),
									$author$project$VegaLite$leFormatAsCustom('unitFormat'),
									$author$project$VegaLite$leFormat('0kg')
								])),
							$author$project$VegaLite$mScale(
							_List_fromArray(
								[
		...
		$author$project$VegaLite$tooltips(
			_List_fromArray(
				[
					_List_fromArray(
					[
						$author$project$VegaLite$tName('beak depth'),
						$author$project$VegaLite$tQuant,
						$author$project$VegaLite$tFormatAsCustom('unitFormat'),
						$author$project$VegaLite$tFormat('3m')
					])
				])));
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConfigTests$path + 'penguins.json', _List_Nil);
	var cfg = A2(
		...
		A2(
			...
			$author$project$VegaLite$configuration(
				$author$project$VegaLite$coCustomFormatTypes(true))),
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coNumberFormatType('unitFormat')));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				cfg(_List_Nil),
...
var $author$project$VegaLite$PEdges = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$paEdges = F4(
	function (l, t, r, b) {
		return $author$project$VegaLite$PEdges(
			$author$project$VegaLite$Nums(
				_List_fromArray(
					[l, t, r, b])));
	});
var $author$project$ConfigTests$paddingCfg = $author$project$ConfigTests$singleVis(
	A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$NormalizedNumberFormat = function (a) {
	return {$: 30, a: a};
};
		...
		switch (_v0.$) {
			...
			case 32:
				return $author$project$VegaLite$NumberFormat(
					$author$project$VegaLite$StrExpr(ex));
			case 30:
				return $author$project$VegaLite$NormalizedNumberFormat(
					$author$project$VegaLite$StrExpr(ex));
			case 46:
				return $author$project$VegaLite$TimeFormat(
					$author$project$VegaLite$StrExpr(ex));
...
var $author$project$VegaLite$ipColor = $author$project$VegaLite$IPColor;
...
var $author$project$VegaLite$VClip = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$vicoBooExpr = F2(
	function (ex, fn) {
		var _v0 = fn(false);
		if (_v0.$ === 1) {
			return $author$project$VegaLite$VClip(
				$author$project$VegaLite$BooExpr(ex));
		} else {
			return fn(false);
		}
	});
var $author$project$VegaLite$vicoClip = function (b) {
	return $author$project$VegaLite$VClip(
		$author$project$VegaLite$Boo(b));
};
...
var $author$project$VegaLite$vicoCornerRadius = function (n) {
...
var $author$project$VegaLite$vicoFillOpacity = function (n) {
	return $author$project$VegaLite$VFillOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$VDiscreteHeight = function (a) {
	return {$: 7, a: a};
};
var $author$project$VegaLite$VDiscreteWidth = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$VOpacity = function (a) {
	return {$: 10, a: a};
};
var $author$project$VegaLite$VStep = function (a) {
	return {$: 11, a: a};
};
var $author$project$VegaLite$VStrokeDashOffset = function (a) {
	return {$: 17, a: a};
};
var $author$project$VegaLite$VStrokeMiterLimit = function (a) {
	return {$: 19, a: a};
};
var $author$project$VegaLite$VStrokeOpacity = function (a) {
	return {$: 13, a: a};
};
var $author$project$VegaLite$VStrokeWidth = function (a) {
	return {$: 14, a: a};
};
var $author$project$VegaLite$vicoNumExpr = F2(
	function (ex, fn) {
		var _v0 = fn(0);
		switch (_v0.$) {
			case 2:
			...
			case 4:
				return $author$project$VegaLite$VCornerRadius(
					$author$project$VegaLite$NumExpr(ex));
			case 6:
				return $author$project$VegaLite$VDiscreteWidth(
					$author$project$VegaLite$NumExpr(ex));
			case 7:
				return $author$project$VegaLite$VDiscreteHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 9:
				return $author$project$VegaLite$VFillOpacity(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 11:
				return $author$project$VegaLite$VStep(
					$author$project$VegaLite$NumExpr(ex));
			case 13:
				return $author$project$VegaLite$VStrokeOpacity(
					$author$project$VegaLite$NumExpr(ex));
			case 14:
...
var $author$project$VegaLite$VStrokeDash = function (a) {
	return {$: 16, a: a};
};
var $author$project$VegaLite$vicoNumsExpr = F2(
	function (ex, fn) {
...
var $author$project$VegaLite$vicoOpacity = function (n) {
	return $author$project$VegaLite$VOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$vicoStrExpr = F2(
	function (ex, fn) {
		...
		switch (_v0.$) {
			...
			case 12:
				return $author$project$VegaLite$VStroke(
					$author$project$VegaLite$StrExpr(ex));
			default:
				return fn($elm$core$Maybe$Nothing);
		}
	});
...
var $author$project$VegaLite$vicoStrokeDashOffset = function (n) {
	return $author$project$VegaLite$VStrokeDashOffset(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$vicoStrokeOpacity = function (n) {
	return $author$project$VegaLite$VStrokeOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$ConfigTests$paramCfg1 = function () {
											...
											A2(
												...
												A2(
													...
													_List_fromArray(
														[
															$author$project$VegaLite$paValue(
															$author$project$VegaLite$str('#ff0')),
															$author$project$VegaLite$paBind(
	...
	var enc = A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$pName('wavelength'),
						$author$project$VegaLite$pQuant,
						$author$project$VegaLite$pScale(
						_List_fromArray(
							[
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$pName('power'),
					$author$project$VegaLite$pQuant
				])));
	var data = A2(
		$elm$core$Basics$composeL,
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coView(
				_List_fromArray(
					[
						A2($author$project$VegaLite$vicoBooExpr, 'clip', $author$project$VegaLite$vicoClip),
						...
						A2($author$project$VegaLite$vicoStrExpr, 'fill', $author$project$VegaLite$vicoFill),
						A2($author$project$VegaLite$vicoNumExpr, 'fillOpacity', $author$project$VegaLite$vicoFillOpacity),
						A2($author$project$VegaLite$vicoStrExpr, 'stroke', $author$project$VegaLite$vicoStroke),
...
var $author$project$VegaLite$FWExpr = function (a) {
	return {$: 13, a: a};
};
var $author$project$VegaLite$fwExpr = $author$project$VegaLite$FWExpr;
...
var $author$project$VegaLite$TiAngle = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$positiveAngle = function (a) {
	return (a < 0) ? (a + 360) : a;
};
var $author$project$VegaLite$ticoAngle = function (n) {
	return $author$project$VegaLite$TiAngle(
		$author$project$VegaLite$Num(
			$author$project$VegaLite$positiveAngle(n)));
};
var $author$project$VegaLite$TiDx = function (a) {
	return {$: 4, a: a};
};
var $author$project$VegaLite$ticoDx = function (n) {
	return $author$project$VegaLite$TiDx(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$TiDy = function (a) {
	return {$: 5, a: a};
};
var $author$project$VegaLite$ticoDy = function (n) {
	return $author$project$VegaLite$TiDy(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$ticoFontStyle = function (s) {
...
var $author$project$VegaLite$ticoFrame = $author$project$VegaLite$TiFrame;
var $author$project$VegaLite$TiLimit = function (a) {
	return {$: 12, a: a};
};
var $author$project$VegaLite$ticoLimit = function (n) {
	return $author$project$VegaLite$TiLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$TiLineHeight = function (a) {
	return {$: 11, a: a};
};
var $author$project$VegaLite$ticoLineHeight = function (n) {
	return $author$project$VegaLite$TiLineHeight(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$TiOffset = function (a) {
	return {$: 13, a: a};
};
var $author$project$VegaLite$TiSubtitleFontSize = function (a) {
	return {$: 19, a: a};
};
var $author$project$VegaLite$TiSubtitleLineHeight = function (a) {
	return {$: 22, a: a};
};
var $author$project$VegaLite$TiSubtitlePadding = function (a) {
	return {$: 23, a: a};
};
var $author$project$VegaLite$TiZIndex = function (a) {
	return {$: 24, a: a};
};
		...
		switch (_v0.$) {
			...
			case 13:
				return $author$project$VegaLite$TiOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 19:
				return $author$project$VegaLite$TiSubtitleFontSize(
					$author$project$VegaLite$NumExpr(ex));
			case 22:
				return $author$project$VegaLite$TiSubtitleLineHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 23:
				return $author$project$VegaLite$TiSubtitlePadding(
					$author$project$VegaLite$NumExpr(ex));
			case 24:
				return $author$project$VegaLite$TiZIndex(
					$author$project$VegaLite$NumExpr(ex));
			default:
				return fn(0);
		}
	});
var $author$project$VegaLite$ticoNumExpr = $author$project$VegaLite$tiNumExpr;
var $author$project$VegaLite$ticoOffset = function (n) {
	return $author$project$VegaLite$TiOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$TiOrient = function (a) {
	return {$: 14, a: a};
};
var $author$project$VegaLite$ticoOrient = $author$project$VegaLite$TiOrient;
var $author$project$VegaLite$TiSubtitleColor = function (a) {
	return {$: 17, a: a};
};
var $author$project$VegaLite$TiSubtitleFont = function (a) {
	return {$: 18, a: a};
};
var $author$project$VegaLite$TiSubtitleFontStyle = function (a) {
	return {$: 20, a: a};
};
		...
		switch (_v0.$) {
			...
			case 16:
				return $author$project$VegaLite$TiSubtitle(
					$author$project$VegaLite$StrExpr(ex));
			case 17:
				return $author$project$VegaLite$TiSubtitleColor(
					$author$project$VegaLite$StrExpr(ex));
			case 18:
				return $author$project$VegaLite$TiSubtitleFont(
					$author$project$VegaLite$StrExpr(ex));
			case 20:
				return $author$project$VegaLite$TiSubtitleFontStyle(
					$author$project$VegaLite$StrExpr(ex));
			default:
				return fn('');
		}
	});
var $author$project$VegaLite$ticoStrExpr = $author$project$VegaLite$tiStrExpr;
var $author$project$VegaLite$ticoSubtitleFont = function (s) {
	return $author$project$VegaLite$TiSubtitleFont(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$ticoSubtitleFontSize = function (n) {
	return $author$project$VegaLite$TiSubtitleFontSize(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$ticoSubtitleFontStyle = function (s) {
	return $author$project$VegaLite$TiSubtitleFontStyle(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$TiSubtitleFontWeight = function (a) {
	return {$: 21, a: a};
};
var $author$project$VegaLite$ticoSubtitleFontWeight = $author$project$VegaLite$TiSubtitleFontWeight;
var $author$project$VegaLite$ticoSubtitleLineHeight = function (n) {
	return $author$project$VegaLite$TiSubtitleLineHeight(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$ticoSubtitlePadding = function (n) {
	return $author$project$VegaLite$TiSubtitlePadding(
		$author$project$VegaLite$Num(n));
};
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coTitle(
				_List_fromArray(
					[
						A2($author$project$VegaLite$ticoNumExpr, 'angle', $author$project$VegaLite$ticoAngle),
						A2($author$project$VegaLite$ticoStrExpr, 'color', $author$project$VegaLite$ticoColor),
						A2($author$project$VegaLite$ticoNumExpr, 'dx', $author$project$VegaLite$ticoDx),
						A2($author$project$VegaLite$ticoNumExpr, 'dy', $author$project$VegaLite$ticoDy),
						A2($author$project$VegaLite$ticoStrExpr, 'font', $author$project$VegaLite$ticoFont),
						A2($author$project$VegaLite$ticoNumExpr, 'fontSize', $author$project$VegaLite$ticoFontSize),
						A2($author$project$VegaLite$ticoStrExpr, 'fontStyle', $author$project$VegaLite$ticoFontStyle),
						$author$project$VegaLite$ticoFontWeight(
						$author$project$VegaLite$fwExpr('fontWeight')),
						$author$project$VegaLite$ticoFrame(
						$author$project$VegaLite$tfExpr('frame')),
						A2($author$project$VegaLite$ticoNumExpr, 'limit', $author$project$VegaLite$ticoLimit),
						A2($author$project$VegaLite$ticoNumExpr, 'lineHeight', $author$project$VegaLite$ticoLineHeight),
						A2($author$project$VegaLite$ticoNumExpr, 'offset', $author$project$VegaLite$ticoOffset),
						$author$project$VegaLite$ticoOrient(
						$author$project$VegaLite$siExpr('orient')),
						A2($author$project$VegaLite$ticoStrExpr, 'subtitleFont', $author$project$VegaLite$ticoSubtitleFont),
...
var $author$project$VegaLite$RacoSymbolsExpr = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$racoSymbolsExpr = $author$project$VegaLite$RacoSymbolsExpr;
...
var $author$project$VegaLite$SacoBarBandPaddingInner = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$sacoBarBandPaddingInner = function (n) {
	return $author$project$VegaLite$SacoBarBandPaddingInner(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$SacoClamp = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$VegaLite$SacoContinuousPadding = function (a) {
	return {$: 5, a: a};
};
		...
		switch (_v0.$) {
			...
			case 1:
				return $author$project$VegaLite$SacoBarBandPaddingInner(
					$author$project$VegaLite$NumExpr(ex));
			case 2:
				return $author$project$VegaLite$SacoRectBandPaddingInner(
					$author$project$VegaLite$NumExpr(ex));
			case 5:
				return $author$project$VegaLite$SacoContinuousPadding(
					$author$project$VegaLite$NumExpr(ex));
...
var $author$project$ConfigTests$paramCfg3 = function () {
	var syms3 = $author$project$VegaLite$strs(
		_List_fromArray(
			['M0,.5L.6,.8L.5,.1L1,-.3L.3,-.4L0,-1L-.3,-.4L-1,-.3L-.5,.1L-.6,.8L0,.5Z']));
	var syms2 = $author$project$VegaLite$strs(
		_List_fromArray(
			['arrow', 'triangle', 'wedge']));
	var syms1 = $author$project$VegaLite$strs(
		_List_fromArray(
			['cross', 'diamond', 'square']));
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$paValues(syms1),
					$author$project$VegaLite$paBind(
					$author$project$VegaLite$ipSelect(
						_List_fromArray(
							[
	...
	var enc2 = A2(
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					$author$project$VegaLite$mName('y2'),
					$author$project$VegaLite$mQuant
				])));
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coRange(
				_List_fromArray(
					[
						$author$project$VegaLite$racoSymbolsExpr('symbols')
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$AnchorExpr = function (a) {
	return {$: 3, a: a};
};
var $author$project$VegaLite$anExpr = $author$project$VegaLite$AnchorExpr;
var $author$project$VegaLite$AxcoBandPosition = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$axcoBandPosition = function (n) {
	return $author$project$VegaLite$AxcoBandPosition(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoDomainCap = function (a) {
	return {$: 4, a: a};
};
var $author$project$VegaLite$axcoDomainCap = $author$project$VegaLite$AxcoDomainCap;
...
var $author$project$VegaLite$AxcoDomainOpacity = function (a) {
	return {$: 8, a: a};
};
var $author$project$VegaLite$axcoDomainOpacity = function (n) {
	return $author$project$VegaLite$AxcoDomainOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$AxcoGridCap = function (a) {
	return {$: 11, a: a};
};
var $author$project$VegaLite$axcoGridCap = $author$project$VegaLite$AxcoGridCap;
...
var $author$project$VegaLite$AxcoGridWidth = function (a) {
	return {$: 16, a: a};
};
var $author$project$VegaLite$axcoGridWidth = function (n) {
	return $author$project$VegaLite$AxcoGridWidth(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoLabelAlign = function (a) {
	return {$: 18, a: a};
};
var $author$project$VegaLite$axcoLabelAlign = $author$project$VegaLite$AxcoLabelAlign;
...
var $author$project$VegaLite$AxcoLabelBaseline = function (a) {
	return {$: 20, a: a};
};
var $author$project$VegaLite$axcoLabelBaseline = $author$project$VegaLite$AxcoLabelBaseline;
var $author$project$VegaLite$AxcoLabelBound = function (a) {
	return {$: 21, a: a};
};
var $author$project$VegaLite$MaybeNumExpr = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$axcoLabelBoundExpr = function (ex) {
	return $author$project$VegaLite$AxcoLabelBound(
		$author$project$VegaLite$MaybeNumExpr(ex));
};
var $author$project$VegaLite$AxcoLabelFlushOffset = function (a) {
	return {$: 23, a: a};
};
var $author$project$VegaLite$axcoLabelFlushOffset = function (n) {
...
var $author$project$VegaLite$AxcoLabelLimit = function (a) {
	return {$: 30, a: a};
};
var $author$project$VegaLite$axcoLabelLimit = function (n) {
	return $author$project$VegaLite$AxcoLabelLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoLabelOffset = function (a) {
	return {$: 32, a: a};
};
var $author$project$VegaLite$axcoLabelOffset = function (n) {
	return $author$project$VegaLite$AxcoLabelOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoLabelOpacity = function (a) {
	return {$: 33, a: a};
};
var $author$project$VegaLite$axcoLabelOpacity = function (n) {
	return $author$project$VegaLite$AxcoLabelOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoLabelOverlap = function (a) {
	return {$: 34, a: a};
};
var $author$project$VegaLite$axcoLabelOverlap = $author$project$VegaLite$AxcoLabelOverlap;
var $author$project$VegaLite$AxcoLabelPadding = function (a) {
	return {$: 35, a: a};
};
var $author$project$VegaLite$axcoLabelPadding = function (n) {
	return $author$project$VegaLite$AxcoLabelPadding(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$AxcoLabelSeparation = function (a) {
	return {$: 36, a: a};
};
var $author$project$VegaLite$axcoLabelSeparation = function (n) {
...
var $author$project$VegaLite$AxcoMaxExtent = function (a) {
	return {$: 37, a: a};
};
var $author$project$VegaLite$AxcoOffset = function (a) {
	return {$: 39, a: a};
};
		...
		switch (_v0.$) {
			case 1:
				return $author$project$VegaLite$AxcoBandPosition(
					$author$project$VegaLite$NumExpr(ex));
			case 37:
				return $author$project$VegaLite$AxcoMaxExtent(
					$author$project$VegaLite$NumExpr(ex));
			case 38:
				return $author$project$VegaLite$AxcoMinExtent(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 27:
				return $author$project$VegaLite$AxcoLabelFontSize(
					$author$project$VegaLite$NumExpr(ex));
			case 31:
				return $author$project$VegaLite$AxcoLabelLineHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 30:
				return $author$project$VegaLite$AxcoLabelLimit(
					$author$project$VegaLite$NumExpr(ex));
...
var $author$project$VegaLite$axcoOffset = function (n) {
	return $author$project$VegaLite$AxcoOffset(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$axcoStrExpr = F2(
	function (ex, fn) {
		var _v0 = fn('');
		switch (_v0.$) {
			case 5:
...
var $author$project$VegaLite$axcoTickOffset = function (n) {
	return $author$project$VegaLite$AxcoTickOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$axcoTickOpacity = function (n) {
	return $author$project$VegaLite$AxcoTickOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$axcoTickWidth = function (n) {
	return $author$project$VegaLite$AxcoTickWidth(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$axcoTitleOpacity = function (n) {
	return $author$project$VegaLite$AxcoTitleOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$axcoTitlePadding = function (n) {
	return $author$project$VegaLite$AxcoTitlePadding(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$axcoTranslate = function (n) {
	return $author$project$VegaLite$AxcoTranslate(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$HAlignExpr = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$VegaLite$NExpr = function (a) {
	return {$: 12, a: a};
};
var $author$project$VegaLite$niExpr = $author$project$VegaLite$NExpr;
var $author$project$VegaLite$OverlapExpr = function (a) {
	return {$: 3, a: a};
};
var $author$project$VegaLite$osExpr = $author$project$VegaLite$OverlapExpr;
var $author$project$VegaLite$TBExpr = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$tbExpr = $author$project$VegaLite$TBExpr;
var $author$project$VegaLite$VAlignExpr = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$vaExpr = $author$project$VegaLite$VAlignExpr;
var $author$project$ConfigTests$paramCfg4 = function () {
	var solid = $author$project$VegaLite$nums(_List_Nil);
	var shortDash = $author$project$VegaLite$nums(
		_List_fromArray(
			[2, 2]));
																	...
																	A2(
																		...
																		A2(
																			...
																			_List_fromArray(
																				[
																					$author$project$VegaLite$paValue(
																					$author$project$VegaLite$str('middle')),
																					$author$project$VegaLite$paBind(
																					$author$project$VegaLite$ipSelect(
																						_List_fromArray(
																							[
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$pBin(_List_Nil),
						$author$project$VegaLite$pOrdinal,
						$author$project$VegaLite$pTitle('Internet Movie Database (IMDB)\nBinned Rating')
					]))),
		A2(
			$author$project$VegaLite$position,
			1,
	...
	var dataMovies = A2($author$project$VegaLite$dataFromUrl, $author$project$ConfigTests$path + 'movies.json', _List_Nil);
	var cfg = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			$author$project$VegaLite$configuration(
				$author$project$VegaLite$coAxisXFilter(
					$author$project$VegaLite$coAxis(
						_List_fromArray(
							[
								A2($author$project$VegaLite$axcoNumExpr, 'bandPosition', $author$project$VegaLite$axcoBandPosition),
								A2($author$project$VegaLite$axcoNumExpr, 'offset', $author$project$VegaLite$axcoOffset),
								A2($author$project$VegaLite$axcoNumExpr, 'minExtent', $author$project$VegaLite$axcoMinExtent),
								$author$project$VegaLite$axcoDomainCap(
								$author$project$VegaLite$caExpr('domainCap')),
								A2($author$project$VegaLite$axcoStrExpr, 'domainColor', $author$project$VegaLite$axcoDomainColor),
								A2($author$project$VegaLite$axcoNumsExpr, 'domainDash', $author$project$VegaLite$axcoDomainDash),
								A2($author$project$VegaLite$axcoNumExpr, 'domainDashOffset', $author$project$VegaLite$axcoDomainDashOffset),
								A2($author$project$VegaLite$axcoNumExpr, 'domainOpacity', $author$project$VegaLite$axcoDomainOpacity),
								A2($author$project$VegaLite$axcoNumExpr, 'domainWidth', $author$project$VegaLite$axcoDomainWidth),
								A2($author$project$VegaLite$axcoNumExpr, 'translate', $author$project$VegaLite$axcoTranslate),
								$author$project$VegaLite$axcoLabelAlign(
								$author$project$VegaLite$haExpr('labelAlign')),
								$author$project$VegaLite$axcoLabelBaseline(
								$author$project$VegaLite$vaExpr('labelBaseline')),
								A2($author$project$VegaLite$axcoNumExpr, 'labelAngle', $author$project$VegaLite$axcoLabelAngle),
								A2($author$project$VegaLite$axcoStrExpr, 'labelColor', $author$project$VegaLite$axcoLabelColor),
								A2($author$project$VegaLite$axcoNumExpr, 'labelFlushOffset', $author$project$VegaLite$axcoLabelFlushOffset),
								A2($author$project$VegaLite$axcoStrExpr, 'labelFont', $author$project$VegaLite$axcoLabelFont),
								A2($author$project$VegaLite$axcoNumExpr, 'labelFontSize', $author$project$VegaLite$axcoLabelFontSize),
								A2($author$project$VegaLite$axcoStrExpr, 'labelFontStyle', $author$project$VegaLite$axcoLabelFontStyle),
								$author$project$VegaLite$axcoLabelFontWeight(
								$author$project$VegaLite$fwExpr('labelFontWeight')),
								A2($author$project$VegaLite$axcoNumExpr, 'labelLimit', $author$project$VegaLite$axcoLabelLimit),
								A2($author$project$VegaLite$axcoNumExpr, 'labelOffset', $author$project$VegaLite$axcoLabelOffset),
								A2($author$project$VegaLite$axcoNumExpr, 'labelOpacity', $author$project$VegaLite$axcoLabelOpacity),
								$author$project$VegaLite$axcoLabelOverlap(
								$author$project$VegaLite$osExpr('labelOverlap')),
								A2($author$project$VegaLite$axcoNumExpr, 'labelPadding', $author$project$VegaLite$axcoLabelPadding),
								A2($author$project$VegaLite$axcoNumExpr, 'labelSeparation', $author$project$VegaLite$axcoLabelSeparation),
								$author$project$VegaLite$axcoTickBand(
								$author$project$VegaLite$tbExpr('tickBand')),
								$author$project$VegaLite$axcoTickCap(
								$author$project$VegaLite$caExpr('tickCap')),
								A2($author$project$VegaLite$axcoStrExpr, 'tickColor', $author$project$VegaLite$axcoTickColor),
								A2($author$project$VegaLite$axcoNumsExpr, 'tickDash', $author$project$VegaLite$axcoTickDash),
								A2($author$project$VegaLite$axcoNumExpr, 'tickDashOffset', $author$project$VegaLite$axcoTickDashOffset),
								A2($author$project$VegaLite$axcoNumExpr, 'tickOffset', $author$project$VegaLite$axcoTickOffset),
								A2($author$project$VegaLite$axcoNumExpr, 'tickOpacity', $author$project$VegaLite$axcoTickOpacity),
								A2($author$project$VegaLite$axcoNumExpr, 'tickSize', $author$project$VegaLite$axcoTickSize),
								A2($author$project$VegaLite$axcoNumExpr, 'tickWidth', $author$project$VegaLite$axcoTickWidth),
								$author$project$VegaLite$axcoTitleAnchor(
								$author$project$VegaLite$anExpr('titleAnchor')),
								$author$project$VegaLite$axcoTitleAlign(
								$author$project$VegaLite$haExpr('titleAlign')),
								A2($author$project$VegaLite$axcoNumExpr, 'titleAngle', $author$project$VegaLite$axcoTitleAngle),
								$author$project$VegaLite$axcoTitleBaseline(
								$author$project$VegaLite$vaExpr('titleBaseline')),
								A2($author$project$VegaLite$axcoStrExpr, 'titleColor', $author$project$VegaLite$axcoTitleColor),
								A2($author$project$VegaLite$axcoStrExpr, 'titleFont', $author$project$VegaLite$axcoTitleFont),
								A2($author$project$VegaLite$axcoStrExpr, 'titleFontStyle', $author$project$VegaLite$axcoTitleFontStyle),
								$author$project$VegaLite$axcoTitleFontWeight(
								$author$project$VegaLite$fwExpr('titleFontWeight')),
								A2($author$project$VegaLite$axcoNumExpr, 'titleLimit', $author$project$VegaLite$axcoTitleLimit),
	...
	var aVals3 = $author$project$VegaLite$nums(
		_List_fromArray(
			[250, 500, 750]));
	var aVals2 = $author$project$VegaLite$nums(
		_List_fromArray(
			[0, 400, 500, 600, 1000]));
	var aVals1 = $author$project$VegaLite$nums(
		_List_fromArray(
			[0, 500, 1000]));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
...
var $author$project$VegaLite$VLAutosize = 8;
var $author$project$VegaLite$autosize = function (aus) {
	return _Utils_Tuple2(
		8,
		$elm$json$Json$Encode$object(
			A2($elm$core$List$map, $author$project$VegaLite$autosizeProperty, aus)));
...
var $author$project$VegaLite$LecoCornerRadius = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$lecoCornerRadius = function (n) {
	return $author$project$VegaLite$LecoCornerRadius(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoGradientLength = function (a) {
	return {$: 11, a: a};
};
var $author$project$VegaLite$lecoGradientLength = function (n) {
	return $author$project$VegaLite$LecoGradientLength(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoGradientOpacity = function (a) {
	return {$: 12, a: a};
};
var $author$project$VegaLite$lecoGradientOpacity = function (n) {
	return $author$project$VegaLite$LecoGradientOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoGradientStrokeWidth = function (a) {
	return {$: 14, a: a};
};
var $author$project$VegaLite$lecoGradientStrokeWidth = function (n) {
	return $author$project$VegaLite$LecoGradientStrokeWidth(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoGradientThickness = function (a) {
	return {$: 15, a: a};
};
var $author$project$VegaLite$lecoGradientThickness = function (n) {
	return $author$project$VegaLite$LecoGradientThickness(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoLabelAlign = function (a) {
	return {$: 21, a: a};
};
var $author$project$VegaLite$lecoLabelAlign = $author$project$VegaLite$LecoLabelAlign;
var $author$project$VegaLite$LecoLabelBaseline = function (a) {
	return {$: 22, a: a};
};
var $author$project$VegaLite$lecoLabelBaseline = $author$project$VegaLite$LecoLabelBaseline;
var $author$project$VegaLite$LecoLabelFont = function (a) {
	return {$: 24, a: a};
};
var $author$project$VegaLite$lecoLabelFont = function (s) {
	return $author$project$VegaLite$LecoLabelFont(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoLabelFontSize = function (a) {
	return {$: 25, a: a};
};
var $author$project$VegaLite$lecoLabelFontSize = function (n) {
	return $author$project$VegaLite$LecoLabelFontSize(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoLabelFontStyle = function (a) {
	return {$: 26, a: a};
};
var $author$project$VegaLite$lecoLabelFontStyle = function (s) {
	return $author$project$VegaLite$LecoLabelFontStyle(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoLabelFontWeight = function (a) {
	return {$: 27, a: a};
};
var $author$project$VegaLite$lecoLabelFontWeight = $author$project$VegaLite$LecoLabelFontWeight;
var $author$project$VegaLite$LecoLabelLimit = function (a) {
	return {$: 28, a: a};
};
var $author$project$VegaLite$lecoLabelLimit = function (n) {
	return $author$project$VegaLite$LecoLabelLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoLabelOffset = function (a) {
	return {$: 29, a: a};
};
var $author$project$VegaLite$lecoLabelOffset = function (n) {
	return $author$project$VegaLite$LecoLabelOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$LecoLabelOverlap = function (a) {
	return {$: 30, a: a};
};
var $author$project$VegaLite$lecoLabelOverlap = $author$project$VegaLite$LecoLabelOverlap;
var $author$project$VegaLite$LecoClipHeight = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$LecoColumnPadding = function (a) {
	return {$: 3, a: a};
};
var $author$project$VegaLite$LecoColumns = function (a) {
	return {$: 4, a: a};
};
var $author$project$VegaLite$LecoOffset = function (a) {
	return {$: 31, a: a};
};
var $author$project$VegaLite$LecoPadding = function (a) {
	return {$: 33, a: a};
};
var $author$project$VegaLite$LecoPositionX = function (a) {
	return {$: 65, a: a};
};
var $author$project$VegaLite$LecoPositionY = function (a) {
	return {$: 66, a: a};
};
...
var $author$project$VegaLite$LecoSymbolDashOffset = function (a) {
	return {$: 41, a: a};
};
var $author$project$VegaLite$LecoSymbolLimit = function (a) {
	return {$: 44, a: a};
};
var $author$project$VegaLite$LecoSymbolOffset = function (a) {
	return {$: 45, a: a};
};
var $author$project$VegaLite$LecoSymbolOpacity = function (a) {
	return {$: 46, a: a};
};
var $author$project$VegaLite$LecoSymbolSize = function (a) {
	return {$: 48, a: a};
};
var $author$project$VegaLite$LecoSymbolStrokeWidth = function (a) {
	return {$: 49, a: a};
};
var $author$project$VegaLite$LecoTitleFontSize = function (a) {
	return {$: 57, a: a};
};
var $author$project$VegaLite$LecoTitleLimit = function (a) {
	return {$: 60, a: a};
};
var $author$project$VegaLite$LecoTitleLineHeight = function (a) {
	return {$: 61, a: a};
};
var $author$project$VegaLite$LecoTitleOpacity = function (a) {
	return {$: 62, a: a};
};
var $author$project$VegaLite$LecoTitlePadding = function (a) {
	return {$: 63, a: a};
};
var $author$project$VegaLite$lecoNumExpr = F2(
	function (ex, fn) {
		var _v0 = fn(0);
		switch (_v0.$) {
			case 2:
				return $author$project$VegaLite$LecoClipHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 3:
				return $author$project$VegaLite$LecoColumnPadding(
					$author$project$VegaLite$NumExpr(ex));
			case 4:
				return $author$project$VegaLite$LecoColumns(
					$author$project$VegaLite$NumExpr(ex));
			case 6:
				return $author$project$VegaLite$LecoCornerRadius(
					$author$project$VegaLite$NumExpr(ex));
			...
			case 29:
				return $author$project$VegaLite$LecoLabelOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 31:
				return $author$project$VegaLite$LecoOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 33:
			...
			case 37:
				return $author$project$VegaLite$LecoStrokeWidth(
					$author$project$VegaLite$NumExpr(ex));
			case 41:
				return $author$project$VegaLite$LecoSymbolDashOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 44:
				return $author$project$VegaLite$LecoSymbolLimit(
					$author$project$VegaLite$NumExpr(ex));
			case 45:
				return $author$project$VegaLite$LecoSymbolOffset(
					$author$project$VegaLite$NumExpr(ex));
			case 46:
				return $author$project$VegaLite$LecoSymbolOpacity(
					$author$project$VegaLite$NumExpr(ex));
			case 48:
				return $author$project$VegaLite$LecoSymbolSize(
					$author$project$VegaLite$NumExpr(ex));
			case 49:
				return $author$project$VegaLite$LecoSymbolStrokeWidth(
					$author$project$VegaLite$NumExpr(ex));
			case 57:
				return $author$project$VegaLite$LecoTitleFontSize(
					$author$project$VegaLite$NumExpr(ex));
			case 60:
				return $author$project$VegaLite$LecoTitleLimit(
					$author$project$VegaLite$NumExpr(ex));
			case 61:
				return $author$project$VegaLite$LecoTitleLineHeight(
					$author$project$VegaLite$NumExpr(ex));
			case 62:
				return $author$project$VegaLite$LecoTitleOpacity(
					$author$project$VegaLite$NumExpr(ex));
			case 63:
				return $author$project$VegaLite$LecoTitlePadding(
					$author$project$VegaLite$NumExpr(ex));
			case 65:
				return $author$project$VegaLite$LecoPositionX(
					$author$project$VegaLite$NumExpr(ex));
			case 66:
				return $author$project$VegaLite$LecoPositionY(
					$author$project$VegaLite$NumExpr(ex));
			default:
				return fn(0);
		}
	});
var $author$project$VegaLite$lecoOffset = function (n) {
	return $author$project$VegaLite$LecoOffset(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$LecoTitleFont = function (a) {
	return {$: 56, a: a};
};
var $author$project$VegaLite$LecoTitleFontStyle = function (a) {
	return {$: 58, a: a};
};
var $author$project$VegaLite$lecoStrExpr = F2(
	function (ex, fn) {
		var _v0 = fn('');
		switch (_v0.$) {
			case 7:
			...
			case 55:
				return $author$project$VegaLite$LecoTitleColor(
					$author$project$VegaLite$StrExpr(ex));
			case 56:
				return $author$project$VegaLite$LecoTitleFont(
					$author$project$VegaLite$StrExpr(ex));
			case 58:
				return $author$project$VegaLite$LecoTitleFontStyle(
					$author$project$VegaLite$StrExpr(ex));
			default:
				return fn('');
		}
	});
var $author$project$VegaLite$lecoX = function (n) {
	return $author$project$VegaLite$LecoPositionX(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoY = function (n) {
	return $author$project$VegaLite$LecoPositionY(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$None = 4;
var $author$project$VegaLite$loNone = 4;
var $author$project$ConfigTests$paramCfg5 = function () {
	var solid = $author$project$VegaLite$nums(_List_Nil);
	var shortDash = $author$project$VegaLite$nums(
		_List_fromArray(
			[2, 2]));
	...
	var longDash = $author$project$VegaLite$nums(
		_List_fromArray(
			[8, 8]));
	var lVals3 = $author$project$VegaLite$nums(
		_List_fromArray(
			[5, 10, 15, 20, 25]));
	var lVals2 = $author$project$VegaLite$nums(
		_List_fromArray(
			[0, 25]));
	var lVals1 = $author$project$VegaLite$nums(
		_List_fromArray(
			[8, 12, 16, 20, 24]));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$VegaLite$pName('Weight_in_lbs'),
							$author$project$VegaLite$pQuant
						]))),
			A2(
				$author$project$VegaLite$position,
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coLegend(
				_List_fromArray(
					[
						A2($author$project$VegaLite$lecoNumExpr, 'cornerRadius', $author$project$VegaLite$lecoCornerRadius),
						A2($author$project$VegaLite$lecoStrExpr, 'fillColor', $author$project$VegaLite$lecoFillColor),
						A2($author$project$VegaLite$lecoNumExpr, 'gradientLength', $author$project$VegaLite$lecoGradientLength),
						A2($author$project$VegaLite$lecoNumExpr, 'gradientOpacity', $author$project$VegaLite$lecoGradientOpacity),
						A2($author$project$VegaLite$lecoStrExpr, 'gradientStrokeColor', $author$project$VegaLite$lecoGradientStrokeColor),
						A2($author$project$VegaLite$lecoNumExpr, 'gradientStrokeWidth', $author$project$VegaLite$lecoGradientStrokeWidth),
						A2($author$project$VegaLite$lecoNumExpr, 'gradientThickness', $author$project$VegaLite$lecoGradientThickness),
						$author$project$VegaLite$lecoLabelAlign(
						$author$project$VegaLite$haExpr('labelAlign')),
						$author$project$VegaLite$lecoLabelBaseline(
						$author$project$VegaLite$vaExpr('labelBaseline')),
						A2($author$project$VegaLite$lecoStrExpr, 'labelFont', $author$project$VegaLite$lecoLabelFont),
						A2($author$project$VegaLite$lecoNumExpr, 'labelFontSize', $author$project$VegaLite$lecoLabelFontSize),
						A2($author$project$VegaLite$lecoStrExpr, 'labelFontStyle', $author$project$VegaLite$lecoLabelFontStyle),
						$author$project$VegaLite$lecoLabelFontWeight(
						$author$project$VegaLite$fwExpr('labelFontWeight')),
						A2($author$project$VegaLite$lecoNumExpr, 'labelLimit', $author$project$VegaLite$lecoLabelLimit),
						A2($author$project$VegaLite$lecoNumExpr, 'labelOffset', $author$project$VegaLite$lecoLabelOffset),
						$author$project$VegaLite$lecoLabelOverlap(
						$author$project$VegaLite$osExpr('labelOverlap')),
						A2($author$project$VegaLite$lecoNumExpr, 'offset', $author$project$VegaLite$lecoOffset),
						A2($author$project$VegaLite$lecoNumExpr, 'padding', $author$project$VegaLite$lecoPadding),
						A2($author$project$VegaLite$lecoStrExpr, 'strokeColor', $author$project$VegaLite$lecoStrokeColor),
						A2($author$project$VegaLite$lecoNumExpr, 'xPos', $author$project$VegaLite$lecoX),
						A2($author$project$VegaLite$lecoNumExpr, 'yPos', $author$project$VegaLite$lecoY)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$VegaLite$lecoClipHeight = function (n) {
	return $author$project$VegaLite$LecoClipHeight(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoColumnPadding = function (n) {
	return $author$project$VegaLite$LecoColumnPadding(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoColumns = function (n) {
	return $author$project$VegaLite$LecoColumns(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$LecoSymbolDash = function (a) {
	return {$: 40, a: a};
};
var $author$project$VegaLite$lecoNumsExpr = F2(
	function (ex, fn) {
		var _v0 = fn(_List_Nil);
		switch (_v0.$) {
			case 36:
				return $author$project$VegaLite$LecoStrokeDash(
					$author$project$VegaLite$NumsExpr(ex));
			case 40:
				return $author$project$VegaLite$LecoSymbolDash(
					$author$project$VegaLite$NumsExpr(ex));
			default:
				return fn(_List_Nil);
		}
...
var $author$project$VegaLite$lecoSymbolDash = function (ns) {
	return $author$project$VegaLite$LecoSymbolDash(
		$author$project$VegaLite$Nums(ns));
};
var $author$project$VegaLite$lecoSymbolDashOffset = function (n) {
	return $author$project$VegaLite$LecoSymbolDashOffset(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$lecoSymbolOffset = function (n) {
	return $author$project$VegaLite$LecoSymbolOffset(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoSymbolOpacity = function (n) {
	return $author$project$VegaLite$LecoSymbolOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoSymbolSize = function (n) {
	return $author$project$VegaLite$LecoSymbolSize(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$LecoTitleAlign = function (a) {
	return {$: 52, a: a};
};
var $author$project$VegaLite$lecoTitleAlign = $author$project$VegaLite$LecoTitleAlign;
var $author$project$VegaLite$LecoTitleAnchor = function (a) {
	return {$: 53, a: a};
};
var $author$project$VegaLite$lecoTitleAnchor = $author$project$VegaLite$LecoTitleAnchor;
var $author$project$VegaLite$LecoTitleBaseline = function (a) {
	return {$: 54, a: a};
};
var $author$project$VegaLite$lecoTitleBaseline = $author$project$VegaLite$LecoTitleBaseline;
var $author$project$VegaLite$lecoTitleFont = function (s) {
	return $author$project$VegaLite$LecoTitleFont(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$lecoTitleFontSize = function (n) {
	return $author$project$VegaLite$LecoTitleFontSize(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoTitleFontStyle = function (s) {
	return $author$project$VegaLite$LecoTitleFontStyle(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$LecoTitleFontWeight = function (a) {
	return {$: 59, a: a};
};
var $author$project$VegaLite$lecoTitleFontWeight = $author$project$VegaLite$LecoTitleFontWeight;
var $author$project$VegaLite$lecoTitleLimit = function (n) {
	return $author$project$VegaLite$LecoTitleLimit(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoTitleLineHeight = function (n) {
	return $author$project$VegaLite$LecoTitleLineHeight(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$lecoTitleOpacity = function (n) {
	return $author$project$VegaLite$LecoTitleOpacity(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$ConfigTests$paramCfg6 = function () {
	var solid = $author$project$VegaLite$nums(_List_Nil);
	var shortDash = $author$project$VegaLite$nums(
		_List_fromArray(
			[2, 2]));
																												...
																												[
																													...
																													$author$project$VegaLite$ipRange(
																														_List_fromArray(
																															[
																																$author$project$VegaLite$inMin(0),
																																$author$project$VegaLite$inMax(3),
																																$author$project$VegaLite$inStep(1)
																															])))
																												]))),
																									A2(
	...
	var enc = A2(
		...
		$author$project$VegaLite$shape(
			_List_fromArray(
				[
					$author$project$VegaLite$mName('Origin'),
					$author$project$VegaLite$mTitle('This is the title of the\nshape legend')
				])));
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConfigTests$path + 'cars.json', _List_Nil);
	var cfg = A2(
		$elm$core$Basics$composeL,
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coLegend(
				_List_fromArray(
					[
						A2($author$project$VegaLite$lecoNumExpr, 'clipHeight', $author$project$VegaLite$lecoClipHeight),
						A2($author$project$VegaLite$lecoNumExpr, 'columnPadding', $author$project$VegaLite$lecoColumnPadding),
						A2($author$project$VegaLite$lecoNumExpr, 'columns', $author$project$VegaLite$lecoColumns),
						A2($author$project$VegaLite$lecoNumExpr, 'rowPadding', $author$project$VegaLite$lecoRowPadding),
						A2($author$project$VegaLite$lecoStrExpr, 'fillColor', $author$project$VegaLite$lecoFillColor),
						A2($author$project$VegaLite$lecoStrExpr, 'strokeColor', $author$project$VegaLite$lecoStrokeColor),
						A2($author$project$VegaLite$lecoNumsExpr, 'symbolDash', $author$project$VegaLite$lecoSymbolDash),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolDashOffset', $author$project$VegaLite$lecoSymbolDashOffset),
						A2($author$project$VegaLite$lecoStrExpr, 'symbolFillColor', $author$project$VegaLite$lecoSymbolFillColor),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolLimit', $author$project$VegaLite$lecoSymbolLimit),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolOffset', $author$project$VegaLite$lecoSymbolOffset),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolOpacity', $author$project$VegaLite$lecoSymbolOpacity),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolSize', $author$project$VegaLite$lecoSymbolSize),
						A2($author$project$VegaLite$lecoStrExpr, 'symbolStrokeColor', $author$project$VegaLite$lecoSymbolStrokeColor),
						A2($author$project$VegaLite$lecoNumExpr, 'symbolStrokeWidth', $author$project$VegaLite$lecoSymbolStrokeWidth),
						$author$project$VegaLite$lecoTitleAlign(
						$author$project$VegaLite$haExpr('titleAlign')),
						$author$project$VegaLite$lecoTitleAnchor(
						$author$project$VegaLite$anExpr('titleAnchor')),
						$author$project$VegaLite$lecoTitleBaseline(
						$author$project$VegaLite$vaExpr('titleBaseline')),
						A2($author$project$VegaLite$lecoStrExpr, 'titleColor', $author$project$VegaLite$lecoTitleColor),
						A2($author$project$VegaLite$lecoStrExpr, 'titleFont', $author$project$VegaLite$lecoTitleFont),
						A2($author$project$VegaLite$lecoNumExpr, 'titleFontSize', $author$project$VegaLite$lecoTitleFontSize),
						A2($author$project$VegaLite$lecoStrExpr, 'titleFontStyle', $author$project$VegaLite$lecoTitleFontStyle),
						$author$project$VegaLite$lecoTitleFontWeight(
						$author$project$VegaLite$fwExpr('titleFontWeight')),
						A2($author$project$VegaLite$lecoNumExpr, 'titleLimit', $author$project$VegaLite$lecoTitleLimit),
						A2($author$project$VegaLite$lecoNumExpr, 'titleLineHeight', $author$project$VegaLite$lecoTitleLineHeight),
						A2($author$project$VegaLite$lecoNumExpr, 'titleOpacity', $author$project$VegaLite$lecoTitleOpacity),
						A2($author$project$VegaLite$lecoNumExpr, 'titlePadding', $author$project$VegaLite$lecoTitlePadding)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$ConfigTests$titleCfg1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$fwValue = function (w) {
	return (w <= 100) ? $author$project$VegaLite$W100 : ((w <= 200) ? $author$project$VegaLite$W200 : ((w <= 300) ? $author$project$VegaLite$W300 : ((w <= 400) ? $author$project$VegaLite$W400 : ((w <= 500) ? $author$project$VegaLite$W500 : ((w <= 600) ? $author$project$VegaLite$W600 : ((w <= 700) ? $author$project$VegaLite$W700 : ((w <= 800) ? $author$project$VegaLite$W800 : $author$project$VegaLite$W900)))))));
};
var $author$project$VegaLite$TiAnchor = function (a) {
	return {$: 0, a: a};
};
var $author$project$VegaLite$tiAnchor = $author$project$VegaLite$TiAnchor;
...
var $author$project$VegaLite$tiSubtitleFontWeight = $author$project$VegaLite$TiSubtitleFontWeight;
...
var $author$project$ConfigTests$titleCfg2 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$tiSubtitle('A subtitle\nalso over two lines'),
						$author$project$VegaLite$tiAnchor($author$project$VegaLite$anEnd),
						$author$project$VegaLite$tiSubtitleColor('red'),
						$author$project$VegaLite$tiSubtitleFont('serif'),
						$author$project$VegaLite$tiSubtitleFontSize(10),
						$author$project$VegaLite$tiSubtitleFontStyle('italic'),
						$author$project$VegaLite$tiSubtitleFontWeight(
						$author$project$VegaLite$fwValue(900)),
...
var $author$project$VegaLite$ticoSubtitleColor = function (s) {
	return $author$project$VegaLite$TiSubtitleColor(
		$author$project$VegaLite$Str(s));
};
var $author$project$ConfigTests$titleCfg3 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coTitle(
				_List_fromArray(
					[
						$author$project$VegaLite$ticoAnchor($author$project$VegaLite$anEnd),
						$author$project$VegaLite$ticoSubtitleColor('red'),
						$author$project$VegaLite$ticoSubtitleFont('serif'),
						$author$project$VegaLite$ticoSubtitleFontSize(10),
						$author$project$VegaLite$ticoSubtitleFontStyle('italic'),
						$author$project$VegaLite$ticoSubtitleFontWeight(
						$author$project$VegaLite$fwValue(900)),
...
var $author$project$VegaLite$caRound = $author$project$VegaLite$CRound;
...
var $author$project$VegaLite$joBevel = $author$project$VegaLite$JBevel;
...
var $author$project$VegaLite$VBackground = function (a) {
	return {$: 0, a: a};
};
var $author$project$VegaLite$vicoBackground = $author$project$VegaLite$VBackground;
var $author$project$VegaLite$VLViewBackground = 34;
var $author$project$VegaLite$viewBackground = function (vbs) {
	return _Utils_Tuple2(
		34,
		$elm$json$Json$Encode$object(
			A2($elm$core$List$concatMap, $author$project$VegaLite$viewBackgroundProperty, vbs)));
};
var $author$project$VegaLite$VBCornerRadius = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$viewCornerRadius = function (n) {
	return $author$project$VegaLite$VBCornerRadius(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$viewFill = function (ms) {
	if (!ms.$) {
		...
		return $author$project$VegaLite$VBFill($author$project$VegaLite$NoStr);
	}
};
...
var $author$project$VegaLite$viewStroke = function (ms) {
	if (!ms.$) {
		...
		return $author$project$VegaLite$VBStroke($author$project$VegaLite$NoStr);
	}
};
...
var $author$project$VegaLite$viewStrokeDash = function (ns) {
	return $author$project$VegaLite$VBStrokeDash(
		$author$project$VegaLite$Nums(ns));
};
...
var $author$project$VegaLite$viewStrokeWidth = function (n) {
	return $author$project$VegaLite$VBStrokeWidth(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$VBStyle = function (a) {
	return {$: 0, a: a};
};
var $author$project$VegaLite$viewStyle = function (ss) {
	return $author$project$VegaLite$VBStyle(
		$author$project$VegaLite$Strs(ss));
};
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coView(
				_List_fromArray(
					[
						$author$project$VegaLite$vicoBackground(
						_List_fromArray(
							[
...
var $author$project$ConfigTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('default', $author$project$ConfigTests$defaultCfg),
		...
		_Utils_Tuple2('axisCfg2', $author$project$ConfigTests$axisCfg2),
		_Utils_Tuple2('axisCfg3', $author$project$ConfigTests$axisCfg3),
		_Utils_Tuple2('axisCfg4', $author$project$ConfigTests$axisCfg4),
		_Utils_Tuple2('axisCfg5', $author$project$ConfigTests$axisCfg5),
		_Utils_Tuple2('axisCfg6', $author$project$ConfigTests$axisCfg6),
		_Utils_Tuple2('axisCfg7', $author$project$ConfigTests$axisCfg7),
		_Utils_Tuple2('axisCfg8', $author$project$ConfigTests$axisCfg8),
		_Utils_Tuple2('axisCfg9', $author$project$ConfigTests$axisCfg9),
		_Utils_Tuple2('axisCfg10', $author$project$ConfigTests$axisCfg10),
		_Utils_Tuple2('axisCfg11', $author$project$ConfigTests$axisCfg11),
		_Utils_Tuple2('axisCfg12', $author$project$ConfigTests$axisCfg12),
		_Utils_Tuple2('axisCfg13', $author$project$ConfigTests$axisCfg13),
		...
		_Utils_Tuple2('paramCfg4', $author$project$ConfigTests$paramCfg4),
		...
		_Utils_Tuple2('barCfg1', $author$project$ConfigTests$barCfg1)
	]);
...
var $author$project$ConfigTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$ConfigTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$ConfigTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$ConfigTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$ConfigTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$ConfigTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$ConfigTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$ConfigTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$ConfigTests$update,
		aA: $author$project$ConfigTests$view
	});
_Platform_export({'ConfigTests':{'init':$author$project$ConfigTests$main(
