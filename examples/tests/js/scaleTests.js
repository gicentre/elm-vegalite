...
var $author$project$VegaLite$doMin = function (n) {
	return $author$project$VegaLite$DMinNumber(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$doMax = function (n) {
	return $author$project$VegaLite$DMaxNumber(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$DMaxDateTime = function (a) {
	return {$: 5, a: a};
};
var $author$project$VegaLite$doMaxDt = function (ts) {
	return $author$project$VegaLite$DMaxDateTime(
		$author$project$VegaLite$Timestamp(ts));
};
...
var $author$project$VegaLite$raMin = function (n) {
...
var $author$project$VegaLite$raMax = function (n) {
...
var $author$project$VegaLite$doNumExpr = F2(
	function (ex, fn) {
		var _v0 = fn(0);
		switch (_v0.$) {
			case 3:
...
var $author$project$VegaLite$IPDate = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$ipDate = $author$project$VegaLite$IPDate;
...
var $author$project$VegaLite$RExprs = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$raExprs = function (ss) {
	return $author$project$VegaLite$RExprs(ss);
};
var $author$project$VegaLite$raNumExpr = F2(
	function (ex, fn) {
		var _v0 = fn(0);
		switch (_v0.$) {
			case 6:
...
var $author$project$VegaLite$StrsExpr = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$ScaleTests$scaleInteractive = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
						...
						_List_fromArray(
							[
								...
								$author$project$VegaLite$ipCheckbox(
									_List_fromArray(
										[
											$author$project$VegaLite$inName('reverse colours')
										])))
							]))),
				A2(
					$author$project$VegaLite$param,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$VegaLite$scDomain(
											A2($author$project$VegaLite$doNumExpr, 'xDomainMin', $author$project$VegaLite$doMin)),
											$author$project$VegaLite$scRange(
											$author$project$VegaLite$raExprs(
												_List_fromArray(
													['xRangeMin', 'xRangeMax']))),
											A2($author$project$VegaLite$scNumExpr, 'pad', $author$project$VegaLite$scPadding),
											$author$project$VegaLite$scNice(
											$author$project$VegaLite$niExpr('nice'))
										]))
								]))),
					A2(
						$author$project$VegaLite$position,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$VegaLite$scDomain(
										A2($author$project$VegaLite$doNumExpr, 'yDomainMax', $author$project$VegaLite$doMax)),
										$author$project$VegaLite$scRange(
										A2($author$project$VegaLite$raNumExpr, 'yRangeMax', $author$project$VegaLite$raMax)),
										A2($author$project$VegaLite$scBooExpr, 'zeroOrigin', $author$project$VegaLite$scZero),
										A2($author$project$VegaLite$scNumExpr, 'pad', $author$project$VegaLite$scPadding),
										$author$project$VegaLite$scNice(
										$author$project$VegaLite$niExpr('nice'))
									]))
						...
						[
							...
							_List_fromArray(
								[
									...
									A2($author$project$VegaLite$scBooExpr, 'rev', $author$project$VegaLite$scReverse)
								]))
						]))),
			$author$project$VegaLite$shape(
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$scDomainExpr('shapeB ? [\'a\',\'b\'] : [\'a\']')
							]))
					]))),
		$author$project$VegaLite$size(
			_List_fromArray(
				[
					$author$project$VegaLite$mName('date'),
					$author$project$VegaLite$mTemporal,
					$author$project$VegaLite$mScale(
					_List_fromArray(
						[
							$author$project$VegaLite$scDomain(
							$author$project$VegaLite$doDtsExpr('[datetime(minDate),datetime(maxDate)]'))
						]))
				])));
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($author$project$VegaLite$scBooExpr, 'clamp', $author$project$VegaLite$scClamp)
							]))
					]))),
		A2(
			$author$project$VegaLite$position,
...
var $author$project$ScaleTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('scaleInteractive', $author$project$ScaleTests$scaleInteractive)
	]);
