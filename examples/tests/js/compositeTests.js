...
var $author$project$CompositeTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maExtent(ext)
					])),
				enc(_List_Nil)
			]));
};
...
var $author$project$CompositeTests$boxplot1 = $author$project$CompositeTests$bPlot($author$project$VegaLite$exRange);
...
var $author$project$VegaLite$maBox = $author$project$VegaLite$MBox;
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$VegaLite$exIqrScale(0.5)),
						$author$project$VegaLite$maBox(
						_List_fromArray(
							[
								$author$project$VegaLite$maColor('firebrick')
							])),
						$author$project$VegaLite$maOutliers(
						_List_fromArray(
							[
						...
						$author$project$VegaLite$maMedian(
						_List_fromArray(
							[
								$author$project$VegaLite$maSize(18),
								$author$project$VegaLite$maFill('black'),
								$author$project$VegaLite$maStrokeWidth(0)
							])),
						$author$project$VegaLite$maRule(
						_List_fromArray(
							[
								$author$project$VegaLite$maStrokeWidth(0.4)
							])),
						$author$project$VegaLite$maTicks(
						_List_fromArray(
							[
			...
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maExtent(
						$author$project$VegaLite$exIqrScale(0.5)),
						$author$project$VegaLite$maBox(_List_Nil),
						$author$project$VegaLite$maOutliers(_List_Nil),
						$author$project$VegaLite$maMedian(_List_Nil),
						$author$project$VegaLite$maRule(_List_Nil),
						$author$project$VegaLite$maTicks(_List_Nil)
					])),
				enc(_List_Nil)
			]));
}();
var $author$project$VegaLite$Errorband = 4;
var $author$project$VegaLite$errorband = $author$project$VegaLite$mark(4);
var $author$project$VegaLite$ExCI = {$: 0};
var $author$project$VegaLite$exCi = $author$project$VegaLite$ExCI;
var $author$project$VegaLite$ExIqr = {$: 3};
var $author$project$VegaLite$exIqr = $author$project$VegaLite$ExIqr;
var $author$project$VegaLite$ExStderr = {$: 1};
var $author$project$VegaLite$exStderr = $author$project$VegaLite$ExStderr;
var $author$project$VegaLite$ExStdev = {$: 2};
var $author$project$VegaLite$exStdev = $author$project$VegaLite$ExStdev;
var $author$project$VegaLite$MBorders = function (a) {
	return {$: 7, a: a};
};
...
var $author$project$CompositeTests$eBand = function (ext) {
	var summary = function () {
		switch (ext) {
			case 'ci':
				return $author$project$VegaLite$exCi;
			case 'stdev':
				return $author$project$VegaLite$exStdev;
			case 'stderr':
				return $author$project$VegaLite$exStderr;
			case 'range':
				return $author$project$VegaLite$exRange;
			default:
				return $author$project$VegaLite$exIqr;
		}
	}();
	var label = function () {
		switch (ext) {
...
var $author$project$CompositeTests$errorband1 = $author$project$CompositeTests$eBand('ci');
var $author$project$CompositeTests$errorband2 = $author$project$CompositeTests$eBand('stdev');
var $author$project$VegaLite$Errorbar = 5;
var $author$project$VegaLite$errorbar = $author$project$VegaLite$mark(5);
...
var $author$project$CompositeTests$errorbar1 = $author$project$CompositeTests$eBar($author$project$VegaLite$exCi);
var $author$project$CompositeTests$errorbar2 = $author$project$CompositeTests$eBar($author$project$VegaLite$exStdev);
...
var $author$project$CompositeTests$errorbar3 = function () {
	var encPoints = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var encErrorBars = A2(
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					$author$project$VegaLite$mStr('#4682b4')
				])));
...
var $author$project$CompositeTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('boxplot1', $author$project$CompositeTests$boxplot1),
		_Utils_Tuple2('boxplot2', $author$project$CompositeTests$boxplot2),
		_Utils_Tuple2('boxplot3', $author$project$CompositeTests$boxplot3),
		_Utils_Tuple2('boxplot4', $author$project$CompositeTests$boxplot4),
		_Utils_Tuple2('errorband1', $author$project$CompositeTests$errorband1),
...
var $author$project$CompositeTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$CompositeTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$CompositeTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$CompositeTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$CompositeTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$CompositeTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$CompositeTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$CompositeTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$CompositeTests$update,
		aA: $author$project$CompositeTests$view
	});
_Platform_export({'CompositeTests':{'init':$author$project$CompositeTests$main(
