...
var $author$project$TooltipTests$tooltip1 = function () {
	var enc = A2(
...
var $author$project$TooltipTests$tooltip2 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			_List_fromArray(
				[
					...
					$author$project$VegaLite$ipCheckbox(
						_List_fromArray(
							[
								$author$project$VegaLite$inName('Show tooltips')
							])))
				])));
	var enc = A2(
		$elm$core$Basics$composeL,
...
var $author$project$TooltipTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$TooltipTests$tooltip4 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			A2(
				...
				$author$project$VegaLite$text(
					_List_fromArray(
						[
							$author$project$VegaLite$tName('image')
						]))),
			A2(
				$author$project$VegaLite$position,
				1,
				_List_fromArray(
					[
						$author$project$VegaLite$pName('image'),
	...
	var data = A2(
		...
		A2(
			...
			$author$project$VegaLite$strs(
				_List_fromArray(
					[$author$project$TooltipTests$path + 'ffox.png', $author$project$TooltipTests$path + 'gimp.png', $author$project$TooltipTests$path + '7zip.png']))));
	var cfg = A2(
		$elm$core$Basics$composeL,
...
var $author$project$TooltipTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('tooltip1', $author$project$TooltipTests$tooltip1),
		_Utils_Tuple2('tooltip2', $author$project$TooltipTests$tooltip2),
		_Utils_Tuple2('tooltip3', $author$project$TooltipTests$tooltip3),
		_Utils_Tuple2('tooltip4', $author$project$TooltipTests$tooltip4)
	]);
...
var $author$project$TooltipTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$TooltipTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$TooltipTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$TooltipTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$TooltipTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TooltipTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TooltipTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$TooltipTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$TooltipTests$update,
		aA: $author$project$TooltipTests$view
	});
_Platform_export({'TooltipTests':{'init':$author$project$TooltipTests$main(
