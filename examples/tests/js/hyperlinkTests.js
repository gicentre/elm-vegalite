...
var $author$project$HyperlinkTests$hyperlink1 = function () {
	var encLabel = A2(
		...
		$author$project$VegaLite$size(
			_List_fromArray(
				[
					$author$project$VegaLite$mNum(16)
				])));
		...
		A2(
			...
			A2(
				...
				$author$project$VegaLite$size(
					_List_fromArray(
						[
							$author$project$VegaLite$mNum(8000)
						]))),
			$author$project$VegaLite$color(
				_List_fromArray(
					[
	...
	var data = A2(
		...
		A2(
			...
			$author$project$VegaLite$strs(
				_List_fromArray(
					['https://vega.github.io/vega', 'https://vega.github.io/vega-lite']))));
...
var $author$project$HyperlinkTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.2/data/';
...
var $author$project$VegaLite$HCondition = F3(
	function (a, b, c) {
		return {$: 7, a: a, b: b, c: c};
	});
var $author$project$VegaLite$hCondition = $author$project$VegaLite$HCondition;
...
var $author$project$HyperlinkTests$hyperlink3 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		$author$project$VegaLite$hyperlink(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$hCondition,
					$author$project$VegaLite$prTest(
						$author$project$VegaLite$expr('datum[\'IMDB Rating\']*10 > datum[\'Rotten Tomatoes Rating\']')),
					_List_fromArray(
						[
...
var $author$project$HyperlinkTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('hyperlink1', $author$project$HyperlinkTests$hyperlink1),
		_Utils_Tuple2('hyperlink2', $author$project$HyperlinkTests$hyperlink2),
		_Utils_Tuple2('hyperlink3', $author$project$HyperlinkTests$hyperlink3)
	]);
...
var $author$project$HyperlinkTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$HyperlinkTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$HyperlinkTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$HyperlinkTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$HyperlinkTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$HyperlinkTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$HyperlinkTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$HyperlinkTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$HyperlinkTests$update,
		aA: $author$project$HyperlinkTests$view
	});
_Platform_export({'HyperlinkTests':{'init':$author$project$HyperlinkTests$main(
