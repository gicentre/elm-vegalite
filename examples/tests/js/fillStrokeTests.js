...
var $author$project$FillStrokeTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$VegaLite$doStrs = function (ss) {
	return $author$project$VegaLite$DStrings(
		$author$project$VegaLite$Strs(ss));
};
...
var $author$project$VegaLite$ChStrokeDash = 10;
var $author$project$VegaLite$chStrokeDash = 10;
