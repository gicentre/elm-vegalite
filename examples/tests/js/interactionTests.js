...
var $author$project$VegaLite$pNum = function (n) {
	return $author$project$VegaLite$PNumber(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$InteractionTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$VegaLite$DRaw = function (a) {
	return {$: 6, a: a};
};
var $author$project$VegaLite$doRawExpr = $author$project$VegaLite$DRaw;
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$scDomain(
									$author$project$VegaLite$doRawExpr('useCustomX ? [minX, maxX] : null'))
								]))
						]))),
			A2(
				$author$project$VegaLite$position,
