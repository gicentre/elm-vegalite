...
var $author$project$VegaLite$HoursMinutes = {$: 33};
var $author$project$VegaLite$hoursMinutes = $author$project$VegaLite$HoursMinutes;
var $author$project$VegaLite$HoursMinutesSeconds = {$: 34};
...
var $author$project$VegaLite$YearMonthDateHours = {$: 5};
var $author$project$VegaLite$yearMonthDateHours = $author$project$VegaLite$YearMonthDateHours;
var $author$project$TimeTests$parseTime = function (dType) {
	var tu = function () {
		if (!dType) {
			return $author$project$VegaLite$pTimeUnit($author$project$VegaLite$yearMonthDateHours);
		} else {
			return $author$project$VegaLite$pTimeUnit(
				$author$project$VegaLite$utc($author$project$VegaLite$yearMonthDateHours));
		}
	}();
	var timeScale = function () {
		if (!dType) {
			return $author$project$VegaLite$pScale(
				_List_fromArray(
					[
						$author$project$VegaLite$scType($author$project$VegaLite$scTime)
					]));
		} else {
			return $author$project$VegaLite$pScale(
				_List_fromArray(
					[
						$author$project$VegaLite$scType($author$project$VegaLite$scUtc)
					]));
		}
	}();
	var format = function () {
		if (!dType) {
			return $author$project$VegaLite$foDate('%d %b %Y %H:%M');
		} else {
			return $author$project$VegaLite$foUtc('%d %b %Y %H:%M');
		}
	}();
	var enc = A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$axFormat('%d %b %H:%M')
								]))
						]))),
			A2(
				$author$project$VegaLite$position,
		...
		$author$project$VegaLite$size(
			_List_fromArray(
				[
					$author$project$VegaLite$mNum(500)
				])));
	var data = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A2(
				...
				$author$project$VegaLite$strs(
					_List_fromArray(
						['28 Oct 2017 22:00', '28 Oct 2017 23:00', '29 Oct 2017 00:00', '29 Oct 2017 01:00', '29 Oct 2017 02:00', '29 Oct 2017 03:00', '29 Oct 2017 04:00'])))),
		A2(
			$author$project$VegaLite$dataColumn,
			'value',
...
var $author$project$VegaLite$Milliseconds = {$: 39};
...
var $author$project$VegaLite$MinutesSeconds = {$: 36};
...
var $author$project$VegaLite$MonthDateHours = {$: 18};
var $author$project$VegaLite$monthDateHours = $author$project$VegaLite$MonthDateHours;
var $author$project$VegaLite$MonthDateHoursMinutes = {$: 19};
...
var $author$project$TimeTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$TimeTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$TimeTests$NewSource = $elm$core$Basics$identity;
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$TimeTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TimeTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TimeTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$TimeTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$TimeTests$update,
		aA: $author$project$TimeTests$view
	});
_Platform_export({'TimeTests':{'init':$author$project$TimeTests$main(
