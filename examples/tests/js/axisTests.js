...
var $author$project$AxisTests$axis13 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
			...
			A2(
				...
				$author$project$VegaLite$configuration(
					$author$project$VegaLite$coAxis(
						_List_fromArray(
							[
								$author$project$VegaLite$axcoStyle(
								_List_fromArray(
									['tickStyle']))
							])))),
			$author$project$VegaLite$configuration(
...
var $author$project$VegaLite$cAxLabelOffset = F2(
	function (n1, n2) {
		return A2(
			$author$project$VegaLite$CAxLabelOffset,
...
var $author$project$VegaLite$cAxGridDashOffset = F2(
	function (n1, n2) {
		return A2(
			$author$project$VegaLite$CAxGridDashOffset,
			$author$project$VegaLite$Num(n1),
			$author$project$VegaLite$Num(n2));
	});
...
var $author$project$VegaLite$cAxTickDashOffset = F2(
	function (n1, n2) {
		return A2(
			$author$project$VegaLite$CAxTickDashOffset,
			$author$project$VegaLite$Num(n1),
			$author$project$VegaLite$Num(n2));
	});
...
var $author$project$VegaLite$AxTemporalFormats = function (a) {
	return {$: 16, a: a};
};
var $author$project$VegaLite$axTemporalFormats = function (fmts) {
	return $author$project$VegaLite$AxTemporalFormats(
		A2(
			$elm$core$List$map,
			function (_v0) {
				var tu = _v0.a;
				var s = _v0.b;
				return _Utils_Tuple2(tu, s);
			},
			fmts));
};
...
var $author$project$AxisTests$axis16 = function () {
	var temporalSeq = A4($author$project$VegaLite$dataSequenceAs, -11000000, 10000000, 100000, 'time');
	var ps = A2(
		$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$axTemporalFormats(
							_List_fromArray(
								[
									_Utils_Tuple2($author$project$VegaLite$year, '`%Y'),
									_Utils_Tuple2($author$project$VegaLite$hours, 'kl %-H'),
									_Utils_Tuple2($author$project$VegaLite$minutes, '%H:%M')
								]))
						]))
				])));
	return $author$project$VegaLite$toVegaLite(
...
var $author$project$VegaLite$ArExpr = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$arExpr = $author$project$VegaLite$ArExpr;
...
var $author$project$AxisTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$AxisTests$axis17 = function () {
							...
							A2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												$author$project$VegaLite$paValues(aVals1),
												$author$project$VegaLite$paBind(
												$author$project$VegaLite$ipSelect(
													_List_fromArray(
														[
											...
											$author$project$VegaLite$dataObject(
												_List_fromArray(
													[
														_Utils_Tuple2(
														'description',
														$author$project$VegaLite$str('Bar chart bar'))
													])))
										]))),
							A2(
								$author$project$VegaLite$param,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$VegaLite$arExpr('barDesc')
							]))
					]))
			]));
}();
...
var $author$project$AxisTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('axis13', $author$project$AxisTests$axis13),
		...
		_Utils_Tuple2('axis17', $author$project$AxisTests$axis17)
	]);
