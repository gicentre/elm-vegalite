...
var $author$project$VegaLite$AxFormatAsNum = {$: 17};
var $author$project$VegaLite$axFormatAsNum = $author$project$VegaLite$AxFormatAsNum;
var $author$project$VegaLite$AxFormatAsTemporal = {$: 18};
...
var $author$project$TextFormatTests$textFormat2 = function () {
	var trans = A2(
		...
		$author$project$VegaLite$transform,
		$author$project$VegaLite$filter(
			$author$project$VegaLite$fiExpr('year(datum.month) >= \'2016\'')));
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$tiFontWeight = $author$project$VegaLite$TiFontWeight;
...
var $author$project$VegaLite$tiOrient = $author$project$VegaLite$TiOrient;
...
var $author$project$TextFormatTests$title1 = function () {
	var t3 = $author$project$VegaLite$strs(
		_List_fromArray(
			['A Title', 'over', 'three lines']));
	var t2 = $author$project$VegaLite$strs(
		_List_fromArray(
			['Short title']));
	var t1 = $author$project$VegaLite$strs(
		_List_fromArray(
			['This is the visualization title', 'that is split over two lines']));
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$paValues(t1),
					$author$project$VegaLite$paBind(
					$author$project$VegaLite$ipSelect(
						_List_fromArray(
							[
