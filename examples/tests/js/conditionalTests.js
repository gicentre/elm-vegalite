...
var $author$project$ConditionalTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$ConditionalTests$axisCondition1 = function () {
	var enc = A2(
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConditionalTests$path + 'movies.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maOpacity(0.1)
					])),
				enc(_List_Nil)
			]));
}();
...
var $author$project$ConditionalTests$axisCondition2 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$VegaLite$expr('datum.label ==\'4.0\''),
								A2(
									$author$project$VegaLite$cAxLabelFontWeight,
									$author$project$VegaLite$fwBold,
...
var $author$project$VegaLite$seInterval = 1;
var $author$project$ConditionalTests$bindScales1 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
...
var $author$project$ConditionalTests$bindScales2 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
...
var $author$project$VegaLite$MInvalid = function (a) {
	return {$: 50, a: a};
};
var $author$project$VegaLite$ivImputeMark = 0;
var $author$project$VegaLite$maRemoveInvalid = function (b) {
	return b ? $author$project$VegaLite$MInvalid(_List_Nil) : $author$project$VegaLite$MInvalid(
		_List_fromArray(
...
var $author$project$ConditionalTests$markCondition1 = function () {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
				...
				[
					...
					$author$project$VegaLite$prTest(
						A2(
							...
							$author$project$VegaLite$expr('datum[\'IMDB Rating\'] === null'),
							$author$project$VegaLite$expr('datum[\'Rotten Tomatoes Rating\'] === null'))),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$mStr('#0099ee')
						]))
				])));
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ConditionalTests$path + 'movies.json', _List_Nil);
	var cfg = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coMark(
				_List_fromArray(
					[
						$author$project$VegaLite$maRemoveInvalid(false)
					]))));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2(
							$author$project$VegaLite$prTest(
								$author$project$VegaLite$expr('datum.value < 40')),
							_List_fromArray(
								[
									$author$project$VegaLite$mStr('blue')
								])),
							_Utils_Tuple2(
							$author$project$VegaLite$prTest(
								$author$project$VegaLite$expr('datum.value < 50')),
							_List_fromArray(
								[
							...
							_Utils_Tuple2(
							$author$project$VegaLite$prTest(
								$author$project$VegaLite$expr('datum.value < 60')),
							_List_fromArray(
								[
									$author$project$VegaLite$mStr('yellow')
								]))
						]),
					_List_fromArray(
						[
...
var $author$project$VegaLite$OCondition = F3(
	function (a, b, c) {
		return {$: 1, a: a, b: b, c: c};
	});
var $author$project$VegaLite$oCondition = $author$project$VegaLite$OCondition;
var $author$project$VegaLite$ONumber = function (a) {
	return {$: 9, a: a};
};
var $author$project$VegaLite$oNum = function (n) {
	return $author$project$VegaLite$ONumber(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$ConditionalTests$orderCondition1 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
	...
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maStrokeWidth(8)
					]))
			]));
}();
...
var $author$project$VegaLite$seTranslate = function (s) {
	return $author$project$VegaLite$Translate(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$SMFill = function (a) {
	return {$: 0, a: a};
};
var $author$project$VegaLite$smFill = function (s) {
	return $author$project$VegaLite$SMFill(
		$author$project$VegaLite$Str(s));
};
var $author$project$VegaLite$SMFillOpacity = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$smFillOpacity = function (n) {
	return $author$project$VegaLite$SMFillOpacity(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$SMStroke = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$smStroke = function (s) {
	return $author$project$VegaLite$SMStroke(
		$author$project$VegaLite$Str(s));
};
var $author$project$ConditionalTests$selectionCondition1 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$VegaLite$seTranslate('[mousedown[!event.shiftKey], mouseup] > mousemove')
							]))
					]))),
		A2(
			$author$project$VegaLite$param,
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$VegaLite$smFill('#fdbb84'),
									$author$project$VegaLite$smFillOpacity(0.5),
									$author$project$VegaLite$smStroke('#e34a33')
								]))
						]))
				])));
	var enc = A2(
				...
				[
					...
					$author$project$VegaLite$prTest(
						A2(
							...
							$author$project$VegaLite$bParam('alex'),
							$author$project$VegaLite$bParam('morgan'))),
					_List_fromArray(
						[
							$author$project$VegaLite$mAggregate($author$project$VegaLite$opCount)
						]),
...
var $author$project$ConditionalTests$selectionCondition3 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
...
var $author$project$ConditionalTests$selectionCondition4 = function () {
	var ps = A2(
		$elm$core$Basics$composeL,
		$author$project$VegaLite$params,
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$seClear(''),
							$author$project$VegaLite$seOn('[mousedown[!event.shiftKey], mouseup] > mousemove'),
							$author$project$VegaLite$seTranslate('[mousedown[!event.shiftKey], mouseup] > mousemove')
						]))
				])));
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$VegaLite$seClear('mouseup'),
							$author$project$VegaLite$seOn('[mousedown[!event.shiftKey], mouseup] > mousemove'),
							$author$project$VegaLite$seTranslate('[mousedown[!event.shiftKey], mouseup] > mousemove')
						]))
				])));
		...
		$author$project$VegaLite$color(
			_List_fromArray(
				[
					A3(
					$author$project$VegaLite$mCondition,
					$author$project$VegaLite$prParamEmpty('mySelection'),
					_List_fromArray(
						[
							$author$project$VegaLite$mAggregate($author$project$VegaLite$opCount),
							$author$project$VegaLite$mName('*')
...
var $author$project$ConditionalTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('markCondition1', $author$project$ConditionalTests$markCondition1),
		_Utils_Tuple2('markCondition2', $author$project$ConditionalTests$markCondition2),
		_Utils_Tuple2('axisCondition1', $author$project$ConditionalTests$axisCondition1),
		_Utils_Tuple2('axisCondition2', $author$project$ConditionalTests$axisCondition2),
		_Utils_Tuple2('axisCondition3', $author$project$ConditionalTests$axisCondition3),
		_Utils_Tuple2('selectionCondition1', $author$project$ConditionalTests$selectionCondition1),
		_Utils_Tuple2('selectionCondition2', $author$project$ConditionalTests$selectionCondition2),
		_Utils_Tuple2('selectionCondition3', $author$project$ConditionalTests$selectionCondition3),
		_Utils_Tuple2('selectionCondition4', $author$project$ConditionalTests$selectionCondition4),
		_Utils_Tuple2('selectionCondition5', $author$project$ConditionalTests$selectionCondition5),
...
var $author$project$ConditionalTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$ConditionalTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$ConditionalTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$ConditionalTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$ConditionalTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$ConditionalTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$ConditionalTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$ConditionalTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$ConditionalTests$update,
		aA: $author$project$ConditionalTests$view
	});
_Platform_export({'ConditionalTests':{'init':$author$project$ConditionalTests$main(
