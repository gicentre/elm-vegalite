...
var $author$project$VegaLite$hStr = function (s) {
	return $author$project$VegaLite$HString(
...
var $author$project$ImageTests$lakeImage = function (mProps) {
	var enc = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var encImage = A2(
		...
		$author$project$VegaLite$url(
			_List_fromArray(
				[
					$author$project$VegaLite$hStr('https://gicentre.github.io/data/images/LillyTarn.jpg')
				])));
	var data = A2(
		$elm$core$Basics$composeL,
		A2(
...
var $author$project$VegaLite$maAspect = function (b) {
	return $author$project$VegaLite$MAspect(
		...
		switch (_v0.$) {
			...
			case 31:
				return $author$project$VegaLite$MFilled(
					$author$project$VegaLite$BooExpr(ex));
			case 45:
				return $author$project$VegaLite$MOrder(
					$author$project$VegaLite$BooExpr(ex));
			case 50:
				return $author$project$VegaLite$MRemoveInvalid(
					$author$project$VegaLite$BooExpr(ex));
			case 53:
				return $author$project$VegaLite$MShortTimeLabels(
					$author$project$VegaLite$BooExpr(ex));
			case 89:
				return $author$project$VegaLite$MAspect(
					$author$project$VegaLite$BooExpr(ex));
...
var $author$project$ImageTests$image11 = function () {
	var prm = A2(
		$elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$author$project$VegaLite$ipCheckbox(
						_List_fromArray(
							[
								$author$project$VegaLite$inName('maintain aspect ratio')
							])))
				])));
	var enc = A2(
		$elm$core$Basics$composeL,
...
var $author$project$VegaLite$hName = function (s) {
	return $author$project$VegaLite$HName(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$ImageTests$image13 = A2(
	$author$project$ImageTests$imageEnc,
	A2(
		$elm$core$Basics$composeL,
		A2(
...
var $author$project$VegaLite$MUrl = function (a) {
	return {$: 72, a: a};
};
var $author$project$VegaLite$maUrl = function (s) {
	return $author$project$VegaLite$MUrl(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$ImageTests$image14 = function () {
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$ImageTests$path + 'zipcodes.csv', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$VegaLite$maWidth(4),
						$author$project$VegaLite$maHeight(4),
						$author$project$VegaLite$maUrl($author$project$ImageTests$path + 'ffox.png')
					]))
			]));
}();
...
var $author$project$ImageTests$specs = _List_fromArray(
	[
		_Utils_Tuple2('image1', $author$project$ImageTests$image1),
		_Utils_Tuple2('image2', $author$project$ImageTests$image2),
		_Utils_Tuple2('image3', $author$project$ImageTests$image3),
		_Utils_Tuple2('image4', $author$project$ImageTests$image4),
		_Utils_Tuple2('image5', $author$project$ImageTests$image5),
		_Utils_Tuple2('image6', $author$project$ImageTests$image6),
		...
		_Utils_Tuple2('image13', $author$project$ImageTests$image13),
		_Utils_Tuple2('image14', $author$project$ImageTests$image14)
	]);
...
var $author$project$ImageTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$ImageTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$ImageTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$ImageTests$view = function (spec) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2(
					...
					A2(
						...
						$author$project$ImageTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$ImageTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$ImageTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$ImageTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$ImageTests$update,
		aA: $author$project$ImageTests$view
	});
_Platform_export({'ImageTests':{'init':$author$project$ImageTests$main(
