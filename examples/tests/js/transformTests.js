...
var $author$project$TransformTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$VegaLite$regressionProperty = function (regProp) {
	switch (regProp.$) {
		...
		case 2:
			var x = regProp.a;
			return A2($author$project$VegaLite$numExpr, 'order', x);
		case 3:
			var xs = regProp.a;
			return A2($author$project$VegaLite$numsExpr, 'extent', xs);
		case 4:
			var b = regProp.a;
			return A2($author$project$VegaLite$booExpr, 'params', b);
		default:
			...
			_Utils_Tuple2(
				...
				$elm$json$Json$Encode$object(
					_Utils_ap(
						...
						A2($elm$core$List$concatMap, $author$project$VegaLite$regressionProperty, rgProps)))));
	});
var $author$project$VegaLite$Nums = function (a) {
	return {$: 0, a: a};
};
var $author$project$VegaLite$RgExtent = function (a) {
	return {$: 3, a: a};
};
var $author$project$VegaLite$rgExtent = F2(
	function (n1, n2) {
		return $author$project$VegaLite$RgExtent(
...
var $author$project$VegaLite$rgOrder = function (n) {
	return $author$project$VegaLite$RgOrder(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$RgLinear = 0;
var $author$project$VegaLite$rgLinear = 0;
var $author$project$VegaLite$RgParams = function (a) {
	return {$: 4, a: a};
};
var $author$project$VegaLite$rgParams = function (b) {
	return $author$project$VegaLite$RgParams(
		$author$project$VegaLite$Boo(b));
};
...
var $author$project$TransformTests$transform11 = function () {
	var transReg = A2(
		...
		A3(
			...
			_List_fromArray(
				[
					$author$project$VegaLite$rgMethod($author$project$VegaLite$rgLinear)
				])));
	var transCoeff = A2(
		$elm$core$Basics$composeL,
		A2(
			...
			A3(
				...
				_List_fromArray(
					[
						$author$project$VegaLite$rgMethod($author$project$VegaLite$rgLinear),
						$author$project$VegaLite$rgParams(true)
					]))),
		A2($author$project$VegaLite$calculateAs, '\'y = \'+format(datum.coef[0],\'.2f\')+\' + \'+format(datum.coef[1],\'.2f\')+\'x\'+\'   R²: \'+format(datum.rSquared, \'.2f\')', 'coef'));
	var encScatter = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
	...
	var specReg = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				transReg(_List_Nil),
	...
	var specScatter = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				encScatter(_List_Nil),
				$author$project$VegaLite$point(
	...
	var encCoeff = A2(
		...
		$author$project$VegaLite$text(
			_List_fromArray(
				[
					$author$project$VegaLite$tName('coef')
				])));
	var specCoeff = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				transCoeff(_List_Nil),
				encCoeff(_List_Nil),
				$author$project$VegaLite$textMark(
				_List_fromArray(
					[
						$author$project$VegaLite$maX(4),
						$author$project$VegaLite$maY(4),
...
var $author$project$VegaLite$wiField = function (s) {
	return $author$project$VegaLite$WField(
		$author$project$VegaLite$Str(s));
};
...
var $author$project$VegaLite$wiFrame = F2(
	function (mn1, mn2) {
		var _v0 = _Utils_Tuple2(mn1, mn2);
		if (_v0.a.$ === 1) {
			if (_v0.b.$ === 1) {
				var _v1 = _v0.a;
				var _v2 = _v0.b;
				return A2($author$project$VegaLite$WFrame, $author$project$VegaLite$NoNum, $author$project$VegaLite$NoNum);
			} else {
				var _v3 = _v0.a;
				var n = _v0.b.a;
				return A2(
					$author$project$VegaLite$WFrame,
					$author$project$VegaLite$NoNum,
					$author$project$VegaLite$Num(n));
			}
		} else {
			if (_v0.b.$ === 1) {
...
var $author$project$VegaLite$wiGroupBy = function (ss) {
	return $author$project$VegaLite$WGroupBy(
...
var $author$project$VegaLite$windowFieldProperty = function (w) {
	switch (w.$) {
		...
		case 2:
			var x = w.a;
			return A2($author$project$VegaLite$numExpr, 'param', x);
		default:
			var s = w.a;
			return A2($author$project$VegaLite$strExpr, 'field', s);
	}
...
var $author$project$VegaLite$windowProperty = function (wProp) {
	...
	switch (wProp.$) {
		...
		case 1:
			var b = wProp.a;
			return A2($author$project$VegaLite$booExpr, 'ignorePeers', b);
		case 2:
			var ss = wProp.a;
			return A2($author$project$VegaLite$strsExpr, 'groupby', ss);
		default:
			...
			function (ws, outName) {
				return $elm$json$Json$Encode$object(
					A2(
						...
						A2($elm$core$List$concatMap, $author$project$VegaLite$windowFieldProperty, ws)));
			});
		return $elm$core$List$cons(
			_Utils_Tuple2(
				'multiSpecs',
					...
					A2(
						...
						_Utils_Tuple2(
							...
							A2(
								...
								wss)),
						A2($elm$core$List$concatMap, $author$project$VegaLite$windowProperty, wProps)))));
	});
...
var $author$project$VegaLite$Minutes = {$: 35};
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2(
							$author$project$VegaLite$tuStep,
							5,
							$author$project$VegaLite$utc($author$project$VegaLite$minutes)))
					]))),
		A2(
			$author$project$VegaLite$position,
			1,
...
var $author$project$TransformTests$transform20 = function () {
	var trans = A2(
		$elm$core$Basics$composeL,
		A2(
			$elm$core$Basics$composeL,
...
var $author$project$VegaLite$biStep = function (n) {
	return $author$project$VegaLite$Step(
		$author$project$VegaLite$Num(n));
};
			...
			_Utils_Tuple2(
				...
				$elm$json$Json$Encode$object(
					_Utils_ap(
						...
						A2($elm$core$List$concatMap, $author$project$VegaLite$loessProperty, lsProps)))));
	});
...
var $author$project$VegaLite$qtStep = function (n) {
	return $author$project$VegaLite$QtStep(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$quantileProperty = function (qProp) {
	switch (qProp.$) {
		...
		case 1:
			var xs = qProp.a;
			return A2($author$project$VegaLite$numsExpr, 'probs', xs);
		case 2:
			var x = qProp.a;
			return A2($author$project$VegaLite$numExpr, 'step', x);
		default:
				...
				$elm$json$Json$Encode$object(
					A2(
						...
						_Utils_Tuple2(
							'quantile',
							$elm$json$Json$Encode$string(field)),
						A2($elm$core$List$concatMap, $author$project$VegaLite$quantileProperty, qProps)))));
	});
...
var $author$project$TransformTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2('transform20', $author$project$TransformTests$transform20)
	]);
...
var $author$project$TransformTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$TransformTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$TransformTests$NewSource = $elm$core$Basics$identity;
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$TransformTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$TransformTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$TransformTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$TransformTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$TransformTests$update,
