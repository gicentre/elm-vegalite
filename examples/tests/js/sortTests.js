...
var $author$project$SortTests$path = 'https://cdn.jsdelivr.net/npm/vega-datasets@2.3/data/';
...
var $author$project$SortTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$SortTests$main = $elm$browser$Browser$element(
	{
		...
		az: $author$project$SortTests$update,
		aA: $author$project$SortTests$view
	});
