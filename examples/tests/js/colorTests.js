...
var $author$project$VegaLite$grX1 = function (n) {
	return $author$project$VegaLite$GrX1(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$GrX2 = function (a) {
	return {$: 2, a: a};
};
var $author$project$VegaLite$grX2 = function (n) {
	return $author$project$VegaLite$GrX2(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$GrY1 = function (a) {
	return {$: 1, a: a};
};
var $author$project$VegaLite$grY1 = function (n) {
	return $author$project$VegaLite$GrY1(
		$author$project$VegaLite$Num(n));
};
var $author$project$VegaLite$GrY2 = function (a) {
	return {$: 3, a: a};
};
var $author$project$VegaLite$grY2 = function (n) {
	return $author$project$VegaLite$GrY2(
		$author$project$VegaLite$Num(n));
};
...
var $author$project$VegaLite$ScSymLog = 4;
var $author$project$VegaLite$scSymLog = 4;
...
var $author$project$ColorTests$NewSource = $elm$core$Basics$identity;
...
var $author$project$ColorTests$main = $elm$browser$Browser$element(
	{
		...
		az: $author$project$ColorTests$update,
		aA: $author$project$ColorTests$view
	});
