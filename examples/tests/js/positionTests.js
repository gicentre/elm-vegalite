...
var $author$project$PositionTests$position14 = function () {
	...
	var data2 = A2($author$project$VegaLite$dataFromUrl, $author$project$PositionTests$path + 'cars.json', _List_Nil);
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
...
var $author$project$PositionTests$specs = _List_fromArray(
	[
...
var $author$project$PositionTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$PositionTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$PositionTests$NewSource = $elm$core$Basics$identity;
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$PositionTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$PositionTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$PositionTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$PositionTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$PositionTests$update,
		aA: $author$project$PositionTests$view
	});
