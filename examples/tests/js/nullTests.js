...
var $author$project$NullTests$filter1 = function () {
	...
	var data = A2($author$project$VegaLite$dataFromUrl, $author$project$NullTests$path + 'movies.json', _List_Nil);
	var cfg = A2(
		$elm$core$Basics$composeL,
...
var $author$project$NullTests$invalidModes = function (markProps) {
	...
	var quantSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'Quantitative X', _List_Nil),
	...
	var spec8 = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				$author$project$VegaLite$width(100),
				$author$project$VegaLite$height(100),
	...
	var ordSpec = $author$project$VegaLite$asSpec(
		_List_fromArray(
			[
				A2($author$project$VegaLite$title, 'Ordinal X', _List_Nil),
				$author$project$VegaLite$hConcat(
				_List_fromArray(
							...
							A2(
								...
								A2(
									...
									$author$project$VegaLite$dataRow(
										_List_fromArray(
											[
												_Utils_Tuple2('a', $author$project$VegaLite$nullValue),
												_Utils_Tuple2(
												'b',
								...
								$author$project$VegaLite$dataRow(
									_List_fromArray(
										[
											...
											_Utils_Tuple2('b', $author$project$VegaLite$nullValue)
										]))),
							$author$project$VegaLite$dataRow(
								_List_fromArray(
									[
	...
	var cfg = A2(
		...
		$author$project$VegaLite$configure,
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coMark(markProps)));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				cfg(_List_Nil),
...
var $author$project$NullTests$specs = _List_fromArray(
	[
		...
		_Utils_Tuple2(
		'modes1',
		$author$project$NullTests$invalidModes(
			_List_fromArray(
				[
					$author$project$VegaLite$maInvalid(_List_Nil)
				]))),
		...
		$author$project$NullTests$invalidModes(
			_List_fromArray(
				[
					$author$project$VegaLite$maInvalid(
					_List_fromArray(
						[$author$project$VegaLite$ivBreakPaths]))
				]))),
		_Utils_Tuple2(
		'modes4',
		$author$project$NullTests$invalidModes(
			_List_fromArray(
				[
					$author$project$VegaLite$maInvalid(
					_List_fromArray(
						[$author$project$VegaLite$ivImputeDomain, $author$project$VegaLite$ivImputePathDomain, $author$project$VegaLite$ivBreakPaths]))
				]))),
		_Utils_Tuple2(
		'modes5',
		$author$project$NullTests$invalidModes(
...
var $author$project$NullTests$update = F2(
	function (msg, _v0) {
		var srcName = msg;
		return _Utils_Tuple2(
			A2(
				...
				A2(
					$elm$core$Dict$get,
					srcName,
					$elm$core$Dict$fromList($author$project$NullTests$specs))),
			$elm$core$Platform$Cmd$none);
	});
var $author$project$NullTests$NewSource = $elm$core$Basics$identity;
			...
			[
				...
				A2(
					...
					A2(
						...
						$author$project$NullTests$specs))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
...
var $author$project$NullTests$main = $elm$browser$Browser$element(
	{
		ar: $elm$core$Basics$always(
			_Utils_Tuple2(
				$elm$json$Json$Encode$null,
				$author$project$NullTests$elmToJS(
					$author$project$VegaLite$combineSpecs($author$project$NullTests$specs)))),
		ax: $elm$core$Basics$always($elm$core$Platform$Sub$none),
		az: $author$project$NullTests$update,
		aA: $author$project$NullTests$view
	});
