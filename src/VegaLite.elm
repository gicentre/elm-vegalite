...
type ScaleProperty
    ...
    | SDomainExpr String
    | SRange ScaleRange
    | SScheme Strs (List Float)
    | SSchemeExpr Strs (List Float)
    | SAlign Num
    | SPadding Num
    | SPaddingInner Num
    | SPaddingOuter Num
...
{-| Default x-position of legend group in pixel units for absolute positioning when
...
{-| Default y-position of legend group in pixel units for absolute positioning when
[leOrient](#leOrient) is set to `loNone`.
-}
...
{-| Default set of symbols for shape encoding.
-}
...
sacoNumExpr ex fn =
    case fn 0 of
        ...
        SCContinuousPadding _ ->
            SCContinuousPadding (NumExpr ex)
