...
[fiGreaterThanEq](#fiGreaterThanEq), [fiParam](#fiParam), [fiExpr](#fiExpr),
[fiCompose](#fiCompose), [fiSelection](#fiSelection), [fiOneOf](#fiOneOf),
[fiRange](#fiRange) and [fiValid](#fiValid).
-}
type Filter
...
{-| Generated by [paBind](#paBind), [paBindLegend](#paBindLegend),
[paBindScales](#paBindScales), [paExpr](#paExpr), [paValue](#paValue) and
[paSelect](#paSelect).
-}
type ParamProperty
    = PBind PBinding
...
{-| Filter a data stream in response to the value of a parameter. Useful for
creating interactive filtering using a selection parameter.
-}
fiParam : String -> Filter
fiParam =
    FParam
...
{-| Deprecated in favour of [fiParam](#fiParam).
-}
