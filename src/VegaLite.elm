...
[prDistance](#prDistance), [prFraction](#prFraction), [prLobes](#prLobes), [prReflectX](#prReflectX),
[prReflectY](#prReflectY), [prParallel](#prParallel), [prPointRadius](#prPointRadius),
[prRadius](#prRadius), [prRatio](#prRatio), [prSpacing](#prSpacing) and [prTilt](#prTilt).
-}
...
{-| Expression that evaluates to two coordinate pairs representing [ [left,top],
[bottom,right] ] of a clipping rectangle in pixel coordinates.
-}
clipRectExpr : String -> ClipRect
clipRectExpr s =
    ClipRectExpr s
    ...
    case pp of
        ...
        PrClipExtent rClip ->
            case rClip of
                ...
                ClipRectExpr s ->
                    [ ( "clipExtent", JE.object [ ( "expr", JE.string s ) ] ) ]
        ...
        PrCenter lamda phi ->
            [ ( "center", toList [ numSpec lamda, numSpec phi ] ) ]
