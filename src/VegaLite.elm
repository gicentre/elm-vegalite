...
[num](#num), [str](#str), [dataExpr](#dataExpr), [dataValues](#dataValues),
...
{-| Represent a list of data values as a single data value. For example,

    param "location" [ paValue (dataValues (nums [ 4000, 8000 ])) ]
