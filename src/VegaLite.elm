...
[coGeoshape](#coGeoshape), [coFacet](#coFacet), [coHeader](#coHeader), [coLegend](#coLegend), [coLine](#coLine),
...
{-| Generated by [facoColumns](#faColumns) and [facoSpacing](#facoSpacing).
-}
type FacetConfig
    = FColumns Int
    | FSpacing Float
...
[mTitle](#mTitle), [mAggregate](#mAggregate), [mLegend](#mLegend), [mSort](#mSort),
...
[scExponent](#scExponent), [scConstant](#scConstant), [scBase](#scBase),
[scZero](#scZero) and [scReverse](#scReverse).
-}
type ScaleProperty
    = SType Scale
    | SDomain ScaleDomain
...
[`columns`](#columns), [`hConcat`](#hConcat), [`vConcat`](#vConcat), [`spec`](#spec)
and [`resolve`](#resolve).
...
[`viewBackground`](#viewBackground), and [`configure`](#configure).
...
{-| Specifications to be juxtaposed in a flow layout of views.
-}
...
commonly built by chaining series of `LabelledSpec` generating functions together.
For example,
...
{-| Configuration option for the spacing in pixels between sub-views in a view
composition, such as a faceted or concatenated view.
-}
...
{-| Sort order for a field when encoding with a faceted channel. For example,
...
{-| Imputation rules for a mark channel. See the
[Vega-Lite impute documentation](https://vega.github.io/vega-lite/docs/impute.html)
-}
...
[scBase](#scBase) to some other value.
-}
scLog : Scale
scLog =
    ScLog
...
{-| Sort by another channel. For example,
...
{-| Specifications to be juxtaposed vertically in a row layout of views.
-}
