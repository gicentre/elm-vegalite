...
{-| Generated by [hdFormat](#hdFormat),[hdLabelAlign](#hdLabelAlign),
...
[prLobes](#prLobes), [prReflectX](#prReflectX), [prReflectY](#prReflectY),
[prParallel](#prParallel), [prRadius](#prRadius), [prRatio](#prRatio),
...
{-| Reference in a position chanel to a field name generated by [repeatFlow](#repeatFlow)
or [repeat](#repeat). The parameter identifies whether reference is being made to
fields that are to be arranged in columns, in rows or a with a flow layout.
