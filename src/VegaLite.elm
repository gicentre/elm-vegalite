...
{-| Dafault number of pixels before the first axis baseline (domain) line dash is drawn.
-}
...
{-| Dafault number of pixels before the first axis grid line dash is drawn.
-}
...
{-| Dafault number of pixels before the first axis tick dash is drawn.
-}
...
scaleProperty scaleProp =
    case scaleProp of
        ...
        SDomain sdType ->
            case sdType of
                DMinNumber n ->
                    ( "domainMin", scaleDomainSpec sdType )

                DMidNumber n ->
                    ( "domainMid", scaleDomainSpec sdType )

                DMaxNumber n ->
                    ( "domainMax", scaleDomainSpec sdType )
