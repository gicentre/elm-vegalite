...
[axcoGridDash](#axcoGridDash), [axcoGridOpacity](#axcoGridOpacity), [axcoGridWidth](#axcoGridWidth),
...
[axTitleX](#axTitleX), [axTitleY](#axTitleY), [axGrid](#axGrid), [axGridCap](#axGridCap),
...
{-| Generated by [date](#date), [day](#day), [dayHours](#dayHours), [dayHoursMinutes](#dayHoursMinutes),
[dayHoursMinutesSeconds](#dayHoursMinutesSeconds), [hours](#hours), [hoursMinutes](#hoursMinutes),
...
[monthDateHoursMinutes](#monthDateHoursMinutes), [monthDateHoursMinutesSeconds](#monthDateHoursMinutesSeconds),
...
any temporal sequence into a maximnum of 7 bins.
-}
day : TimeUnit
day =
    Day
...
therefore discretize any temporal sequence into a maximnum of 7\*24 bins.
-}
dayHours : TimeUnit
dayHours =
    DayHours
...
therefore discretize any temporal sequence into a maximnum of 7\_24\_60 bins.
-}
...
therefore discretize any temporal sequence into a maximnum of 7\_24\_60\*60 bins.
-}
...
axisConfigProperty axisCfg =
    case axisCfg of
        ...
        DomainCap c ->
            [ ( "domainCap", JE.string (strokeCapLabel c) ) ]
        ...
        GridCap c ->
            [ ( "gridCap", JE.string (strokeCapLabel c) ) ]
