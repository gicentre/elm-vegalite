...
{-| Generated by [paBind](#paBind), [paDescription](#paDescription), [paExpr](#paExpr)
and [paValue](#paValue).
-}
type ParamProperty
    = PBind PBinding
...
{-| Provide a [Vega expression](https://vega.github.io/vega/docs/expressions/) to
an legend property function requring a numeric value. This can be used to provide an
...
{-| Provide a [Vega expression](https://vega.github.io/vega/docs/expressions/) to
an legend property function requring a string value. This can be used to provide an
interactive parameterisation of a legend property when an expression is bound to an
input element. For example,
...
{-| Provide a [Vega expression](https://vega.github.io/vega/docs/expressions/) to
a mark property function requring a boolean value. This can be used to provide an
...
-}
markPropertyBooExpr : String -> (Bool -> MarkProperty) -> MarkProperty
markPropertyBooExpr ex fn =
    case fn True of
        MClip _ ->
            MClip (BooExpr ex)
...
{-| Provide a [Vega expression](https://vega.github.io/vega/docs/expressions/) to
a mark property function requring a string value. This can be used to provide an
interactive parameterisation of a mark property by providing an expression bound
to an input element. For example,
...
{-| The dynmaic binding associated with a top-level parameter. Can be used to create
...
{-| Description of a parameter, helpful for documenting JSON source inline.
-}
paDescription : String -> ParamProperty
paDescription =
    PDescription
