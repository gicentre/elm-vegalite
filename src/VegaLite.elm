...
{-| Generated by [axcoBandPosition](#axcoBandPosition), [axcoDisable](#axcoDisable),
[axcoDomain](#axcoDomain), [axcoDomainColor](#axcoDomainColor), [axcoDomainOpacity](#axcoDomainOpacity),
...
[oBin](#oBin), [oAggregate](#oAggregate), [oTimeUnit](#oTimeUnit) and [oSort](#oSort).
-}
type OrderChannel
    = OName String
    | ORepeat Arrangement
...
should be included for marks and guides when generating SVGoutput. If not specified,
the default is `True`.
-}
