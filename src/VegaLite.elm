...
{-| Generated by [arAria](#arAria) and [arDescription](#arDescription).
-}
type Aria
    = ArAria Bool
      -- TODO: Expose role/roleDesciription if/when it is confirmed in the Vega-Lite spec.
      -- | AriaRole String
      -- | AriaRoleDescription
...
[axDataCondition](#axDataCondition), [axDomain](#axDomain), [axDomainColor](#axDomainColor),
...
should be included when generating SVG output. If not specified, the default is `True`.
-}
arAria : Bool -> Aria
arAria =
    ArAria
