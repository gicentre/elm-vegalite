...
{-| A list of named styles to apply to the view background. Each named style can
be specified via [coNamedStyle](#coNamedStyle). Later styles in the list will
override earlier styles if there is a conflict.
-}
vicoStyle : List String -> ViewConfig
vicoStyle =
    VStyle
