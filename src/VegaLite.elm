...
type TitleConfig
    ...
    | TicoFontSize Num
    | TicoFontStyle Str
    | TicoFontWeight FontWeight
    | TicoFrame TitleFrame
    | TicoLineHeight Num
    | TicoLimit Num
    | TicoOffset Num
    | TicoOrient Side
    | TicoStyle (List String)
    | TicoSubtitle Str
    | TicoSubtitleColor Str
    | TicoSubtitleFont Str
    | TicoSubtitleFontSize Num
    | TicoSubtitleFontStyle Str
    | TicoSubtitleFontWeight FontWeight
    | TicoSubtitleLineHeight Num
    | TicoSubtitlePadding Num
    | TicoZIndex Num
...
categoricalDomainMap scaleDomainPairs =
    ...
    in
    [ ScDomain (DStrings domain), ScRange (RStrings (Strs range)) ]
...
tiNumExpr ex fn =
    case fn 0 of
        ...
        TicoFontSize _ ->
            TicoFontSize (NumExpr ex)

        TicoLineHeight _ ->
            TicoLineHeight (NumExpr ex)

        TicoLimit _ ->
            TicoLimit (NumExpr ex)

        TicoOffset _ ->
            TicoOffset (NumExpr ex)

        TicoSubtitleFontSize _ ->
            TicoSubtitleFontSize (NumExpr ex)

        TicoSubtitleLineHeight _ ->
            TicoSubtitleLineHeight (NumExpr ex)

        TicoSubtitlePadding _ ->
            TicoSubtitlePadding (NumExpr ex)

        TicoZIndex _ ->
            TicoZIndex (NumExpr ex)
...
tiStrExpr ex fn =
    case fn "" of
        TicoColor _ ->
            TicoColor (StrExpr ex)

        TicoFont _ ->
            TicoFont (StrExpr ex)

        TicoFontStyle _ ->
            TicoFontStyle (StrExpr ex)

        TicoSubtitle _ ->
            TicoSubtitle (StrExpr ex)

        TicoSubtitleColor _ ->
            TicoSubtitleColor (StrExpr ex)

        TicoSubtitleFont _ ->
            TicoSubtitleFont (StrExpr ex)

        TicoSubtitleFontStyle _ ->
            TicoSubtitleFontStyle (StrExpr ex)
