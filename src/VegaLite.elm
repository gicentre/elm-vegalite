...
{-| Indicate a data field encoded as a hyperlink property is ordinal.
-}
...
{-| Indicate a data field encoded as a key channel property is nominal. This is
...
{-| Indicate a data field encoded as a position is nominal. This is the
default data type.
-}
...
{-| Indicate a data field encoded as a position is quantitative. This is not necessary
...
{-| Reference in a position channel to a datum value generated by [repeat](#repeat).
-}
...
{-| Indicate a data field encoded as a position is temporal. This is not necessary
