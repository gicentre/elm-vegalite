...
[coAxisStyles](#coAxisStyles), [coAxisXFilter](#coAxisXFilter), [coAxisYFilter](#coAxisYFilter),
...
type HeaderProperty
    ...
    | HTitleFontStyle String
    | HTitleFontWeight FontWeight
    | HTitleLimit Float
    | HTitleLineHeight Float
    | HTitleOrient Side
    | HTitlePadding Float
...
{-| Generated by [lecoClipHeight](#lecoClipHeight),
[lecoColumnPadding](#lecoColumnPadding), [lecoColumns](#lecoColumns),
[lecoCornerRadius](#lecoCornerRadius), [lecoFillColor](#lecoFillColor),
...
type LegendProperty
    ...
    | LTitlePadding Float
    | LType Legend
      -- Pending resolution to https://github.com/vega/vega-lite/issues/5921
      --  | LUnselectedOpacity Float
...
{-| Generated by [mName](#mName), [mDatum](#mDatum), [mRepeat](#mRepeat),
[mRepeatDatum](#mRepeatDatum), [mMType](#mMType), [mScale](#mScale), [mBin](#mBin),
[mBinned](#mBinned) [mTimeUnit](#mTimeUnit), [mTitle](#mTitle), [mAggregate](#mAggregate),
[mLegend](#mLegend), [mSort](#mSort), [mSelectionCondition](#mSelectionCondition),
...
[maBaseline](#maBaseline), [maBinSpacing](#maBinSpacing), [maBlend](#maBlend),
[maBorders](#maBorders), [maBox](#maBox), [maClip](#maClip), [maColor](#maColor),
[maColorGradient](#maColorGradient), [maCornerRadius](#maCornerRadius), [maCornerRadiusEnd](#maCornerRadiusEnd),
...
{-| Generated by [pName](#pName), [pDatum](#pDatum), [pRepeat](#pRepeat), [pMType](#pMType),
[pBin](#PBin), [pBinned](#pBinned), [pTimeUnit](#pTimeUnit), [pTitle](#pTitle),
[pAggregate](#pAggregate), [pScale](#pScale), [pAxis](#pAxis), [pSort](#pSort),
[pBand](#pBand), [pStack](#pStack), [pWidth](#pWidth), [pHeight](#pHeight), [pNum](#pNum)
and [pImpute](#pImpute).
-}
...
[scInterpolate](#scInterpolate), [scNice](#scNice), [scDomainMid](#scDomainMid),
[scExponent](#scExponent), [scConstant](#scConstant), [scBase](#scBase) and
[scZero](#scZero).
-}
type ScaleProperty
    = SType Scale
...
{-| Generated by [raNums](#raNums), [raStrs](#raStrs), [raNumLists](#raNumLists)
and [raName](#raName).
-}
type ScaleRange
    = RNumbers (List Float)
...
[vaAlphabetic](#vaAlphabetic), [vaBottom](#vaBottom) and [vaLineBottom](#vaLineBottom).
-}
type VAlign
    = AlignTop
    | AlignLineTop
...
{-| Indicate a data field encoded as a key channel property stores geofeatures.
...
{-| Defailt opacity of unselected legend items when made interactive via
...
{-| Encode a stroke dash channel. For example,
                ...
                ( ifProp, elseProp ) =
                    case cap of
                        ...
                        CAxLabelOffset o1 o2 ->
                            ( axisProperty (AxLabelOffset o1), axisProperty (AxLabelOffset o2) )
...
configProperty configProp =
    case configProp of
        ...
        Axis axType acs ->
            ( axisLabel axType, JE.object (List.map axisConfigProperty acs) )
        ...
        AxisBand axType acs ->
            ( axisLabel axType ++ "Band", JE.object (List.map axisConfigProperty acs) )

        AxisDiscrete axType acs ->
            ( axisLabel axType ++ "Discrete", JE.object (List.map axisConfigProperty acs) )

        AxisPoint axType acs ->
            ( axisLabel axType ++ "Point", JE.object (List.map axisConfigProperty acs) )

        AxisQuant axType acs ->
            ( axisLabel axType ++ "Quantitative", JE.object (List.map axisConfigProperty acs) )

        AxisTemporal axType acs ->
            ( axisLabel axType ++ "Temporal", JE.object (List.map axisConfigProperty acs) )
...
headerProperty hProp =
    case hProp of
        ...
        HOrient orient ->
            ( "orient", JE.string (sideLabel orient) )
...
legendProperty legendProp =
    case legendProp of
        ...
        -- Pending fixing of https://github.com/vega/vega-lite/issues/5921
