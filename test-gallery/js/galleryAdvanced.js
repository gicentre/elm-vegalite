...
var author$project$GalleryAdvanced$advanced10 = function () {
		...
		author$project$VegaLite$detail(
			_List_fromArray(
				[
					...
					author$project$VegaLite$dMType(2)
				])));
	...
	var data = author$project$VegaLite$dataFromUrl('https://vega.github.io/vega-lite/data/iris.json');
	var cfg = A2(
		elm$core$Basics$composeL,
		A2(
			elm$core$Basics$composeL,
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							author$project$VegaLite$axTitle('Residual')
						]))
				])));
...
var author$project$GalleryAdvanced$mySpecs = author$project$VegaLite$combineSpecs(
	_List_fromArray(
		[
			...
			_Utils_Tuple2('advanced12', author$project$GalleryAdvanced$advanced13),
