...
var $author$project$VegaLite$Date = {$: 'Date'};
...
var $author$project$VegaLite$Day = {$: 'Day'};
var $author$project$VegaLite$day = $author$project$VegaLite$Day;
var $author$project$VegaLite$Hours = {$: 'Hours'};
...
var $author$project$VegaLite$ONone = {$: 'ONone'};
var $author$project$VegaLite$osNone = $author$project$VegaLite$ONone;
var $author$project$VegaLite$YearMonthDate = {$: 'YearMonthDate'};
...
var $author$project$VegaLite$EqualEarth = {$: 'EqualEarth'};
...
var $author$project$VegaLite$SymWedge = {$: 'SymWedge'};
