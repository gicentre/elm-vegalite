...
var author$project$VegaLite$StrokeWidth = function (a) {
	return {$: 7, a: a};
};
var author$project$VegaLite$vicoStrokeWidth = author$project$VegaLite$StrokeWidth;
	...
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				des,
				conf(_List_Nil),
				A2(author$project$VegaLite$dataFromUrl, 'https://vega.github.io/vega-lite/data/seattle-temps.csv', _List_Nil),
				author$project$VegaLite$rect(_List_Nil),
				enc(_List_Nil)
			]));
}();
...
var author$project$GalleryTable$table4 = function () {
	...
	return author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				des,
				A2(author$project$VegaLite$dataFromUrl, 'https://vega.github.io/vega-lite/data/github.csv', _List_Nil),
