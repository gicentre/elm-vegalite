...
var $author$project$VegaLite$RemoveInvalid = function (a) {
	return {$: 30, a: a};
};
var $author$project$VegaLite$coRemoveInvalid = $author$project$VegaLite$RemoveInvalid;
...
var $author$project$GalleryScatter$scatter7 = function () {
	...
	var config = A2(
		...
		$author$project$VegaLite$configuration(
			$author$project$VegaLite$coRemoveInvalid(false)));
	return $author$project$VegaLite$toVegaLite(
		_List_fromArray(
			[
				des,
