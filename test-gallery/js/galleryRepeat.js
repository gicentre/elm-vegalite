...
var $author$project$VegaLite$SeGlobal = {$: 'SeGlobal'};
var $author$project$VegaLite$seGlobal = $author$project$VegaLite$SeGlobal;
...
var $author$project$VegaLite$SeUnion = {$: 'SeUnion'};
var $author$project$VegaLite$seUnion = $author$project$VegaLite$SeUnion;
...
var $author$project$VegaLite$Flush = {$: 'Flush'};
var $author$project$VegaLite$boFlush = $author$project$VegaLite$Flush;
var $author$project$VegaLite$VLBounds = {$: 'VLBounds'};
...
var $author$project$VegaLite$bounds = function (bnds) {
	return _Utils_Tuple2(
		$author$project$VegaLite$VLBounds,
